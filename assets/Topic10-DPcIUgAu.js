import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as a}from"./FAQTemplate-BamsZuNW.js";import{P as n}from"./PlainTextPrint-CGJ_aUDk.js";import{T as s}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const r=`/**\r
...
\r
    public StudentLedgerEntry {\r
      if (studentName == null) {\r
        throw new NullPointerException("studentName must not be null");\r
      }\r
      if (courseName == null) {\r
        throw new NullPointerException("courseName must not be null");\r
      }\r
      if (rollNumber <= 0) {\r
...
\r
  ...
  public static double computeFinalPayableFee(StudentLedgerEntry entry) {\r
    if (entry == null) {\r
      throw new NullPointerException("StudentLedgerEntry must not be null");\r
    }\r
\r
...
\r
  ...
  public static String generateInvoiceReport(StudentLedgerEntry entry) {\r
    if (entry == null) {\r
      throw new NullPointerException("entry cannot be null");\r
    }\r
...
\r
  public static void main(String[] args) {\r
    ...
    System.out.println("================================================================================\\n");\r
\r
    StudentLedgerEntry[] studentList = {\r
...
\r
    ...
    System.out.println("2. Never use wildcard imports (import java.util.*;) - keep code clean and self-contained.");\r
    System.out.println("3. Eliminate magic numbers by defining static final UPPER_SNAKE_CASE constants.");\r
    System.out.println("4. Guard every public method defensively using explicit null checks.");\r
    System.out.println("================================================================================");\r
  }\r
}\r
`,l=`================================================================================\r
...
================================================================================\r
\r
1. FORMAL PROBLEM DEFINITION & CLEAN CODE SPECIFICATIONS\r
--------------------------------------------------------------------------------\r
PROBLEM 10: Google Java Style & Clean Code Refactoring\r
- Objective: Refactor an unstructured legacy campus ledger application into a\r
  production-grade codebase conforming strictly to the Google Java Style Guide.\r
- Specification 10A (Naming & Formatting):\r
  * Classes / Records : UpperCamelCase (e.g., StudentLedgerEntry).\r
  * Methods / Vars    : lowerCamelCase (e.g., calculateNetPayableFee).\r
  * Constants         : UPPER_SNAKE_CASE (e.g., GST_TAX_RATE = 0.18).\r
  * Indentation       : Strictly 2 spaces (NO tabs).\r
  * Column Width      : 100-character line wrap limit.\r
  * Wildcard Imports  : Zero wildcard imports allowed (explicit imports only).\r
- Specification 10B (Defensive Contracts & Immutability):\r
  * Null Safety       : Defensive null guards (Objects.requireNonNull or explicit if-check).\r
  * Data Modeling     : Immutable records with compact validation constructors.\r
  * Magic Literals    : Extract all numerical and string literals to static final constants.\r
  * Bracing           : Egyptian braces ('{' on same line) required on all control structures.\r
\r
2. GOOGLE JAVA STYLE ESSENTIALS\r
--------------------------------------------------------------------------------\r
...
\r
- Hygiene Rules:\r
  * NO wildcard imports (wildcard imports with * are strictly forbidden).\r
  * Eliminate Magic Numbers: Extract static final named constants.\r
  * Defensive Programming: Enforce explicit null checks on all public parameters.\r
\r
