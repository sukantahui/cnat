import{b as c,j as e}from"./vendor-react-core-C47mfheO.js";import{T as k}from"./TeacherSukantaHui-BfpnVddt.js";import{P as d}from"./PythonFileLoader-D8ceUcTQ.js";import{F as g}from"./FAQTemplate-D7324Ho6.js";import{P as f}from"./PlainTextPrint-COK-Ppq5.js";import"./vendor-icons-CjLaApDI.js";import"./PythonCodeBlock-Dc6jy8v_.js";import"./vendor-prism-BKuZ5wk-.js";const b=[{question:"What is the key difference between `screen.onkeypress()` and `screen.onkeyrelease()`?",shortAnswer:"`onkeypress()` fires the moment a key is depressed; `onkeyrelease()` fires when the physical key springs back up.",explanation:"Pairing press and release events enables continuous multi-key state tracking.",hint:"Which event fires on key down versus key up?",level:"basic",codeExample:`screen.onkeypress(press_handler, 'Up')
