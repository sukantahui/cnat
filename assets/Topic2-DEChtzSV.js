import{j as e}from"./index-CUXXvONC.js";import{C as a}from"./CodeBlock-BnJcuPuh.js";import"./prism-mOIs-ccL.js";import"./prism-json-D0UlpdKh.js";import"./file-code-BNZ84HOO.js";import"./createLucideIcon-O_Er4fpW.js";import"./copy-rP0aAxF9.js";import"./download-C-zK-a1m.js";import"./play-DNNbdgtV.js";function d(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"Nested Objects & Arrays of Objects"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Objects can contain more objects inside them. This helps model real-world structured data — such as storing complete student info at Coder & AccoTax, Barrackpore."}),e.jsx("h3",{className:"text-lg font-semibold text-slate-200",children:"Nested Object"}),e.jsx(a,{code:`const student = {
  name: "Susmita",
  course: "JavaScript",
  address: {
    city: "Barrackpore",
...
// GST Filing`,language:"javascript"}),e.jsx("p",{className:"text-slate-400 text-sm",children:"Nested objects and arrays help structure complex data in a readable and organised way — essential for modern JavaScript development."})]})}export{d as default};
