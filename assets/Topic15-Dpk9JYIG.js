...
================================================================================`,i=[{question:"When should an enterprise Java engineer choose 'Callable<V>' over 'Runnable'?",shortAnswer:"An engineer should choose 'Callable<V>' whenever the background task needs to return a computed value (e.g. querying a database, calculating a financial report) or when the task can throw checked exceptions (e.g. 'IOException', 'SQLException') that must be handled by the caller. 'Runnable' should only be used for fire-and-forget tasks returning 'void' with no checked exceptions.",explanation:"Design decision guide for concurrent task modeling.",hint:"Choose Callable when returning a result or handling checked exceptions; use Runnable for fire-and-forget.",level:"Intermediate",codeExample:"Callable<Report> task = () -> generatePdfReport(); // Returns Report and throws Exception"}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 008_001 · Topic 15"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Creation Matrix"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Thread Creation Approaches: The Complete Comparative Decision Matrix"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Synthesize threading patterns: evaluating inheritance tradeoffs, return types, checked exception handling, and thread pool compatibility across all 4 creation strategies."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:o,title:"ThreadCreationComparisonGrandMatrixDemo.java",highlightLines:[7,10,13,14,15,16,17,18,19,20]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Creation Matrix FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 008_001 Topic 15: Thread Creation Matrix",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"008_001_topic15_thread_creation_matrix_note.txt"})}),e.jsx(a,{note:"If someone asks you in an interview: 'What is the best way to create a thread?', your answer is: 'Use Callable with ExecutorService if you need a return value, or Runnable lambda for fire-and-forget tasks! Never extend Thread!' — Sukanta Hui"})]})}export{b as default};
