...
if __name__ == "__main__":\r
    ...
    os.remove(filename)\r
    print("🧹 Cleaned up.")`,f=`# line_processing.py\r
...
if __name__ == "__main__":\r
    ...
    os.remove(filename)\r
    print("🧹 Cleaned up.")`,p=`# large_file_processing.py\r
