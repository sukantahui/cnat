...
for success."`,K=()=>{const[d,w]=r.useState("concept"),[p,f]=r.useState({}),[m,j]=r.useState(null),[h,k]=r.useState(null),N=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],S=[{id:1,title:"Example 1: Basic Pivot Element",problem:`Given the tableau:
┌─────┬─────┬─────┬─────┬─────┬─────┐
│  B  │  x  │  y  │ s₁  │ s₂  │ RHS │
├─────┼─────┼─────┼─────┼─────┼─────┤
│ s₁  │  2  │  1  │  1  │  0  │ 10  │
