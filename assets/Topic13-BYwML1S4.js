import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as n}from"./FAQTemplate-BamsZuNW.js";import{P as r}from"./PlainTextPrint-CGJ_aUDk.js";import{T as o}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const s=`/**\r
...
1. CALLBACK OPERATORS:\r
   - 'thenApply(Function)': Transforms input → output (map equivalent).\r
...
================================================================================`,l=[{question:"Compare 'thenApply()', 'thenAccept()', and 'thenRun()' in CompletableFuture.",shortAnswer:"1. 'thenApply(Function<T, R>)': Accepts a computed value T, applies a transforming function, and returns a new 'CompletableFuture<R>' (analogous to 'Stream.map()'). 2. 'thenAccept(Consumer<T>)': Accepts a computed value T, consumes it with side-effects (e.g. printing or saving), and returns 'CompletableFuture<Void>' (analogous to 'Stream.forEach()'). 3. 'thenRun(Runnable)': Executes a Runnable action upon completion without receiving the previous stage's result and returns 'CompletableFuture<Void>'.",explanation:"Core functional transformation pipeline operators on CompletionStage.",hint:"thenApply maps T → R; thenAccept consumes T → void; thenRun executes () → void upon completion.",level:"Intermediate",codeExample:"future.thenApply(val → val * 2).thenAccept(res → print(res)).thenRun(() → done());"}];function y(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 008_007 · Topic 13"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Pipeline Transformations"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Transforming Results: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"thenApply"}),", ",e.jsx("code",{className:"text-sky-400 font-mono",children:"thenAccept"})," & ",e.jsx("code",{className:"text-purple-400 font-mono",children:"thenRun"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Construct reactive processing pipelines: mapping intermediate values with ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"thenApply"}),", consuming payloads via ",e.jsx("code",{className:"text-sky-300 font-mono",children:"thenAccept"}),", and triggering completion actions with ",e.jsx("code",{className:"text-purple-300 font-mono",children:"thenRun"}),"."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"TransformingAsyncResultsPipelineDemo.java",highlightLines:[7,10,13,14,15,20,21,22,23,24]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Pipeline Transformations FAQs",questions:l})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:a,title:"Module 008_007 Topic 13: Transforming Async Results",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"008_007_topic13_transforming_async_results_note.txt"})}),e.jsx(o,{note:"Think of it as a factory conveyor belt: 'thenApply' modifies the product, 'thenAccept' packs it into a shipping box, and 'thenRun' turns off the factory lights when done! — Sukanta Hui"})]})}export{y as default};
