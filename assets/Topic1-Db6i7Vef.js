...
================================================================================`,s=[{question:"Explain the roles, input/output types, and SAM methods of the Big 4 Java Functional Interfaces.",shortAnswer:"1. 'Predicate<T>': 'boolean test(T t)' – Accepts 1 argument of type T, returns boolean (Condition testing/filtering). 2. 'Function<T, R>': 'R apply(T t)' – Accepts 1 argument of type T, returns transformed value of type R (Data mapping). 3. 'Consumer<T>': 'void accept(T t)' – Accepts 1 argument of type T, returns void (Side-effect actions like printing/saving). 4. 'Supplier<T>': 'T get()' – Takes 0 arguments, returns a new/cached value of type T (Lazy generation/factory).",explanation:"Core matrix of the Big 4 foundational functional interfaces.",hint:"Predicate tests (T &rarr; boolean), Function transforms (T &rarr; R), Consumer consumes (T &rarr; void), Supplier generates (() &rarr; T).",level:"Beginner",codeExample:"Predicate<T> (test), Function<T,R> (apply), Consumer<T> (accept), Supplier<T> (get)"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 009_002 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"The Big 4 Core"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The Big 4 Core Interfaces: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"Predicate"}),", ",e.jsx("code",{className:"text-sky-400 font-mono",children:"Function"}),", ",e.jsx("code",{className:"text-purple-400 font-mono",children:"Consumer"})," & ",e.jsx("code",{className:"text-amber-400 font-mono",children:"Supplier"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Master the four foundational pillars of modern Java: comparing condition testers, transformative mappers, side-effect consumers, and lazy factory suppliers."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:o,title:"BigFourCoreInterfacesOverviewDemo.java",highlightLines:[7,8,9,10,19,20,22,23,25,26,28,29]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Big 4 Interfaces FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 009_002 Topic 1: The Big 4 Core Interfaces",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"009_002_topic1_big_four_core_interfaces_note.txt"})}),e.jsx(a,{note:"Memorize the Big 4 by their verbs: Predicate TESTS (yes/no), Function TRANSFORMS (A into B), Consumer ACCEPTS (eats data without returning anything), and Supplier GIVES (supplies data out of thin air)! — Sukanta Hui"})]})}export{x as default};
