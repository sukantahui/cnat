...
sustainability, risk, or employee preferences."`,L=()=>{const[o,u]=i.useState("concept"),[g,b]=i.useState({}),[x,y]=i.useState(null),[p,v]=i.useState(null),j=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],f=[{id:1,title:"Example 1: Unique Optimal Solution",problem:`Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
x ≥ 0, y ≥ 0
