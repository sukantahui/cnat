import{r as c,j as t}from"./index-M13epWmp.js";import{P as v}from"./PrintButton-BBgTipM0.js";import{J as u}from"./JavaCodeBlock-BtexpujI.js";import{P as j}from"./prism-__2n-qyh.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
