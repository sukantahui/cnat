...
console.log(report["current module"]);  // Bracket notation`,language:"javascript"}),e.jsx("p",{className:"text-slate-400 text-sm",children:"Use dot notation when possible. Use bracket notation when the key has spaces, special characters, or is dynamic."})]})}export{n as default};
