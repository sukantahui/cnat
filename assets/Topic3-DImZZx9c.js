...
1. EXECUTORS FACTORY TRAPS:\r
   - 'newFixedThreadPool(n)': Unbounded queue &rarr; Heap OutOfMemoryError.\r
   - 'newCachedThreadPool()': Unbounded thread count &rarr; Native thread OOM crash.\r
