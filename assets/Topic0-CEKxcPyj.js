import{j as e}from"./index-C5Nbbk6-.js";import{E as s}from"./EditablePythonCodeBlock-CpMbJdhb.js";import"./index-ClHeBgp3.js";import"./braces-CxhkSqhy.js";import"./layout-list-F0chhMfF.js";import"./play--xjmOV9C.js";import"./type-DhDX8m8R.js";import"./refresh-cw-BNltxj78.js";import"./copy-DRodcmmM.js";import"./download-6yOraGoh.js";import"./eye-off-kqkFbjqx.js";import"./eye-mkgdQ3p8.js";function h(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Introduction to Python Operators"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Operators are symbols used to perform operations on variables and values. Python provides a wide range of operators—from arithmetic to logical to expression evaluation. This topic lays the foundation for mastering them."}),e.jsxs("section",{className:"space-y-3",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Arithmetic Operators"}),e.jsxs("p",{className:"text-sm text-slate-300",children:["Arithmetic operators perform mathematical operations. Python supports: ",e.jsx("strong",{children:"+, -, *, /, //, %, **"})]}),e.jsx(s,{initialCode:`a = 10
b = 3
