import{b as l,j as t}from"./vendor-react-core-CaA1o1Cx.js";import{P as z}from"./PrintButton-C0fsE3b_.js";import{J as f}from"./JavaCodeBlock-CF1Ibqou.js";import{P as v}from"./vendor-prism-ntVuzLqd.js";function w({code:r="",highlightLines:c=[],title:b="Java Code (BlueJ)"}){const[u,h]=l.useState([]),d=l.useRef(null);return l.useEffect(()=>{const m=v.highlight(r,v.languages.java,"java");h(m.split(`
