...
echo -e "\\nFinished!"`,$=()=>{const r=new Date().getFullYear()-1998,[t,l]=o.useState("Hello, Barrackpore!"),[n,c]=o.useState(""),[d,h]=o.useState(""),[p,a]=o.useState(!1);return o.useEffect(()=>{a(!0),setTimeout(()=>a(!1),300);let s=t;n==="-n"?s=t+" (no newline)":n==="-e"?s=t.replace(/\\n/g,`
