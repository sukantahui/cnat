...
================================================================================`,i=[{question:"When should a developer choose an explicit Lambda Expression over a Method Reference in Java?",shortAnswer:"1. 'Parameter Transformations / Constant Injections': When arguments passed to the method require calculations or fixed default values (e.g. 'amt -> calcTax(amt, 18.0)'). 2. 'Overload Ambiguity': When the target class contains overloaded methods (e.g. 'print(int)' vs 'print(String)') that confuse the compiler unless parameter types are explicitly declared in a lambda. 3. 'Readability & Context': When parameter names provide critical domain clarity (e.g. '(sourceCurrency, targetCurrency) -> ...') that would be lost with an opaque method reference.",explanation:"Grand architectural capstone of Module 009_003.",hint:"Use lambdas when injecting constants, transforming arguments, resolving overloaded method ambiguities, or improving domain readability.",level:"Advanced",codeExample:"// Lambda preferred: x -> calculate(x, 10, true) // Cannot be done with method reference!"}];function f(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 009_003 · Topic 10"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Method References Capstone"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["When ",e.jsx("code",{className:"text-rose-400 font-mono",children:"NOT to Use"})," Method References: Readability vs Over-Cleverness (Capstone)"]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Synthesize idiomatic functional design: evaluating parameter injections, avoiding overloaded method ambiguity traps, and balancing method reference brevity with lambda expressiveness."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:o,title:"WhenNotToUseMethodReferencesCapstoneDemo.java",highlightLines:[7,10,11,23,24,25,29,30]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Method References Capstone FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 009_003 Topic 10: Method References Capstone",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"009_003_topic10_when_not_to_use_method_references_note.txt"})}),e.jsx(a,{note:"Congratulations on completing Module 009_003! You have mastered the entire spectrum of Method References and Constructor References—from the 4 foundational types and String[]::new array factories to parameter resolution and idiomatic refactoring! — Sukanta Hui"})]})}export{f as default};
