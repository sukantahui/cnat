import{b,j as e,bh as t}from"./vendor-react-core-CaA1o1Cx.js";const J=()=>{const[s,x]=b.useState({isLoggedIn:!1,name:"",role:"student",subscription:"free",notifications:3,darkMode:!0}),[n,v]=b.useState("if"),[c,w]=b.useState(!1),[m,j]=b.useState(!1),[h,C]=b.useState(""),p=[{id:"if",label:"if Statement",icon:"🤔",color:"blue"},{id:"ternary",label:"Ternary Operator",icon:"❓",color:"green"},{id:"logical",label:"Logical &&",icon:"🔗",color:"purple"},{id:"switch",label:"Switch Case",icon:"🔀",color:"yellow"},{id:"complex",label:"Complex Conditions",icon:"🧩",color:"cyan"},{id:"patterns",label:"Patterns",icon:"📐",color:"pink"}],N=[{id:1,name:"Swadeep Das",grade:"A",city:"Barrackpore",active:!0},{id:2,name:"Tuhina Roy",grade:"B+",city:"Shyamnagar",active:!0},{id:3,name:"Abhronila Sen",grade:"A+",city:"Ichapur",active:!1},{id:4,name:"Debangshu Dey",grade:"B",city:"Naihati",active:!0}],y={blue:{border:"border-blue-500",bg:"bg-blue-900/10",text:"text-blue-300"},green:{border:"border-green-500",bg:"bg-green-900/10",text:"text-green-300"},purple:{border:"border-purple-500",bg:"bg-purple-900/10",text:"text-purple-300"},yellow:{border:"border-yellow-500",bg:"bg-yellow-900/10",text:"text-yellow-300"},cyan:{border:"border-cyan-500",bg:"bg-cyan-900/10",text:"text-cyan-300"},pink:{border:"border-pink-500",bg:"bg-pink-900/10",text:"text-pink-300"}},S=()=>{j(!0),setTimeout(()=>{x({...s,isLoggedIn:!0,name:"Swadeep Das",role:"student",subscription:"pro",notifications:3}),j(!1),C("")},1e3)},I=()=>{x({...s,isLoggedIn:!1,name:"",role:"student",subscription:"free",notifications:0})},L=r=>{x({...s,role:r})},A=r=>{x({...s,subscription:r})},E=()=>{x({...s,darkMode:!s.darkMode})},P=()=>{x({...s,notifications:0})},k=()=>p.find(l=>l.id===n)?.color||"blue",R=()=>{const r=k();return y[r]||y.blue},D=()=>{switch(n){case"if":return f();case"ternary":return M();case"logical":return U();case"switch":return F();case"complex":return B();case"patterns":return T();default:return f()}},f=()=>{let r="";s.isLoggedIn?r=`Welcome back, ${s.name}!`:r="Please log in to continue";let l="";return s.role==="admin"?l="Administrator":s.role==="teacher"?l="Instructor":l="Student",e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-gray-900/40 p-5 rounded-xl border border-gray-700",children:[e.jsx("h3",{className:"text-xl font-bold text-blue-400 mb-4",children:"if Statement Examples"}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"p-4 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-gray-300 mb-2",children:"Simple if-else"}),e.jsx("div",{className:"p-3 bg-gray-900/50 rounded-lg border border-gray-700",children:e.jsx("p",{className:"text-lg text-center",children:r})}),e.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Using if-else to set variable before rendering"})]}),e.jsxs("div",{className:"p-4 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-gray-300 mb-2",children:"if-else if-else Chain"}),e.jsx("div",{className:"p-3 bg-gray-900/50 rounded-lg border border-gray-700",children:e.jsxs("div",{className:"flex items-center justify-center gap-3",children:[e.jsx("div",{className:t("w-3 h-3 rounded-full",s.role==="admin"?"bg-red-500":s.role==="teacher"?"bg-yellow-500":"bg-green-500")}),e.jsxs("p",{className:"text-lg",children:["Role: ",l]})]})}),e.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Multiple conditions with else-if chain"})]}),e.jsxs("div",{className:"p-4 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-gray-300 mb-2",children:"Nested if Statements"}),e.jsx("div",{className:"p-3 bg-gray-900/50 rounded-lg border border-gray-700",children:s.isLoggedIn?s.subscription==="enterprise"?e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"text-xl text-purple-400",children:"🌟 Enterprise Member"}),e.jsx("p",{className:"text-sm text-gray-400",children:"Full access to all features"})]}):s.subscription==="pro"?e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"text-xl text-green-400",children:"⭐ Pro Member"}),e.jsx("p",{className:"text-sm text-gray-400",children:"Access to premium features"})]}):e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"text-xl text-gray-400",children:"Free Member"}),e.jsx("p",{className:"text-sm text-gray-400",children:"Basic features only"})]}):e.jsx("div",{className:"text-center text-gray-500",children:"Please log in to see subscription status"})}),e.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Nested if statements for complex logic"})]})]})]}),c&&e.jsxs("div",{className:"bg-gray-900/40 p-5 rounded-xl border border-gray-700",children:[e.jsx("h4",{className:"font-bold text-blue-300 mb-3",children:"Code Example"}),e.jsx("pre",{className:"bg-gray-950 p-4 rounded-lg overflow-x-auto text-xs",children:`// Simple if-else
let greeting = '';
if (user.isLoggedIn) {
...
);`})]})]})},M=()=>e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-gray-900/40 p-5 rounded-xl border border-gray-700",children:[e.jsx("h3",{className:"text-xl font-bold text-green-400 mb-4",children:"Ternary Operator Examples"}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"p-4 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-gray-300 mb-2",children:"Basic Ternary (Inline)"}),e.jsx("div",{className:"p-3 bg-gray-900/50 rounded-lg border border-gray-700",children:e.jsxs("div",{className:"flex items-center justify-center gap-3",children:[e.jsx("div",{className:t("w-4 h-4 rounded-full",s.isLoggedIn?"bg-green-500":"bg-red-500")}),e.jsxs("p",{className:"text-lg",children:["Status: ",s.isLoggedIn?"Logged In":"Logged Out"]})]})}),e.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Simple true/false condition in JSX"})]}),e.jsxs("div",{className:"p-4 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-gray-300 mb-2",children:"Nested Ternary"}),e.jsx("div",{className:"p-3 bg-gray-900/50 rounded-lg border border-gray-700",children:e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"text-xl",children:s.subscription==="enterprise"?"🏢 Enterprise":s.subscription==="pro"?"⭐ Pro":s.subscription==="free"?"🆓 Free":"Unknown"}),e.jsx("p",{className:"text-sm text-gray-400 mt-1",children:s.subscription==="enterprise"?"Unlimited access":s.subscription==="pro"?"Premium features":s.subscription==="free"?"Basic features":""})]})}),e.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Multiple conditions with nested ternary (use with caution)"})]}),e.jsxs("div",{className:"p-4 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-gray-300 mb-2",children:"Ternary with JSX Blocks"}),e.jsx("div",{className:"p-3 bg-gray-900/50 rounded-lg border border-gray-700",children:s.isLoggedIn?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Notifications:"}),e.jsx("span",{className:"text-yellow-400 font-bold",children:s.notifications})]}),s.notifications>0&&e.jsx("button",{onClick:P,className:"w-full py-1 bg-yellow-900/30 text-yellow-300 rounded hover:bg-yellow-800/50 text-sm",children:"Clear Notifications"})]}):e.jsx("div",{className:"text-center text-gray-500",children:"No notifications - please log in"})}),e.jsx("p",{className:"text-sm text-gray-500 mt-2",children:"Using ternary to render different JSX blocks"})]})]})]}),c&&e.jsxs("div",{className:"bg-gray-900/40 p-5 rounded-xl border border-gray-700",children:[e.jsx("h4",{className:"font-bold text-green-300 mb-3",children:"Code Example"}),e.jsx("pre",{className:"bg-gray-950 p-4 rounded-lg overflow-x-auto text-xs",children:`// Basic ternary
...
<ConditionalRender condition={user.isLoggedIn}>
  <UserMenu />
</ConditionalRender>`})]})]})},u=R();return e.jsx("div",{className:"min-h-screen bg-gradient-to-br from-gray-900 to-black text-white p-4 md:p-8",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsxs("div",{className:"flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600",children:"Conditional Rendering in React"}),e.jsx("p",{className:"text-gray-400 mt-2",children:"Master different techniques for conditional rendering in React components"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{onClick:()=>w(!c),className:t("px-4 py-2 rounded-lg border transition-colors",c?"bg-blue-900/30 border-blue-500 text-blue-300":"bg-gray-800/50 border-gray-700 text-gray-300 hover:border-gray-600"),children:c?"Hide Code":"Show Code"}),e.jsx("button",{onClick:E,className:"p-2 rounded-lg bg-gray-800/50 border border-gray-700 hover:border-gray-600",children:s.darkMode?"🌙":"☀️"})]})]}),e.jsxs("div",{className:"grid lg:grid-cols-4 gap-6",children:[e.jsx("div",{className:"lg:col-span-1",children:e.jsxs("div",{className:"bg-gray-900/40 rounded-xl border border-gray-700 p-4 sticky top-6",children:[e.jsx("div",{className:"mb-6",children:e.jsxs("div",{className:"p-3 bg-gray-800/40 rounded-lg border border-gray-700",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:t("w-2 h-2 rounded-full",s.isLoggedIn?"bg-green-500":"bg-red-500")}),e.jsx("span",{className:"text-sm",children:s.isLoggedIn?"Online":"Offline"})]}),e.jsxs("span",{className:"text-xs text-gray-400",children:[s.darkMode?"Dark":"Light"," Mode"]})]}),e.jsx("div",{className:"space-y-3",children:s.isLoggedIn?e.jsxs("div",{className:"space-y-2",children:[e.jsx("p",{className:"font-bold text-center",children:s.name}),e.jsxs("div",{className:"flex justify-center gap-2",children:[e.jsx("span",{className:"px-2 py-1 bg-blue-900/30 text-blue-300 rounded text-xs",children:s.role}),e.jsx("span",{className:"px-2 py-1 bg-purple-900/30 text-purple-300 rounded text-xs",children:s.subscription})]}),e.jsx("button",{onClick:I,className:"w-full py-2 bg-red-900/30 text-red-300 rounded-lg hover:bg-red-800/50 border border-red-800/30",children:"Logout"})]}):e.jsx("button",{onClick:S,disabled:m,className:t("w-full py-3 rounded-lg border transition-colors",m?"bg-gray-800 border-gray-700 text-gray-400":"bg-green-900/30 border-green-800/30 text-green-300 hover:bg-green-800/50"),children:m?"Logging in...":"Login to Demo"})})]})}),e.jsxs("div",{className:"mb-6",children:[e.jsx("h3",{className:"font-bold text-gray-300 mb-2",children:"Change Role"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:["student","teacher","admin"].map(r=>e.jsx("button",{onClick:()=>L(r),className:t("py-2 rounded-lg border text-sm capitalize transition-colors",s.role===r?"bg-blue-900/30 border-blue-500 text-blue-300":"bg-gray-800/30 border-gray-700 text-gray-300 hover:border-gray-600"),children:r},r))})]}),e.jsxs("div",{className:"mb-6",children:[e.jsx("h3",{className:"font-bold text-gray-300 mb-2",children:"Examples"}),e.jsx("div",{className:"space-y-1",children:p.map(r=>{const l=y[r.color];return e.jsxs("button",{onClick:()=>v(r.id),className:t("w-full flex items-center gap-3 p-3 rounded-lg border transition-colors",n===r.id?t(l.border,l.bg.replace("/10","/30"),l.text):"bg-gray-800/30 border-gray-700 text-gray-300 hover:border-gray-600"),children:[e.jsx("span",{className:"text-lg",children:r.icon}),e.jsx("span",{children:r.label})]},r.id)})})]}),e.jsxs("div",{className:"p-3 bg-gray-800/40 rounded-lg border border-gray-700",children:[e.jsx("h3",{className:"font-bold text-gray-300 mb-2",children:"Current Stats"}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Notifications:"}),e.jsx("span",{className:t("font-bold",s.notifications>0?"text-yellow-400":"text-gray-400"),children:s.notifications})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Subscription:"}),e.jsx("span",{className:"capitalize",children:s.subscription})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:"text-gray-400",children:"Dark Mode:"}),e.jsx("span",{children:s.darkMode?"Enabled":"Disabled"})]})]})]})]})}),e.jsxs("div",{className:"lg:col-span-3",children:[e.jsx("div",{className:t("mb-6 p-5 rounded-xl border",u.border,u.bg),children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("span",{className:"text-2xl",children:p.find(r=>r.id===n)?.icon}),e.jsx("h2",{className:"text-2xl font-bold",children:p.find(r=>r.id===n)?.label})]}),e.jsxs("p",{className:"text-gray-400",children:[n==="if"&&"Using if statements and if-else chains",n==="ternary"&&"Inline conditional rendering with ternary operator",n==="logical"&&"Conditional rendering with logical && operator",n==="switch"&&"Multiple conditions with switch statements",n==="complex"&&"Complex conditions and dynamic styling",n==="patterns"&&"Best practices and patterns"]})]}),e.jsxs("div",{className:t("px-4 py-2 rounded-lg text-sm font-bold",u.bg.replace("/10","/30"),u.text),children:[n==="if"&&"Basic",n==="ternary"&&"Intermediate",n==="logical"&&"Intermediate",n==="switch"&&"Advanced",n==="complex"&&"Expert",n==="patterns"&&"Patterns"]})]})}),D(),e.jsxs("div",{className:"mt-8 p-5 bg-gray-900/40 rounded-xl border border-gray-700",children:[e.jsx("h3",{className:"text-xl font-bold text-gray-300 mb-3",children:"Best Practices"}),e.jsxs("div",{className:"grid md:grid-cols-1 gap-4",children:[e.jsxs("div",{className:"p-3 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-green-400 mb-1",children:"Do's"}),e.jsxs("ul",{className:"text-sm text-gray-400 space-y-1",children:[e.jsx("li",{children:"✓ Use early returns for guard clauses"}),e.jsx("li",{children:"✓ Keep conditions simple and readable"}),e.jsx("li",{children:"✓ Extract complex logic into helper functions"}),e.jsx("li",{children:"✓ Use configuration objects for multiple conditions"}),e.jsx("li",{children:"✓ Consider using enums for finite states"})]})]}),e.jsxs("div",{className:"p-3 bg-gray-800/40 rounded-lg",children:[e.jsx("h4",{className:"font-bold text-red-400 mb-1",children:"Don'ts"}),e.jsxs("ul",{className:"text-sm text-gray-400 space-y-1",children:[e.jsx("li",{children:"✗ Avoid deeply nested ternary operators"}),e.jsx("li",{children:"✗ Don't put complex logic in JSX"}),e.jsx("li",{children:"✗ Avoid using && with 0 or falsy values"}),e.jsx("li",{children:"✗ Don't duplicate condition logic"}),e.jsx("li",{children:"✗ Avoid large switch statements in render"})]})]})]})]}),e.jsxs("div",{className:"mt-8 text-center text-gray-500 text-sm",children:[e.jsx("p",{children:"This interactive demo covers all major conditional rendering patterns in React. Experiment with different user states to see how each technique works!"}),e.jsxs("div",{className:"flex items-center justify-center gap-4 mt-4",children:[e.jsx("span",{children:"Created with ❤️ for React developers"}),e.jsx("span",{children:"•"}),e.jsxs("span",{children:["Students: ",N.map(r=>r.name).join(", ")]})]})]})]})]})]})})};export{J as default};
