import{j as e}from"./index-gsr__VoO.js";import{E as s}from"./EditablePythonCodeBlock-B-q13mCk.js";import"./index-BWD-23kO.js";import"./braces-CoES6LeI.js";import"./layout-list-BJ8vQIye.js";import"./play-DRLvq0m8.js";import"./refresh-cw-CbGJFCpt.js";import"./copy-_YtngGN_.js";import"./download-BR7jb7LT.js";function x(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Conditional Statements in Python — if, elif, else"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["Conditional statements allow a program to make decisions. Python evaluates a condition as ",e.jsx("strong",{children:"True"})," or ",e.jsx("strong",{children:"False"}),"and executes the matching code block. This is one of the most powerful tools for creating logic, validations, menus, and real-world applications."]}),e.jsxs("h2",{className:"text-xl font-semibold text-sky-300",children:["1. The ",e.jsx("code",{children:"if"})," Statement"]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["An ",e.jsx("code",{children:"if"})," block runs only when its condition is ",e.jsx("strong",{children:"True"}),". Python uses indentation (usually 4 spaces) to define the block."]}),e.jsx(s,{initialCode:`age = 20
