import{j as e}from"./index-CR1DasM0.js";import{E as s}from"./EditableCodeBlock-BKvnUTAE.js";import"./index-CECdYRSp.js";import"./braces-TBFp6IUo.js";import"./file-code-CY8p-E5H.js";import"./layout-list-6Ln6C2pH.js";import"./play-Co1C4LkH.js";import"./type-Ctw3BzEx.js";import"./refresh-cw-BAUyi9LY.js";import"./wand-sparkles-DQPrprC3.js";import"./copy-DsdvCQ6A.js";import"./download-2BksmjAz.js";import"./eye-off-BnEnoXOk.js";import"./eye-B_2VHLp8.js";function g(){return e.jsxs("div",{className:"space-y-10",children:[e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-sky-300",children:["The ",e.jsx("span",{className:"text-sky-400",children:"switch"})," Statement"]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["A ",e.jsx("code",{className:"text-sky-300",children:"switch"})," statement lets you compare a value against multiple possible cases. It is cleaner than writing a long chain of",e.jsx("code",{className:"text-sky-300",children:" if / else if "}),", especially when checking the same variable repeatedly."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h3",{className:"text-xl font-semibold text-sky-300",children:"Basic Example"}),e.jsx(s,{language:"javascript",initialCode:`let day = 3;
let result = "";
