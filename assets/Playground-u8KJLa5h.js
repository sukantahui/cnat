import{b as f,j as e}from"./vendor-react-core-C47mfheO.js";import{F as C}from"./vendor-monaco-Bq9GhMe9.js";import{y as k,aL as N,bF as L,z as T,H as b,J as z,e as M,N as E,O as F,aI as H,aJ as R,c as O,D,bG as J,k as P,l as B}from"./vendor-icons-C5r6Bfkl.js";class w extends f.Component{constructor(t){super(t),this._postMessageHandler=n=>{!n.data||!n.data.type||n.data.type==="console"&&this.setState(c=>({consoleOutput:[...c.consoleOutput,{type:n.data.level||"log",message:n.data.message}]}))},window.addEventListener("message",this._postMessageHandler,!1);const o=n=>this.normalizeCode(n||""),a=t.initialSnippets||{},i=o(a.javascript??t.initialCode??""),l=o(a.html??`<!-- HTML goes here -->
