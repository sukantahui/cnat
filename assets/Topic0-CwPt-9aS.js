import{j as e}from"./index-DlQhRwac.js";import{E as s}from"./EditablePythonCodeBlock-CFQYO0-a.js";import"./index-Cwnu-Juo.js";import"./braces-Cs97IlMa.js";import"./layout-list-BonHw52I.js";import"./play-CpwSfdJ1.js";import"./type-ClWXtHxZ.js";import"./refresh-cw-BFZI2NBH.js";import"./copy-Dx2Xdz_j.js";import"./download-9mt5C_Kp.js";import"./eye-off-jIIH8s4K.js";import"./eye-Cs4vM6yN.js";function h(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Introduction to Python Operators"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Operators are symbols used to perform operations on variables and values. Python provides a wide range of operators—from arithmetic to logical to expression evaluation. This topic lays the foundation for mastering them."}),e.jsxs("section",{className:"space-y-3",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Arithmetic Operators"}),e.jsxs("p",{className:"text-sm text-slate-300",children:["Arithmetic operators perform mathematical operations. Python supports: ",e.jsx("strong",{children:"+, -, *, /, //, %, **"})]}),e.jsx(s,{initialCode:`a = 10
b = 3
