...
n = 4
for i in range(1, n + 1):
    print(" " * i + "*" * (2 * i - 1))`}),e.jsxs("div",{className:"bg-red-900/30 border-l-4 border-red-400 p-3 text-sm text-red-200",children:[e.jsx("strong",{children:"⚠ Teacher Warning:"}),"Forgetting ",e.jsx("code",{children:"print()"})," for a new line is the most common mistake in pattern questions."]})]})]})}}export{o as default};
