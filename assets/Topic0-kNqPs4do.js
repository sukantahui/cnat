...
while num > 0:
    ...
    if choice == 1:
        ...
        print("Invalid choice")`}),e.jsxs("div",{className:"bg-yellow-900/30 border-l-4 border-yellow-400 p-3 text-sm text-yellow-200",children:[e.jsx("strong",{children:"👩‍🏫 Teacher Note:"}),"Menu-driven programs combine loops and conditional logic and are very important for practical exams."]})]})]})}}export{g as default};
