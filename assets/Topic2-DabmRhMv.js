...
// }`})]}),e.jsx("footer",{className:"pt-6 border-t border-slate-800 text-slate-400 text-sm",children:e.jsxs("p",{children:["In the next chapter, we will explore",e.jsx("span",{className:"text-purple-300",children:" creating dynamic UI components "}),"like notifications, cards, alert boxes, and interactive widgets."]})})]})}}export{g as default};
