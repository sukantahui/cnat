import{b as n,j as e,bh as r}from"./vendor-react-core-CaA1o1Cx.js";import{T as C}from"./TeacherSukantaHui-Ds9F9lLV.js";import{F as _}from"./FAQTemplate-D_90hN4m.js";import{P as R}from"./PlainTextPrint-yt10TRX1.js";import{P as D}from"./PythonFileLoader-DUNJ9gwR.js";import"./vendor-icons-ri6cs58t.js";import"./PythonCodeBlock-PUup0iW5.js";import"./vendor-prism-CCfIgi4B.js";const L=[{id:1,question:"What is Multi-Factor Authentication (MFA) and what is the fundamental mathematical principle governing its security?",shortAnswer:"MFA is an authentication mechanism requiring credentials from two or more independent factor categories. The core principle is that compromise of one factor (e.g., password stolen via phishing) does not compromise credentials in another domain (e.g., physical hardware key).",explanation:"True MFA mathematically reduces the overall probability of compromise to the product of the individual compromise probabilities of independent authentication channels: P(compromise) = P(factor_1) * P(factor_2).",hint:"Requires two or more distinct factor categories (Knowledge, Possession, Inherence).",level:"Basic",codeExample:`// True MFA vs Multi-Step 1FA:
