...
So result is -01111.
`})]}),e.jsx("div",{className:"bg-yellow-900/30 p-4 rounded-xl border border-yellow-700",children:e.jsx("p",{className:"text-yellow-300 font-semibold",children:"End-around-carry-bit addition occurs only in 1’s complement arithmetic operations but not in 2’s complement arithmetic operations."})})]})]}),e.jsxs("section",{className:"bg-yellow-900/30 p-6 rounded-2xl border border-yellow-700",children:[e.jsx("h2",{className:"text-xl font-bold text-yellow-300 mb-2",children:"Important Note"}),e.jsxs("p",{className:"text-yellow-200",children:["In 1’s Complement system, zero has two representations:",e.jsx("span",{className:"font-mono text-sky-300",children:" 0000 "})," and",e.jsx("span",{className:"font-mono text-sky-300",children:" 1111"}),". Hence, ambiguity of zero still exists."]})]})]})}export{p as default};
