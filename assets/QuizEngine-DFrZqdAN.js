import{j as e,r as o,c as q}from"./index-DWohEkZn.js";import{C as ye}from"./CodeBlockGeneral-C2GIV2r3.js";import{Q as ne}from"./index-49C-nWTn.js";import{Q as je}from"./browser-DM-S59Os.js";import{E as oe}from"./eye-off-CeH8fnu0.js";import{R as Ne}from"./rotate-ccw-CSpNKGWV.js";import{E as we}from"./eye-MtmNCO_Y.js";import{A as ke}from"./award-Duv_w5Bg.js";import{c as Se}from"./createLucideIcon-C1O5LkBh.js";const Ae=[["path",{d:"M10 14.66v1.626a2 2 0 0 1-.976 1.696A5 5 0 0 0 7 21.978",key:"1n3hpd"}],["path",{d:"M14 14.66v1.626a2 2 0 0 0 .976 1.696A5 5 0 0 1 17 21.978",key:"rfe1zi"}],["path",{d:"M18 9h1.5a1 1 0 0 0 0-5H18",key:"7xy6bh"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M6 9a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1z",key:"1mhfuq"}],["path",{d:"M6 9H4.5a1 1 0 0 1 0-5H6",key:"tex48p"}]],Ce=Se("trophy",Ae),_e="/assets/signature-CtsmCGqM.png",Ee="/assets/stamp-DpSj6svg.png";function ie(){const u="certificate_counter";let r=parseInt(localStorage.getItem(u),10);(isNaN(r)||r<1)&&(r=1);const n=new Date().getFullYear(),c=String(r).padStart(5,"0"),A=`CAT-${n}-${c}`;return localStorage.setItem(u,r+1),A}function Te({studentName:u="STUDENT NAME",score:r=0,total:n=0,title:c="Module Test",passPercent:A=60,level:j="All Levels"}){const D=async()=>{const h=n?(r/n*100).toFixed(2):"0.00",x=h>=A,N=h>=85?"A+":h>=70?"A":h>=60?"B":h>=50?"C":"D",b=new Date().toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"}),w=ie(),C=`https://www.codernaccotax.co.in/verify?cert=${w}`,i=await je.toDataURL(C),_=`
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<div class="page">
  <div class="outer-frame">
    <div class="inner-frame">
      ...
      <div class="small-text">Issued on: ${b}</div>
...
`,v=window.open("","_blank");v.document.write(_),v.document.close()},z=()=>{const h=ie(),x=n?(r/n*100).toFixed(2):"0.00",N=x>=85?"A+ 🌟":x>=70?"A 👍":x>=60?"B 🙂":x>=50?"C ⚠️":"D ❌",b=x>=A,w=b?"PASSED ✅":"NOT PASSED ❌",C=b?`🎉 *Congratulations!*  
