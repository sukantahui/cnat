import{r as c,j as t}from"./index-BUy46d85.js";import{P as v}from"./PrintButton-C0tEduBl.js";import{J as u}from"./JavaCodeBlock-6RlEZOVX.js";import{P as j}from"./prism-BNFWoorg.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
