import{b as o,j as e}from"./vendor-react-core-D9iF7FwR.js";import{T as w}from"./TeacherSukantaHui-Cvdemxlb.js";import{P as m}from"./PythonFileLoader-D5JKxZvU.js";import{F as v}from"./FAQTemplate-DmdkpHR-.js";import{P as j}from"./PlainTextPrint-CS96sBe2.js";import"./vendor-icons-CBbStT7G.js";import"./PythonCodeBlock-Dy3OqNFl.js";import"./vendor-prism-SANIKoEh.js";const _=[{question:"What is the Entity-List pattern in multi-object animation?",shortAnswer:"Storing all moving game objects inside a Python list (e.g. `enemies = [...]`) and updating/rendering them in a single `for` loop.",explanation:"Allows scaling from 1 object to 500 objects with identical codebase structure.",hint:"What data structure stores a collection of animated game objects?",level:"basic",codeExample:`for entity in entities:
    entity.update()
