import{b as u,j as e}from"./vendor-react-core-C47mfheO.js";import{T as _}from"./TeacherSukantaHui-BfpnVddt.js";import{P as h}from"./PythonFileLoader-D8ceUcTQ.js";import{F as w}from"./FAQTemplate-D7324Ho6.js";import{P as j}from"./PlainTextPrint-COK-Ppq5.js";import"./vendor-icons-CjLaApDI.js";import"./PythonCodeBlock-Dc6jy8v_.js";import"./vendor-prism-BKuZ5wk-.js";const k=[{question:"How do you detect collision with the right screen boundary for a circular ball?",shortAnswer:"`if x + radius >= max_x:`",explanation:"Because coordinate `(x, y)` is at the center, the rightmost edge of the circle is at `x + radius`.",hint:"How is the circle's rightmost coordinate calculated relative to its center?",level:"basic",codeExample:`if x + radius >= max_x:
    x = max_x - radius
