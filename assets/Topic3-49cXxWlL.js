...
while i <= 3:
    ...
    while j <= 3:
        print(i, j)
        j += 1
    i += 1`}),e.jsxs("div",{className:"bg-red-900/30 border-l-4 border-red-400 p-3 text-sm text-red-200",children:[e.jsx("strong",{children:"⚠ Teacher Warning:"}),"Wrong indentation and missing resets are the most common exam mistakes in nested loop programs."]})]})]})}}export{f as default};
