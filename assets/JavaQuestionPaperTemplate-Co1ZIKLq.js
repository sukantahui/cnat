import{r as c,j as t}from"./index-DlQhRwac.js";import{P as v}from"./PrintButton-Bu_pJDrd.js";import{J as u}from"./JavaCodeBlock-B3QOaYGb.js";import{P as j}from"./prism-DOs7RmKt.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
