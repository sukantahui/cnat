import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{J as t}from"./JavaFileLoader-BfBG3xz_.js";import{F as a}from"./FAQTemplate-CkSqDH4B.js";import{P as n}from"./PlainTextPrint-C08xhKA4.js";import{T as s}from"./TeacherSukantaHui-CyIG3xbg.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";import"./vendor-icons-CIaKtAt4.js";const r=`/**\r
...
================================================================================`,o=[{question:"Can an abstract class in Java have zero abstract methods, and what is the primary use case?",shortAnswer:"Yes! An abstract class can have zero abstract methods. The primary use case is to prevent developers from directly instantiating the class ('new BaseClass()') while providing completely implemented shared logic.",explanation:"Commonly used in framework adapter classes and base context models.",hint:"Legal in Java; used solely to prevent direct instantiation of a base class.",level:"Intermediate",codeExample:"public abstract class Adapter { public void onClick() {} }"}];function h(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
          @keyframes fadeIn {
            from { opacity: 0; transform: translateY(8px); }
            to { opacity: 1; transform: translateY(0); }
          }
          .animate-fade-in { animation: fadeIn 0.5s ease-out forwards; }
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_007 · Topic 11"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Design Technique"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Can an Abstract Class Have 0 Abstract Methods? (Preventing Direct Instantiation)"}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Discover why architects intentionally mark fully-implemented classes ",e.jsx("code",{className:"text-indigo-400 font-mono",children:"abstract"}),": enforcing inheritance semantics and preventing incomplete conceptual instantiation."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:r,title:"ZeroAbstractMethodsDemo.java",highlightLines:[12,15,23,33]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Zero Abstract Methods FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 002_007 Topic 11: Abstract Class with 0 Methods",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_007_topic11_zero_abstract_methods_note.txt"})}),e.jsx(s,{note:"You don't need abstract methods to make a class abstract! Marking it abstract is simply the cleanest way to say: 'You cannot instantiate me directly; you must extend me.' — Sukanta Hui"})]})}export{h as default};
