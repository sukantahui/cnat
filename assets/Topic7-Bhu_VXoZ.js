...
interface Scanner { void scan(); }`}];function S(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_011 · Topic 7"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"SOLID: I"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["I — Interface Segregation Principle (ISP): ",e.jsx("span",{className:"text-emerald-400",children:"Lean Role Interfaces"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Eliminate bloated, fat interfaces: decomposing monolithic contracts into lean, modular, and role-specific interfaces that clients can adopt without empty stub methods."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:a,title:"InterfaceSegregationPrincipleDemo.java",highlightLines:[18,22,26,30,36,46]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"ISP FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:o,title:"Module 002_011 Topic 7: Interface Segregation Principle",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_011_topic7_isp_note.txt"})}),e.jsx(i,{note:"If an interface has 20 methods and a class only needs 2 of them, do not force the class to implement 18 empty dummy methods! Split the interface into small, focused contracts. — Sukanta Hui"})]})}export{S as default};
