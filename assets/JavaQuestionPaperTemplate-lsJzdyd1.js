import{r as c,j as t}from"./index-Czk7a0H9.js";import{P as v}from"./PrintButton-ez6gtdTs.js";import{J as u}from"./JavaCodeBlock-CySzL3ZH.js";import{P as j}from"./prism-IyxSUpEx.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
