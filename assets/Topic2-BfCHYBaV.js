...
}`}),e.jsxs("p",{className:"text-slate-500 text-xs",children:["📝 ",e.jsx("strong",{children:"Exam Tip:"})," ",e.jsx("code",{children:"switch"})," works only with",e.jsx("code",{children:" int"})," and ",e.jsx("code",{children:"char"})," types in C (not ranges or floats)."]})]})}export{x as default};
