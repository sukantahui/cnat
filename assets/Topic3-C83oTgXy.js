...
});`})]}),e.jsx("footer",{className:"pt-6 border-t border-slate-800 text-slate-400 text-sm",children:e.jsxs("p",{children:["In the next chapter, we build",e.jsx("span",{className:"text-sky-300",children:" a complete mini-application "}),"using dynamic components, events, and DOM utilities."]})})]})}}export{j as default};
