...
1. THE GOLDEN CONTRACT:\r
   - If 'a.equals(b) == true'  &rarr; 'a.hashCode() == b.hashCode()' is MANDATORY.\r
   - If 'a.hashCode() == b.hashCode()' &rarr; 'a.equals(b)' can be true OR false (Collision).\r
   - If 'a.equals(b) == false' &rarr; 'a.hashCode()' can still be same or different.\r
\r
================================================================================\r
