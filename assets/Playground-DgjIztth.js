import{b as f,j as e}from"./vendor-react-core-D9iF7FwR.js";import{F as C}from"./vendor-monaco-CEXMEfXF.js";import{a4 as k,b5 as N,bP as L,a5 as T,a6 as b,a7 as z,m as M,a0 as E,a1 as F,b2 as H,b3 as R,c as D,D as O,bQ as P,r as J,s as B}from"./vendor-icons-Beb6eGc1.js";class w extends f.Component{constructor(t){super(t),this._postMessageHandler=n=>{!n.data||!n.data.type||n.data.type==="console"&&this.setState(c=>({consoleOutput:[...c.consoleOutput,{type:n.data.level||"log",message:n.data.message}]}))},window.addEventListener("message",this._postMessageHandler,!1);const o=n=>this.normalizeCode(n||""),a=t.initialSnippets||{},i=o(a.javascript??t.initialCode??""),l=o(a.html??`<!-- HTML goes here -->
