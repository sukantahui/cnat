...
================================================================================`,a=[{question:"Why is Constructor Dependency Injection (CDI) considered superior to Field Injection in Java?",shortAnswer:"Constructor Injection makes all dependencies explicit and immutable ('final'), prevents creating partially initialized objects, and allows fast, lightweight unit testing by passing mock implementations without needing reflection frameworks.",explanation:"Recommended as the gold standard by Spring Framework and Google Guice.",hint:"Guarantees immutable dependencies and enables effortless unit test mocking.",level:"Intermediate",codeExample:"public Service(PaymentProcessor p) { this.p = Objects.requireNonNull(p); }"}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_011 · Topic 10"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Dependency Injection"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Implementing DIP with Constructor Dependency Injection"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Learn how to implement Dependency Injection in pure Java without third-party frameworks: creating immutable dependencies, enabling fast mock testing, and achieving total inversion of control."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:i,title:"ConstructorDependencyInjectionDemo.java",highlightLines:[11,16,24,32,35,50,54]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Constructor Injection FAQs",questions:a})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 002_011 Topic 10: Constructor Dependency Injection",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_011_topic10_constructor_di_note.txt"})}),e.jsx(o,{note:"Constructor Injection lets you test your service in 1 millisecond by injecting a MockPaymentProcessor without connecting to a real payment gateway or database! — Sukanta Hui"})]})}export{b as default};
