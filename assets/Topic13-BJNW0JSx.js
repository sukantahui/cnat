import{w as A,r as o,u as I,j as e,e as h,L as P,p as B}from"./index-Da242x_v.js";import{c as a}from"./clsx-B-dksMZM.js";import{Z as T}from"./zap-Y6PnXeg7.js";import{C as D}from"./cpu-jg6qoJZa.js";import{C as c}from"./circle-check-big-CNhMTom3.js";import{P as R}from"./puzzle-C92UaGUC.js";import{G as U}from"./git-branch-DA1yYObF.js";const L=[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]],E=A("box",L),X=()=>{const[x,u]=o.useState(!0),[i,g]=o.useState("basics"),[n,b]=o.useState(0),[p,f]=o.useState(!1),{moduleSlug:M,topicIndex:z}=I(),y=()=>{u(!x)};o.useEffect(()=>{f(!0)},[]);const m={title:"React Components: Building Blocks of UI",analogy:"Like Lego bricks - small, reusable pieces that combine to create complex structures",description:"Components are independent, reusable pieces of UI. They can be as small as a button or as large as an entire page.",characteristics:["Receive data via props","Return JSX describing UI","Can maintain internal state","Reusable across application"]},l=[{title:"Simple Button Component",code:`function PrimaryButton({ children, onClick }) {
  return (
    <button 
      onClick={onClick}
