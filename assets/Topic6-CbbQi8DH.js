...
================================================================================`,i=[{question:"How does the Java compiler determine which overloaded constructor to call when using a Constructor Reference ('ClassName::new')?",shortAnswer:"The compiler selects the matching constructor based on the parameter types and argument count of the target Functional Interface SAM. If the target is 'Supplier<T>' (0 args), the no-arg constructor is invoked. If the target is 'Function<A, T>' (1 arg), the single-arg constructor accepting type A is invoked. If the target is 'BiFunction<A, B, T>' (2 args), the two-arg constructor accepting types (A, B) is invoked.",explanation:"Overloaded constructor reference resolution mechanics in Java 8.",hint:"Selected automatically based on the parameter list of the target Functional Interface SAM (Supplier=0, Function=1, BiFunction=2).",level:"Intermediate",codeExample:"Supplier<User> s = User::new; Function<String, User> f = User::new;"}];function S(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 009_003 · Topic 6"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Constructor References"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Kind 4: Reference to a ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"Constructor"})," (",e.jsx("code",{className:"text-sky-400 font-mono",children:"ClassName::new"}),")"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Instantiate objects declaratively: exploring constructor reference resolution across ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"Supplier"}),", ",e.jsx("code",{className:"text-sky-300 font-mono",children:"Function"}),", and ",e.jsx("code",{className:"text-purple-300 font-mono",children:"BiFunction"})," SAM parameter signatures."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"ConstructorReferenceDemo.java",highlightLines:[7,8,9,10,39,40,43,44,47,48,51,52]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Constructor References FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 009_003 Topic 6: Constructor References",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"009_003_topic6_constructor_references_note.txt"})}),e.jsx(o,{note:"Constructor references are the ultimate factory shortcuts! Instead of writing '() -> new ArrayList<>()', just write 'ArrayList::new'! Java inspects the constructor arguments and calls the right one automatically! — Sukanta Hui"})]})}export{S as default};
