import{b as u,j as e}from"./vendor-react-core-BBXbtqt1.js";import{T as _}from"./TeacherSukantaHui-VMH_OtYp.js";import{P as h}from"./PythonFileLoader-YugaCzY9.js";import{F as w}from"./FAQTemplate-BamsZuNW.js";import{P as j}from"./PlainTextPrint-CGJ_aUDk.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const k=[{question:"How do you detect collision with the right screen boundary for a circular ball?",shortAnswer:"`if x + radius >= max_x:`",explanation:"Because coordinate `(x, y)` is at the center, the rightmost edge of the circle is at `x + radius`.",hint:"How is the circle's rightmost coordinate calculated relative to its center?",level:"basic",codeExample:`if x + radius >= max_x:
    x = max_x - radius
