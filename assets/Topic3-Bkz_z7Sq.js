import{r as a,j as e}from"./index-D8vKF2mq.js";import{c as n}from"./clsx-B-dksMZM.js";import{F as f}from"./FAQTemplate-vk816vUa.js";import{T as v}from"./TeacherSukantaHui-DjhHYUAb.js";import{J as l}from"./JavaFileLoader-WyjnB8lQ.js";import"./github-CLhUlPeX.js";import"./createLucideIcon-DTJ5VPt2.js";import"./git-branch-ivLG4H_K.js";import"./JavaCodeBlock-Cn8snDcq.js";import"./prism-DqVe0I4H.js";import"./browser-iABTCUld.js";import"./prism-java-BwO6k4I_.js";const j=`// BasicEntity.java\r
...
public Optional<String> getMiddleName() { return Optional.ofNullable(middleName); }`}],B=()=>{const[t,g]=a.useState({intro:!1,annotations:!1,columnMapping:!1,idGen:!1,embedded:!1,temporal:!1,checklist:!1}),x=(r,i)=>{r.forEach(o=>{o.isIntersecting&&g(d=>({...d,[i]:!0}))})},s=(r,i)=>{if(!r.current)return;const o=new IntersectionObserver(d=>x(d,i),{threshold:.2,rootMargin:"0px 0px -50px 0px"});return o.observe(r.current),o},c=a.useRef(null),m=a.useRef(null),p=a.useRef(null),u=a.useRef(null),h=a.useRef(null),y=a.useRef(null),b=a.useRef(null);return a.useEffect(()=>{const r=[s(c,"intro"),s(m,"annotations"),s(p,"columnMapping"),s(u,"idGen"),s(h,"embedded"),s(y,"temporal"),s(b,"checklist")];return()=>r.forEach(i=>i&&i.disconnect())},[]),e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-100 font-sans leading-relaxed",children:[e.jsx("style",{children:`
