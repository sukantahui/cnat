...
================================================================================`,i=[{question:"What is the 'super' keyword in Java and what does it represent?",shortAnswer:"'super' is an implicit reference variable used in subclass methods and constructors to access members (fields, methods, constructors) of the direct parent superclass.",explanation:"While 'this' refers to the current class instance, 'super' acts as a direct bridge to access overridden or shadowed parent class members.",hint:"Reference variable targeting the direct superclass members.",level:"Beginner",codeExample:"super.display(); // Calls parent display() method"}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_003 · Topic 8"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Inheritance Bridge"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Introduction to the ",e.jsx("code",{className:"text-indigo-400 font-mono",children:"super"})," Keyword in Java Inheritance"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Discover the parent-access gateway in Java OOP. Learn how ",e.jsx("code",{className:"text-indigo-300 font-mono",children:"super"})," bridges subclass execution to superclass fields, methods, and constructors."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:s,title:"SuperKeywordIntroductionDemo.java",highlightLines:[24,25,28,38]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Introduction to 'super' FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{content:o,title:"Module 002_003 Topic 8: Introduction to super",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_003_topic8_super_intro_note.txt"})}),e.jsx(a,{note:"While this looks at the current class, super looks up to the parent. It is your direct telephone line to the superclass! — Sukanta Hui"})]})}export{b as default};
