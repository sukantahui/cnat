import{b as u,j as e}from"./vendor-react-core-C47mfheO.js";import{T as g}from"./TeacherSukantaHui-B_XsiBS9.js";import{P as d}from"./PythonFileLoader-D8ceUcTQ.js";import{F as f}from"./FAQTemplate-D7324Ho6.js";import{P as b}from"./PlainTextPrint-COK-Ppq5.js";import"./vendor-icons-Ca1ERgfs.js";import"./PythonCodeBlock-Dc6jy8v_.js";import"./vendor-prism-BKuZ5wk-.js";const w=[{question:"What is Turtle State Pollution?",shortAnswer:"When a helper function modifies position, heading, or pen attributes without restoring them, breaking subsequent caller drawing.",explanation:"Unrestored mutations cause unpredictable side effects in complex scenes.",hint:"What do you call unintended side effects left behind by a drawing function?",level:"basic",codeExample:"# Unrestored heading causes subsequent lines to be skewed"},{question:"Which methods return the turtle's current position, heading, and pen status?",shortAnswer:"`t.position()` (or `t.pos()`), `t.heading()`, and `t.isdown()`.",explanation:"These getter methods inspect the current kinematic state of the turtle.",hint:"What three methods read position, angle, and pen contact?",level:"basic",codeExample:`pos = t.pos()
head = t.heading()
