...
surplus is subtracted (-)."`,_=()=>{const[o,y]=r.useState("concept"),[b,v]=r.useState({}),[h,f]=r.useState(null),[g,j]=r.useState(null),S=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],N=[{id:1,title:"Example 1: Basic Surplus Variables",problem:`Convert to standard form using surplus variables:
Minimize Z = 4x + 3y
Subject to:
x + y ≥ 6
2x + y ≥ 8
