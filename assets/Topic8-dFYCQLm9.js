...
renderList(document.body, tasks, (t) => {
  ...
  return box;
});`})]}),e.jsx("footer",{className:"pt-6 border-t border-slate-800 text-slate-400 text-sm",children:e.jsx("p",{children:"Bulk DOM creation & template rendering are **core frontend engineering skills**. These techniques scale easily from small classroom projects to full web applications."})})]})}}export{C as default};
