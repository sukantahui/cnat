import{b as W,j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as B}from"./JavaCodeBlock-C-PCLa__.js";import{P as I}from"./vendor-prism-B7oW9GGR.js";function J({code:n="",highlightLines:P=[],title:q="Java Code (BlueJ)"}){const[T,L]=W.useState([]),S=W.useRef(null);return W.useEffect(()=>{const A=I.highlight(n,I.languages.java,"java");L(A.split(`
