const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Topic0-Bz7yHERh.js","assets/index-C8tfbTD8.js","assets/index-oHuOApzY.css","assets/network-CQFtru3l.js","assets/circle-alert-B_7_JrIl.js","assets/server-BPpH4nd5.js","assets/Topic1-CQSTvge8.js","assets/Topic2-BZk_bEFA.js","assets/Topic3-M_AyZr_r.js","assets/Topic4-BlWWbb1P.js","assets/PracticeEngineAdvance-DjPqpVzC.js","assets/CodeBlockGeneral-DVYZ4BB4.js","assets/prism-CVT59FyX.js","assets/prism-json-D0UlpdKh.js","assets/Topic5-BnRhs94C.js","assets/index-Chjiymov.js","assets/Topic6-DrQVqksu.js","assets/Topic7-BqkDa6AC.js","assets/CodeBlock-BF6GYwAJ.js","assets/file-code--LqktZ78.js","assets/copy-CxoiTVpg.js","assets/download-DO3hLbeb.js","assets/play-DM4owxXV.js","assets/Topic0-RoEPaQds.js","assets/Topic1-BM2aSRdM.js"])))=>i.map(i=>d[i]);
import{u as Z,j as e,r as d,L as i,R as ee,A as j,b as H,B as te,l as y,n as se,C as G,X as re,_ as x}from"./index-C8tfbTD8.js";import{r as l}from"./general-roadmap-Bm9Nl7tM.js";const Q=Object.assign({"./topics/general-practice-test-one/Topic0.jsx":()=>x(()=>import("./Topic0-Bz7yHERh.js"),__vite__mapDeps([0,1,2,3,4,5])),"./topics/general-practice-test-one/Topic1.jsx":()=>x(()=>import("./Topic1-CQSTvge8.js"),__vite__mapDeps([6,1,2])),"./topics/general-practice-test-one/Topic2.jsx":()=>x(()=>import("./Topic2-BZk_bEFA.js"),__vite__mapDeps([7,1,2])),"./topics/general-practice-test-one/Topic3.jsx":()=>x(()=>import("./Topic3-M_AyZr_r.js"),__vite__mapDeps([8,1,2])),"./topics/general-practice-test-one/Topic4.jsx":()=>x(()=>import("./Topic4-BlWWbb1P.js"),__vite__mapDeps([9,1,2,10,11,12,13])),"./topics/general-practice-test-one/Topic5.jsx":()=>x(()=>import("./Topic5-BnRhs94C.js"),__vite__mapDeps([14,1,2,11,12,13,15])),"./topics/general-practice-test-one/Topic6.jsx":()=>x(()=>import("./Topic6-DrQVqksu.js"),__vite__mapDeps([16,1,2,10,11,12,13])),"./topics/general-practice-test-one/Topic7.jsx":()=>x(()=>import("./Topic7-BqkDa6AC.js"),__vite__mapDeps([17,1,2,18,12,13,19,20,21,22])),"./topics/general-topics/Topic0.jsx":()=>x(()=>import("./Topic0-RoEPaQds.js"),__vite__mapDeps([23,1,2])),"./topics/general-topics/Topic1.jsx":()=>x(()=>import("./Topic1-BM2aSRdM.js"),__vite__mapDeps([24,1,2]))});function ne(){const{moduleSlug:a,topicIndex:m}=Z();return e.jsx(le,{moduleSlug:a,topicIndex:m},`${a}-${m}`)}function le({moduleSlug:a,topicIndex:m}){const n=Number.parseInt(m,10)||0,P=d.useRef(null),[q,b]=d.useState(!1);let r=null,O=null;for(const s of l.segments){const t=s.modules.find(o=>o.slug===a);if(t){r=t,O=s;break}}if(!r)return e.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 p-10",children:[e.jsx("h1",{className:"text-2xl text-red-400 font-bold",children:"Module Not Found"}),e.jsx(i,{to:`/${l.folder}/roadmap`,className:"text-sky-400 underline mt-4 inline-block",children:"← Back to Roadmap"})]});const N=r.topics[n];if(!N)return e.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 p-10",children:[e.jsx("h1",{className:"text-2xl text-red-400 font-bold",children:"Topic Not Found"}),e.jsx(i,{to:`/${l.folder}/module/${a}`,className:"text-sky-400 underline mt-4 inline-block",children:"← Back to Module"})]});const v=`js-progress-${a}`,[C,S]=d.useState([]);d.useEffect(()=>{const s=localStorage.getItem(v)||"[]";let t=[];try{t=JSON.parse(s)}catch{t=[]}t.includes(n)||t.push(n),t.sort((o,c)=>o-c),localStorage.setItem(v,JSON.stringify(t)),S(t)},[n,v]);const h=r.topics.length,L=C.length,w=Math.round(L/h*100),B=n>0,A=n<h-1,D=()=>{localStorage.removeItem(v),S([])},I=`./topics/${a}/Topic${m}.jsx`,V=Q[I]?ee.lazy(Q[I]):null;d.useEffect(()=>{P.current&&P.current.scrollIntoView({behavior:"smooth",block:"center"})},[n]),d.useEffect(()=>{b(!1)},[a,m]);const[M,F]=d.useState(""),[p,J]=d.useState(()=>{try{return localStorage.getItem("student_name")||""}catch{return""}}),[k,K]=d.useState(!0),[W,E]=d.useState(!1),[Y,R]=d.useState(""),z=s=>s.map((t,o)=>`${o+1}. ${t}`).join(`
