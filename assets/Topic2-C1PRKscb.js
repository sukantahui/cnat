import{j as e}from"./index-D-07m6Qb.js";import{E as s}from"./EditablePythonCodeBlock-DOe1i3T2.js";import"./index-BLtpQgbQ.js";import"./braces-C_CY9Jv1.js";import"./layout-list-xlk1srMZ.js";import"./play-4rBxpZha.js";import"./type-BEuENsNe.js";import"./refresh-cw-DVel-Kgx.js";import"./copy-BeFV_rGJ.js";import"./download-B_C6cj02.js";import"./eye-off-Ddhut9lm.js";import"./eye-DnmUWsTr.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Variables, Keywords, Identifiers & Python’s Dynamic Typing"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"In Python, variables do not need explicit type declarations. Their type is determined automatically based on the assigned value. This topic explains how variables work, naming rules, Python keywords, and how Python stores and reuses memory references."}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. What is a Variable?"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"A variable is a name that refers to a value stored in memory. Python creates a variable automatically when you assign a value to it."}),e.jsx(s,{initialCode:`x = 10
y = 3.14
name = "Sukanta Hui"
is_student = True
