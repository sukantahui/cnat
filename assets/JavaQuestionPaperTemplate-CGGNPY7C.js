import{r as c,j as t}from"./index-CZ43a81g.js";import{P as v}from"./PrintButton-C_QkfBeu.js";import{J as u}from"./JavaCodeBlock-50NInL4g.js";import{P as j}from"./prism-Dpbu9Ka4.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
