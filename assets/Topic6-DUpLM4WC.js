import{r as l,j as e}from"./index-BQNsLvl4.js";import{c as x}from"./clsx-B-dksMZM.js";import{E as u}from"./EditablePythonCodeBlock-CvO-TvqP.js";import{P as j}from"./PythonCodeBlock-D4EZySlK.js";import"./index-Bf_FrdBe.js";import"./createLucideIcon-DfWMkJeo.js";import"./braces-DoP_KH8v.js";import"./layout-list-wnHrvZcu.js";import"./play-BGY4BZxw.js";import"./type-B3clx7CX.js";import"./refresh-cw-DeSTVkrw.js";import"./copy-ggF1ebug.js";import"./download-DAPiigzn.js";import"./eye-off-C-SnOcmU.js";import"./eye-Cp7rdNMW.js";import"./prism-DE0MjEma.js";import"./browser-CfMtt9u_.js";function t({fileModule:s,title:r=null,highlightLines:m=[],showEscapes:d=!1}){const[h,c]=l.useState(""),[p,i]=l.useState(!0);l.useEffect(()=>{if(!s){i(!1);return}typeof s=="string"?(c(o(s)),i(!1)):g(s)},[s,d]);function o(n){let a=n.replace(/\r\n/g,`
`);return d?a.replace(/\n/g,`\\n
`):a}async function g(n){try{if(i(!0),n?.then){const a=await n;a?.default&&c(o(a.default))}else n?.default&&c(o(n.default))}catch(a){console.error("Error loading Python module:",a)}finally{i(!1)}}return p?e.jsxs("div",{className:"text-center py-8 text-slate-400",children:[e.jsx("div",{className:"animate-spin rounded-full h-6 w-6 border-b-2 border-sky-500 mx-auto mb-2"}),"Loading Python code..."]}):e.jsx(j,{code:h,title:r||"Python File",highlightLines:m})}const b=`def validate_age(age_str):\r
    try:\r
        age = int(age_str)\r
\r
...
`,E="",W=()=>{const[s,r]=l.useState(null),[m,d]=l.useState(null);return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-gray-900 to-black text-gray-100 p-6 md:p-8 transition-all duration-500",children:[e.jsx("style",{jsx:!0,children:`
