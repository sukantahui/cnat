import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as a}from"./JavaFileLoader-CVw5Mqo9.js";import{F as s}from"./FAQTemplate-BamsZuNW.js";import{P as r}from"./PlainTextPrint-CGJ_aUDk.js";import{T as n}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const t=`/**\r
...
1. FIELD SHADOWING IN INHERITANCE:\r
   ...
   - 'this.fee' → Child's field (200).\r
   - 'super.fee' → Parent's field (100).\r
\r
================================================================================\r
...
================================================================================`,o=[{question:"What happens when a child class declares an instance variable with the exact same name as a parent class variable?",shortAnswer:"The child field hides (shadows) the parent field. The child class object actually contains BOTH variables in memory; 'super.field' accesses the parent variable.",explanation:"Fields in Java are NOT overridden polymorphically; they are shadowed. Both fields exist in the Heap object.",hint:"Both fields exist in memory; super.fieldName accesses the parent field.",level:"Intermediate",codeExample:"class Child extends Parent { int x = 20; void print() { System.out.println(super.x); } }"}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_003 · Topic 9"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Field Shadowing"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Using ",e.jsx("code",{className:"text-indigo-400 font-mono",children:"super"})," to Access Shadowed Parent Instance Variables"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Understand why fields in Java cannot be overridden. Learn how both parent and child fields coexist in Heap memory and how ",e.jsx("code",{className:"text-indigo-300 font-mono",children:"super.field"})," accesses shadowed superclass state."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(a,{fileModule:t,title:"SuperFieldShadowingDemo.java",highlightLines:[12,17,21,24,32]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(s,{title:"Field Shadowing & 'super' FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:i,title:"Module 002_003 Topic 9: Shadowed Parent Fields",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_003_topic9_shadowed_fields_note.txt"})}),e.jsx(n,{note:"Remember: Methods can be overridden polymorphically, but variables are only shadowed! Both parent and child variables live together in memory. — Sukanta Hui"})]})}export{b as default};
