...
region satisfies every single constraint."`,W=()=>{const[l,m]=r.useState("concept"),[g,p]=r.useState({}),[d,f]=r.useState(null),[c,u]=r.useState(null),j=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],k=[{id:1,title:"Example 1: Two Constraints",problem:`Determine the feasible region for:
2x + y ≤ 10
x + 2y ≤ 8
