...
1. QUERY METHOD SUITE:\r
   - lower(e) / higher(e) &rarr; strictly < / >.\r
   - floor(e) / ceiling(e) &rarr; <= / >=.\r
   - subSet(from, fInc, to, tInc) &rarr; configurable range view.\r
   - headSet(to, inc) & tailSet(from, inc).\r
   - pollFirst() / pollLast() &rarr; retrieve & remove extremes.\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,s=[{question:"What is the difference between 'subSet(from, to)' from SortedSet and 'subSet(from, fromInclusive, to, toInclusive)' from NavigableSet?",shortAnswer:"The older 'SortedSet.subSet(from, to)' is strictly fixed to 'half-open' intervals (from is inclusive, to is exclusive). In contrast, 'NavigableSet.subSet(from, fromInc, to, toInc)' allows explicit boolean configuration for whether the start and end boundaries are inclusive or exclusive, offering full mathematical flexibility.",explanation:"Enhanced range view APIs introduced with java.util.NavigableSet.",hint:"NavigableSet allows explicit boolean flags to specify whether from and to bounds are inclusive.",level:"Intermediate",codeExample:"set.subSet(10, true, 50, true); // Fully closed interval [10, 50]"}];function S(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 007_003 · Topic 12"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Query Suite"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:[e.jsx("code",{className:"text-emerald-400 font-mono",children:"NavigableSet"})," Complete Query Suite: Proximity, Ranges & Polls"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Execute advanced range queries: mastering boundary-inclusive interval slicing (",e.jsx("code",{className:"text-emerald-300 font-mono",children:"subSet"}),"), threshold lookups, and atomic extreme element extraction (",e.jsx("code",{className:"text-sky-300 font-mono",children:"pollFirst"})," / ",e.jsx("code",{className:"text-purple-300 font-mono",children:"pollLast"}),")."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:l,title:"NavigableSetQueryMethodsSuiteDemo.java",highlightLines:[7,10,18,19,20,21,26,27,28,33,34]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{title:"Query Suite FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:o,title:"Module 007_003 Topic 12: NavigableSet Query Suite",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"007_003_topic12_navigableset_query_suite_note.txt"})}),e.jsx(a,{note:"With NavigableSet, you can pull sub-ranges with exact inclusive/exclusive control (like fetching all students between marks 60 and 90 inclusive) with zero manual loop filtering! — Sukanta Hui"})]})}export{S as default};
