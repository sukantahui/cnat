...
table(5);
\`\`\``}]}],g={paperId:c,title:u,duration:d,totalMarks:p,sections:m};function v(){const[s,o]=t.useState(!1);t.useEffect(()=>{const e=()=>{const i=localStorage.getItem("token");o(i!==null)};e(),window.addEventListener("storage",e);const a=()=>e();return window.addEventListener("authChange",a),()=>{window.removeEventListener("storage",e),window.removeEventListener("authChange",a)}},[]);const r={name:"Coder & AccoTax",address:"25(10/A) Shibtala Road, PO - N.C. Pukur, Barrackpore, Kol-122",phone:"+91 7003756860",email:"contact@codernaccotax.co.in",website:"www.codernaccotax.co.in"};return n.jsx("div",{className:"p-6 bg-gray-900 min-h-screen",children:n.jsx(l,{data:g,isLoggedIn:s,organizationDetails:r})})}export{v as default};
