...
================================================================================`,s=[{question:"Why should developers NEVER catch 'java.lang.Throwable' in business code?",shortAnswer:"'Throwable' is the superclass of 'java.lang.Error'. Catching Throwable intercepts catastrophic JVM failures like OutOfMemoryError, StackOverflowError, and ThreadDeath. When these are caught in application code, the JVM is prevented from crashing cleanly and is left running in an unstable, corrupted memory state.",explanation:"Only top-level framework infrastructure should ever catch Throwable.",hint:"Catches fatal JVM Errors, preventing clean restarts and leaving memory corrupted.",level:"Intermediate",codeExample:"// BAD: catch (Throwable t) { ... } // Catches OutOfMemoryError!"}];function T(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 004_005 · Topic 8"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Anti-Pattern"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The ",e.jsx("code",{className:"text-rose-400 font-mono",children:"'Catch Generic Throwable/Exception'"})," Anti-Pattern"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Maintain JVM stability: discovering why catching ",e.jsx("code",{className:"text-rose-300 font-mono",children:"Throwable"})," traps the JVM in corrupt memory states and learning precise exception filtering."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:o,title:"CatchGenericThrowableAntiPatternDemo.java",highlightLines:[7,10,14,15,20,23,24]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Catch Generic FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 004_005 Topic 8: Catch Generic Throwable",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"004_005_topic8_catch_generic_throwable_note.txt"})}),e.jsx(a,{note:"Catching Throwable is dangerous because if the JVM runs out of memory (OutOfMemoryError), your catch block catches it and tries to keep running! Always catch specific exceptions! — Sukanta Hui"})]})}export{T as default};
