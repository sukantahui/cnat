import{r as a,j as e}from"./index-DdIeXD-l.js";import{J as t}from"./JavaFileLoader-C1CenQp-.js";import{T as n}from"./TeacherSukantaHui-Ds9MNVZs.js";import{F as s}from"./FAQTemplate-zqOawnUC.js";import"./JavaCodeBlock-BZqUsZXj.js";import"./prism-bVBSx9jp.js";import"./browser-DPO_eEMk.js";import"./prism-java-BwO6k4I_.js";import"./git-branch-mOcsg_Cc.js";import"./clsx-B-dksMZM.js";const r=[{question:"What is abstraction in object-oriented programming?",shortAnswer:"Abstraction hides implementation details and shows only essential features.",explanation:"It's a fundamental OOP concept that reduces complexity by focusing on 'what' an object does rather than 'how' it does it. Achieved via abstract classes and interfaces.",hint:"Think of a TV remote - you press buttons without knowing the internal circuits.",level:"basic",codeExample:"abstract class Vehicle { abstract void start(); }"},{question:"How is abstraction different from encapsulation?",shortAnswer:"Abstraction hides complexity (design level), encapsulation hides data (implementation level).",explanation:"Abstraction provides a simplified interface to a complex system. Encapsulation bundles data and methods together and restricts direct access to some components.",hint:"Abstraction = 'what you see', Encapsulation = 'how you protect'.",level:"intermediate",codeExample:`// Abstraction: interface Vehicle { void move(); }
