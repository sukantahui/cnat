...
}`})]}),e.jsxs("div",{className:`${a} mb-8 ${s} animation-delay-[840ms]`,children:[e.jsxs("h2",{className:"flex items-center gap-2",children:[e.jsx(d,{size:18})," Hint"]}),e.jsxs("p",{children:["Think about what happens if you remove ",e.jsx("code",{children:"break"})," from a case."]})]}),e.jsxs("div",{className:`${a} mb-8 ${s} animation-delay-[960ms]`,children:[e.jsxs("h2",{className:"flex items-center gap-2",children:[e.jsx(o,{size:18})," Common Pitfalls"]}),e.jsxs("ul",{className:"list-disc pl-5",children:[e.jsx("li",{children:"Missing break causing fall-through"}),e.jsx("li",{children:"Forgetting default case"}),e.jsx("li",{children:"Using wrong data type"})]})]}),e.jsxs("div",{className:`${a} border-l-4 border-sky-400 ${s} animation-delay-[1080ms]`,children:[e.jsxs("h2",{className:"flex items-center gap-2",children:[e.jsx(n,{size:18})," Mini Checklist"]}),e.jsxs("ul",{className:"list-disc pl-5",children:[e.jsx("li",{children:"All cases have break"}),e.jsx("li",{children:"Default case added"}),e.jsx("li",{children:"Expression type supported"})]})]})]})}}export{g as default};
