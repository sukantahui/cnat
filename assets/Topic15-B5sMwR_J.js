import{j as t}from"./vendor-react-core-BBXbtqt1.js";import{J as e}from"./JavaFileLoader-CVw5Mqo9.js";import{F as r}from"./FAQTemplate-BamsZuNW.js";import{P as n}from"./PlainTextPrint-CGJ_aUDk.js";import{T as i}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const a=`/**\r
...
================================================================================\r
`,s=[{question:"What does the IDENTITY_FINISH characteristic signify in a Collector?",shortAnswer:"IDENTITY_FINISH indicates that the accumulator type A is identical to the final result type R and the finisher function is an unchecked identity cast. The stream engine can skip calling finisher() entirely.",explanation:"Optimizes execution by avoiding an extra function call.",hint:"Finisher function is identity; container A is returned directly as R.",level:"Intermediate",codeExample:"Characteristics.IDENTITY_FINISH"},{question:"What generic types T, A, R represent in Collector<T, A, R>?",shortAnswer:"T is the input stream element type; A is the intermediate mutable accumulator type; R is the final output result type produced by the finisher.",explanation:"For example, in Collectors.joining(), T is CharSequence, A is StringBuilder/StringJoiner, and R is String.",hint:"T = Input, A = Accumulator, R = Result.",level:"Intermediate",codeExample:"Collector<CharSequence, StringJoiner, String>"}];function T(){return t.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[t.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 009_006 · Topic 15"}),t.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"The Collectors Framework"})]}),t.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["The ",t.jsx("code",{className:"text-emerald-400 font-mono",children:"Collector<T, A, R>"})," Interface Architecture: 5 Core Components"]}),t.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Deconstructing the Collector SPI: supplier, accumulator, combiner, finisher, and Characteristics flags (CONCURRENT, UNORDERED, IDENTITY_FINISH)."})]}),t.jsxs("section",{className:"space-y-4",children:[t.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[t.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),t.jsx(e,{fileModule:a,title:"CollectorArchitectureDemo.java",highlightLines:[18,25,34,43]})]}),t.jsx("section",{className:"space-y-4",children:t.jsx(r,{title:"Collectors Framework FAQs",questions:s})}),t.jsx("section",{className:"space-y-4",children:t.jsx(n,{content:o,title:"Module 009_006 Topic 15: Collector Interface Architecture",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"009_006_topic15_collector_interface_architecture_note.txt"})}),t.jsx(i,{note:"A Collector is defined by 5 core methods: supplier() creates the bucket, accumulator() adds an item, combiner() merges two buckets, finisher() does the final touch, and characteristics() tells the JVM how to optimize it! — Sukanta Hui"})]})}export{T as default};
