import{r as c,j as t}from"./index-Cpy87EQq.js";import{P as v}from"./PrintButton-lSSEVrzA.js";import{J as u}from"./JavaCodeBlock-7lYJrCX6.js";import{P as j}from"./prism-C-i29T9Q.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
