import{b as m,j as e,bc as g}from"./vendor-react-core-C47mfheO.js";import{u as W,a as es,F as ts,w as ss}from"./vendor-docs-D0GSaSFW.js";import{a as as,b as ns,t as os}from"./vendor-canvas-e-rorcri.js";import{a as O}from"./api-BkEHyDTL.js";import{l as rs}from"./loginService-Cfq5YnEp.js";import{s as ls}from"./studentService-DW-msihY.js";import{c as pe}from"./index-DqpRdr_N.js";import{p as Ne}from"./paid-stamp-DDbnMIS8.js";import{L as yt}from"./vendor-router-BLg8SyDF.js";import{bT as ze,bw as Nt,p as Z,bg as E,D as vt,n as ue,e as ee,bU as Be,h as We,F as ve,S as je,a8 as V,c as is,M as q,a3 as Ve,f as ds,X as we,bV as cs,bR as xs,$ as ms,a0 as ps}from"./vendor-icons-Ca1ERgfs.js";import{A as Ce,m as he}from"./vendor-motion-CAFo_HSJ.js";import"./vendor-katex-Ta2c85SH.js";import"./vendor-mermaid-hLctyn_E.js";import"./vendor-diagrams-DZZUCFL5.js";import"./vendor-prism-BKuZ5wk-.js";const ke="/assets/CNAT_QR-DbQJp68-.jpeg";function Ls(){const[R,jt]=m.useState([]),[Se,qe]=m.useState(!0),[H,De]=m.useState(""),[Y,L]=m.useState("ALL"),[Q,A]=m.useState("ALL"),[Pe,wt]=m.useState("date"),[be,Ct]=m.useState("desc"),[y,M]=m.useState("ALL"),[x,fe]=m.useState(null),[kt,He]=m.useState(null),[I,Ye]=m.useState(null),[ge,St]=m.useState(""),[Le,Dt]=m.useState(""),[Ae,Pt]=m.useState(""),[Qe,Ge]=m.useState(!1),[Je,Xe]=m.useState(!1),te=m.useRef(null),[Lt,se]=m.useState(!1),[_,ye]=m.useState([]),[Ke,ae]=m.useState(!1),[N,de]=m.useState(null),[ne,U]=m.useState(""),[Ze,At]=m.useState("Cash"),[et,Mt]=m.useState(new Date().toISOString().split("T")[0]),[tt,st]=m.useState(!1),[Me,at]=m.useState(""),[c,$t]=m.useState(null),[nt,ot]=m.useState(!1),[Tt,$e]=m.useState(!1),[It,Te]=m.useState(!1),[F,Ie]=m.useState(""),[Ft,oe]=m.useState(!1),[Fe,rt]=m.useState(!1),[D,_t]=m.useState({summary:{},students:[],enrollments:[]}),[ce,lt]=m.useState("STUDENT"),[w,re]=m.useState("DUES_ONLY"),[z,it]=m.useState(""),[Rt,dt]=m.useState({}),G=m.useMemo(()=>{if(!F.trim())return _;const t=F.trim().toLowerCase(),s=t.replace(/^#/,"");return _.filter(a=>{const o=(a.student?.studentName||a.student?.student_name||"").toLowerCase(),l=(a.admissionNumber||"").toLowerCase(),n=(a.student?.registrationNumber||a.student?.registration_number||"").toLowerCase(),i=(a.student?.whatsapp||a.student?.phone1||"").toLowerCase(),r=(a.course?.courseName||a.course?.course_name||"").toLowerCase(),d=(a.course?.courseCode||a.course?.course_code||"").toLowerCase(),b=String(a.admissionId||a.id||"");return b===s||b.includes(s)||l.includes(t)||n.includes(t)||o.includes(t)||i.includes(t)||r.includes(t)||d.includes(t)})},[_,F]);m.useEffect(()=>{(async()=>{try{const a=await(await fetch(pe)).blob(),o=new FileReader;o.onloadend=()=>St(o.result),o.readAsDataURL(a);const n=await(await fetch(Ne)).blob(),i=new FileReader;i.onloadend=()=>Dt(i.result),i.readAsDataURL(n);const d=await(await fetch(ke)).blob(),b=new FileReader;b.onloadend=()=>Pt(b.result),b.readAsDataURL(d)}catch(s){console.error("Error pre-loading voucher images:",s)}})()},[]),m.useEffect(()=>{(async()=>{try{const s=await rs.currentUser();s?.status&&s.data&&Ye(s.data)}catch{try{const s=localStorage.getItem("user");s&&Ye(JSON.parse(s))}catch{}}})()},[]);const _e=async()=>{qe(!0);try{const t=await O.get("/fees-receipts");let s=[];t.data?.status&&Array.isArray(t.data.data)||Array.isArray(t.data?.data)?s=t.data.data:Array.isArray(t.data)&&(s=t.data),jt(s)}catch(t){console.error("Error loading fee receipts:",t),g.fire({icon:"error",title:"Failed to Load Payments",text:t.response?.data?.message||"Could not retrieve fee receipts from server.",background:"#0f172a",color:"#f8fafc",confirmButtonColor:"#2563eb"})}finally{qe(!1)}};m.useEffect(()=>{_e()},[]);const J=m.useMemo(()=>R.filter(t=>{if(y==="MONTHLY"){if((t.feeType||t.fee_type||"").toLowerCase()!=="monthly")return!1}else if(y==="NON_MONTHLY"){if((t.feeType||t.fee_type||"").toLowerCase()==="monthly")return!1}else if(y==="CASH"){if((t.paymentMode||t.payment_mode||"").toLowerCase()!=="cash")return!1}else if(y==="UPI"){const a=(t.paymentMode||t.payment_mode||"").toLowerCase();if(!a.includes("upi")&&!a.includes("online"))return!1}else if(y==="TODAY"){const a=new Date().toISOString().split("T")[0];if((t.paymentDate||t.payment_date||t.createdAt||"").split("T")[0]!==a)return!1}const s=H.toLowerCase().trim();if(s){const a=(t.receiptNo||t.receipt_no||"").toLowerCase(),o=(t.studentName||t.student_name||t.student?.student_name||"").toLowerCase(),l=(t.registrationNumber||t.registration_number||t.student?.registration_number||"").toLowerCase(),n=(t.studentPhone||t.phone||t.student?.whatsapp||t.student?.phone||"").toLowerCase(),i=(t.courseName||t.course_name||t.course?.course_name||"").toLowerCase(),r=(t.paymentMode||t.payment_mode||"").toLowerCase(),d=(t.coveragePeriodText||"").toLowerCase();if(!(a.includes(s)||o.includes(s)||l.includes(s)||n.includes(s)||i.includes(s)||r.includes(s)||d.includes(s)))return!1}if(Y!=="ALL"){const a=(t.paymentMode||t.payment_mode||"").toLowerCase();if(Y.toLowerCase()!==a)return!1}if(Q!=="ALL"){const a=(t.feeType||t.fee_type||"").toLowerCase();if(Q.toLowerCase()!==a)return!1}return!0}).sort((t,s)=>{if(Pe==="amount"){const l=Number(t.amountPaid||t.amount_paid||0),n=Number(s.amountPaid||s.amount_paid||0);return be==="asc"?l-n:n-l}const a=new Date(t.paymentDate||t.payment_date||t.createdAt||t.created_at).getTime(),o=new Date(s.paymentDate||s.payment_date||s.createdAt||s.created_at).getTime();return be==="asc"?a-o:o-a}),[R,y,H,Y,Q,Pe,be]),C=m.useMemo(()=>{let t=0,s=0,a=0,o=0,l=0,n=0,i=0,r=0,d=0,b=0,p=0,u=0;const S=new Date().toISOString().split("T")[0];return R.forEach(h=>{const v=Number(h.amountPaid||h.amount_paid||0),k=(h.paymentMode||h.payment_mode||"").toLowerCase(),j=(h.feeType||h.fee_type||"").toLowerCase(),f=(h.paymentDate||h.payment_date||h.createdAt||"").split("T")[0];t+=v,k==="cash"?(s+=v,a++):k.includes("upi")||k.includes("online")?(o+=v,l++):n+=v,j==="monthly"?(i+=v,r++):(d+=v,b++),f===S&&(p++,u+=v)}),{totalCount:R.length,totalAmount:t,cashAmount:s,cashCount:a,upiAmount:o,upiCount:l,bankAmount:n,monthlyTotal:i,monthlyCount:r,lumpSumTotal:d,lumpSumCount:b,todayCount:p,todayAmount:u}},[R]),Ot=m.useMemo(()=>J.reduce((t,s)=>t+Number(s.amountPaid||s.amount_paid||0),0),[J]),Et=t=>{navigator.clipboard.writeText(t),He(t),setTimeout(()=>He(null),1500)},Ut=()=>{if(J.length===0){g.fire({icon:"info",title:"No Data to Export",text:"There are no payment receipts matching your current filters.",background:"#0f172a",color:"#f8fafc"});return}const t=J.map((n,i)=>({"SL #":i+1,"Receipt Number":n.receiptNo||n.receipt_no,"Payment Date":n.paymentDate?new Date(n.paymentDate).toLocaleDateString():"","Student Name":n.studentName||n.student_name,"Registration Number":n.registrationNumber||n.registration_number,"Course Program":n.courseName||n.course_name,"Fee Type":(n.feeType||n.fee_type)==="monthly"?"Monthly":"Course Fees (Lump sum)","Payment Mode":n.paymentMode||n.payment_mode,"Amount Paid (₹)":Number(n.amountPaid||n.amount_paid||0),"Coverage Period":me(n),"Collected By":n.collectedBy||"Admin"})),s=W.json_to_sheet(t),a=W.book_new();W.book_append_sheet(a,s,"Fee Payments");const o=es(a,{bookType:"xlsx",type:"array"}),l=new Blob([o],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8"});ts.saveAs(l,`CNAT_Fee_Payments_${new Date().toISOString().split("T")[0]}.xlsx`)},zt=()=>{window.print()},ct=t=>{if(!t||isNaN(t))return"";if(t=Math.floor(Number(t)),t===0)return"Zero Only";const s=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine"],a=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],o=["Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],l=d=>d===0?"":d<10?s[d]:d<20?o[d-10]:a[Math.floor(d/10)]+(d%10?" "+s[d%10]:""),n=d=>{if(d===0)return"";if(d<100)return l(d);const b=Math.floor(d/100),p=d%100;return s[b]+" Hundred"+(p?" and "+l(p):"")};let i="",r=t;if(r>=1e7){const d=Math.floor(r/1e7);i+=l(d)+" Crore",r%=1e7,r>0&&(i+=" ")}if(r>=1e5){const d=Math.floor(r/1e5);i+=l(d)+" Lakh",r%=1e5,r>0&&(i+=" ")}if(r>=1e3){const d=Math.floor(r/1e3);i+=n(d)+" Thousand",r%=1e3,r>0&&(i+=" ")}return r>0&&(i+=n(r)),i+" Only"},xt=()=>x?.collectedBy||x?.collected_by?x.collectedBy||x.collected_by:I?.student_name||I?.name?I.student_name||I.name:I?.email?I.email.split("@")[0]:"Accounts Section",mt=()=>x?.collectorDesignation||x?.collector_designation?x.collectorDesignation||x.collector_designation:I?.role||I?.userType&&I.userType.userTypeName?I.role||I.userType.userTypeName:"Accounts Department",Bt=async()=>{if(se(!0),at(""),_.length===0){ae(!0);try{const t=await O.get("/admissions"),s=t?.data?.data||t?.data||[],a=Array.isArray(s)?s.filter(o=>o.student&&o.course):[];ye(a)}catch(t){console.error("Failed to load admissions:",t),g.fire({icon:"error",title:"Failed to load admissions",text:"Could not load admitted students. Please try again.",background:"#0f172a",color:"#f8fafc"})}finally{ae(!1)}}},Re=t=>{if(!t||!t.student||!t.course)return null;const s=t.student.id,a=t.course.id,o=Number(t.feeModesId)===1||t.feeModeName?.toLowerCase().includes("monthly"),l=Number(t.courseFees||t.course?.courseFees||600),i=R.filter(r=>(r.studentId===s||r.student_id===s)&&(r.courseId===a||r.course_id===a)).reduce((r,d)=>r+Number(d.amountPaid||d.amount_paid||0),0);if(o){const r=l>0?l:600,d=Math.floor(i/r),b=new Date(t.admissionDate||new Date),p=[];for(let h=0;h<d;h++){const v=new Date(b);v.setMonth(v.getMonth()+h),p.push(v.toLocaleDateString("en-IN",{month:"long",year:"numeric"}))}const u=new Date(b);u.setMonth(u.getMonth()+d);const S=u.toLocaleDateString("en-IN",{month:"long",year:"numeric"});return{isMonthly:!0,monthlyRate:r,previousPaid:i,monthsCleared:d,clearedMonthsList:p,nextDueMonth:S,suggestedAmount:r,admissionDate:t.admissionDate}}else{const r=l,d=Math.max(0,r-i);return{isMonthly:!1,totalCourseFee:r,previousPaid:i,balanceDue:d,suggestedAmount:d,isPaidInFull:d<=0,admissionDate:t.admissionDate}}},Wt=t=>{de(t);const s=Re(t);s&&U(s.suggestedAmount>0?s.suggestedAmount.toString():"")},Vt=(t,s)=>{if(!t||!t.isMonthly||!s||Number(s)<=0)return[];const a=Math.floor(Number(s)/t.monthlyRate);if(a<=0)return[];const o=new Date(t.admissionDate||new Date),l=t.monthsCleared,n=[];for(let i=0;i<a;i++){const r=new Date(o);r.setMonth(r.getMonth()+l+i),n.push(r.toLocaleDateString("en-IN",{month:"long",year:"numeric"}))}return n},qt=async t=>{if(t.preventDefault(),!N){g.fire({icon:"warning",title:"Select Student",text:"Please select an admitted student first.",background:"#0f172a",color:"#f8fafc"});return}const s=Number(ne);if(!s||s<=0){g.fire({icon:"warning",title:"Invalid Amount",text:"Please enter a valid payment amount.",background:"#0f172a",color:"#f8fafc"});return}const a=Re(N);if(a?.isMonthly&&s<a.monthlyRate){g.fire({icon:"warning",title:"Amount Less than Monthly Fee",text:`Monthly installment is ₹${a.monthlyRate}. Amount paid cannot be less than ₹${a.monthlyRate}.`,background:"#0f172a",color:"#f8fafc"});return}st(!0);try{const o={student_id:N.student.id,course_id:N.course.id,fee_type:a?.isMonthly?"monthly":"non_monthly",amount_paid:s,payment_date:et,payment_mode:Ze},l=await O.post("/fees-receipts",o),n=l?.data?.data||l?.data;await _e(),se(!1),de(null),U(""),g.fire({icon:"success",title:"Fee Payment Recorded!",text:`Receipt #${n?.receiptNo||n?.receipt_no||"Issued"} recorded successfully. Opening voucher...`,timer:1600,showConfirmButton:!1,background:"#0f172a",color:"#f8fafc"}),n&&fe(n)}catch(o){console.error("Failed to record fee payment:",o);const l=o.response?.data?.message||o.response?.data?.data||"Failed to record payment. Please check required fields.";g.fire({icon:"error",title:"Payment Recording Failed",text:typeof l=="string"?l:JSON.stringify(l),background:"#0f172a",color:"#f8fafc"})}finally{st(!1)}},X=async t=>{if(t){ot(!0);try{const s=await O.get(`/admissions/${t}/ledger`);s?.data?.status&&s?.data?.data?($t(s.data.data),Te(!1),$e(!0)):g.fire({icon:"error",title:"Ledger Not Found",text:s?.data?.message||"Could not load student fee ledger.",background:"#0f172a",color:"#f8fafc"})}catch(s){console.error("Failed to load student ledger:",s),g.fire({icon:"error",title:"Ledger Error",text:s.response?.data?.message||"Failed to load student fee ledger. Please verify Admission ID.",background:"#0f172a",color:"#f8fafc"})}finally{ot(!1)}}},pt=async t=>{if(!t)return;const s=t.studentId||t.student_id,a=t.courseId||t.course_id;let o=_.find(n=>(n.student?.id===s||n.studentId===s)&&(n.course?.id===a||n.courseId===a));if(!o)try{const n=await O.get("/admissions"),i=n?.data?.data||n?.data||[],r=Array.isArray(i)?i.filter(d=>d.student&&d.course):[];ye(r),o=r.find(d=>(d.student?.id===s||d.studentId===s)&&(d.course?.id===a||d.courseId===a))}catch(n){console.error("Error fetching admissions for receipt ledger:",n)}const l=o?.admissionId||o?.id;if(l)X(l);else{try{const n=await O.get(`/students/${s}/admissions`),r=(n?.data?.data||n?.data||[]).find(d=>d.courseId===a||d.course_id===a||d.course?.id===a);if(r&&(r.id||r.admissionId)){X(r.id||r.admissionId);return}}catch(n){console.error("Fallback student admissions error:",n)}g.fire({icon:"warning",title:"Admission Record Not Found",text:"Could not locate an active admission record for this student and course.",background:"#0f172a",color:"#f8fafc"})}},Ht=t=>{if(!t)return;const s=t.student,a=s?.whatsapp||s?.phone;if(!a){g.fire({icon:"warning",title:"No WhatsApp Number",text:"Student does not have a WhatsApp number registered.",background:"#0f172a",color:"#f8fafc"});return}let o=`🏛️ *CODER & ACCOTAX (CNAT)*
...
</html>`;s.document.open(),s.document.write(S),s.document.close()},Oe=async()=>{rt(!0);try{const s=(await O.get("/admissions/dues")).data?.data||{summary:{},students:[],enrollments:[]};_t(s);const a={};(s.students||[]).forEach(o=>{(o.hasMultipleCourses||o.totalDue>0)&&(a[o.studentId]=!0)}),dt(a)}catch(t){console.error("Error fetching dues list:",t),g.fire({icon:"error",title:"Failed to Load Dues List",text:t.response?.data?.message||"Could not retrieve student dues statement.",background:"#0f172a",color:"#f8fafc"})}finally{rt(!1)}},Qt=t=>{dt(s=>({...s,[t]:!s[t]}))},le=m.useMemo(()=>{if(!D.students)return[];let t=[...D.students];if(w==="DUES_ONLY"?t=t.filter(s=>s.totalDue>0):w==="MULTI_COURSE"?t=t.filter(s=>s.hasMultipleCourses):w==="CLEARED"?t=t.filter(s=>s.totalDue<=0):w==="MONTHLY"?t=t.filter(s=>s.courses.some(a=>a.isMonthly&&a.balanceDue>0)):w==="LUMPSUM"&&(t=t.filter(s=>s.courses.some(a=>!a.isMonthly&&a.balanceDue>0))),z.trim()){const s=z.trim().toLowerCase();t=t.filter(a=>{const o=(a.studentName||"").toLowerCase().includes(s),l=(a.studentRegNo||"").toLowerCase().includes(s),n=(a.studentPhone||"").toLowerCase().includes(s),i=a.courses.some(r=>(r.courseName||"").toLowerCase().includes(s)||(r.courseCode||"").toLowerCase().includes(s));return o||l||n||i})}return t},[D.students,w,z]),xe=m.useMemo(()=>{if(!D.enrollments)return[];let t=[...D.enrollments];if(w==="DUES_ONLY"?t=t.filter(s=>s.balanceDue>0):w==="CLEARED"?t=t.filter(s=>s.balanceDue<=0):w==="MONTHLY"?t=t.filter(s=>s.isMonthly):w==="LUMPSUM"&&(t=t.filter(s=>!s.isMonthly)),z.trim()){const s=z.trim().toLowerCase();t=t.filter(a=>(a.studentName||"").toLowerCase().includes(s)||(a.studentRegNo||"").toLowerCase().includes(s)||(a.studentPhone||"").toLowerCase().includes(s)||(a.courseName||"").toLowerCase().includes(s)||(a.courseCode||"").toLowerCase().includes(s))}return t},[D.enrollments,w,z]),Gt=t=>{const s=(t.studentPhone||"").replace(/\D/g,"");if(!s){g.fire({icon:"warning",title:"No WhatsApp Number",text:`No phone number recorded for ${t.studentName}.`,background:"#0f172a",color:"#f8fafc"});return}const a=s.length===10?`91${s}`:s;let o=`🔔 *Fee Due Reminder - Coder & AccoTax* 🔔
...
Coder & AccoTax (Barrackpore) | +91 70037 56860`;const l=encodeURIComponent(o);window.open(`https://api.whatsapp.com/send?phone=${a}&text=${l}`,"_blank")},ht=t=>{oe(!1);const s=_.find(a=>a.id===t.admissionId||a.admissionId===t.admissionId);s?(de(s),U(String(t.balanceDue>0?t.balanceDue:t.monthlyRate||"")),se(!0)):(ae(!0),O.get("/admissions").then(a=>{const o=a?.data?.data||a?.data||[],l=Array.isArray(o)?o.filter(i=>i.student):[];ye(l);const n=l.find(i=>i.id===t.admissionId||i.admissionId===t.admissionId);n&&(de(n),U(String(t.balanceDue>0?t.balanceDue:t.monthlyRate||""))),se(!0)}).catch(a=>console.error(a)).finally(()=>ae(!1)))},bt=t=>{oe(!1),X(t.admissionId)},Jt=()=>{const t=window.open("","_blank");if(!t){g.fire({icon:"warning",title:"Pop-up Blocked",text:"Please allow pop-ups to print the official Dues Statement.",background:"#0f172a",color:"#f8fafc"});return}const s=new Date().toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}),a=le,o=a.reduce((n,i)=>n+Number(i.totalDue||0),0),l=`<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
For any queries, contact: +91 70037 56860 | www.codernaccotax.co.in`;let S=null,h=null;if(te.current)try{const f={quality:.95,backgroundColor:"#ffffff",pixelRatio:2,skipFonts:!0,fontEmbedCSS:""};h=await as(te.current,f);try{S=await ns(te.current,f)}catch{h&&(S=await(await fetch(h)).blob())}}catch(f){console.warn("Could not capture voucher image:",f)}let v=!1;if(S&&navigator.clipboard&&typeof window.ClipboardItem<"u")try{await navigator.clipboard.write([new window.ClipboardItem({"image/png":S})]),v=!0}catch(f){console.warn("Could not write image to clipboard:",f)}if(h){const f=document.createElement("a"),P=String(l).replace(/[^a-zA-Z0-9_-]/g,"_"),$=String(i).replace(/[^a-zA-Z0-9_-]/g,"_");f.download=`Voucher_${P}_${$}.png`,f.href=h,f.click()}const k=encodeURIComponent(u),j=`https://api.whatsapp.com/send?phone=${a}&text=${k}`;window.open(j,"_blank"),g.fire({icon:"success",title:"Opening WhatsApp...",html:`
