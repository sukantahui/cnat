import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{J as a}from"./JavaFileLoader-BfBG3xz_.js";import{F as t}from"./FAQTemplate-CkSqDH4B.js";import{P as n}from"./PlainTextPrint-C08xhKA4.js";import{T as s}from"./TeacherSukantaHui-CyIG3xbg.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";import"./vendor-icons-CIaKtAt4.js";const r=`/**\r
...
================================================================================`,c=[{question:"Why does 'nullRef.staticVariable' NOT throw a NullPointerException in Java?",shortAnswer:"Because the Java compiler binds static member access at compile time to the declaring Class type, completely ignoring the runtime value of the reference variable.",explanation:"Bytecode uses 'getstatic AcademicConfig.hubName' directly without dereferencing the pointer.",hint:"Compiler resolves static access using the compile-time type, ignoring null.",level:"Advanced",codeExample:"Student s = null; System.out.println(s.ACADEMY); // Works fine!"}];function f(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_004 · Topic 3"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Best Practices"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Accessing Static Variables: ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"ClassName.var"})," vs ",e.jsx("code",{className:"text-rose-300 font-mono",children:"objectRef.var"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Learn why accessing static members through object references is an anti-pattern, and understand the famous JVM bytecode null-reference static access puzzle."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(a,{fileModule:r,title:"StaticAccessConventionsDemo.java",highlightLines:[18,23,29]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Static Access Conventions FAQs",questions:c})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 002_004 Topic 3: Static Access Conventions",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_004_topic3_access_conventions_note.txt"})}),e.jsx(s,{note:"Always write ClassName.variableName! Writing obj.variableName is misleading and can confuse your teammates into thinking it is an instance variable. — Sukanta Hui"})]})}export{f as default};
