import{j as e}from"./index-CRQVh4re.js";import{E as s}from"./EditablePythonCodeBlock-cAbT7m5W.js";import"./index-C9ustuPO.js";import"./braces-koYBCYVL.js";import"./layout-list-B8Q7FCNK.js";import"./play-I4WOjbVK.js";import"./type-DPaMVfx8.js";import"./refresh-cw-DGCj3_No.js";import"./copy-Bmu3Bn8U.js";import"./download-DfwRCjzX.js";import"./eye-off-Dht_vehv.js";import"./eye-DF2o32X7.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Core Data Types in Python — int, float, str, bool"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["Python has four essential built-in data types used in the foundation of every program:",e.jsx("code",{children:"int"}),", ",e.jsx("code",{children:"float"}),", ",e.jsx("code",{children:"str"}),", and ",e.jsx("code",{children:"bool"}),". These types are dynamically assigned, meaning Python automatically decides the type based on the value."]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. int (Integer)"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Used for whole numbers — no decimals allowed. Python can store very large integers without overflow."}),e.jsx(s,{initialCode:`a = 10
b = -50
