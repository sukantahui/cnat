...
when positive, there's room for growth."`,_=()=>{const[o,p]=s.useState("concept"),[g,v]=s.useState({}),[b,k]=s.useState(null),[m,f]=s.useState(null),j=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],S=[{id:1,title:"Example 1: Basic Slack Variables",problem:`Convert to standard form using slack variables:
Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
