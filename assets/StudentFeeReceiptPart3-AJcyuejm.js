import{b as l,j as e}from"./vendor-react-core-BBXbtqt1.js";import{C as Q}from"./cnat-Cw7eyaib.js";import{p as X}from"./paid-stamp-DDbnMIS8.js";import{t as at,a as rt}from"./vendor-canvas-e-rorcri.js";import{s as Se}from"./studentService-CfrU6gYV.js";import{c as Pe}from"./courseService-CZrLM58u.js";import{l as st}from"./loginService-DhyhgiWW.js";import{s as ot}from"./simpleFeesReceiptService-g_9i5QBk.js";import"./api-B-XEjutJ.js";const vt=()=>{const Fe=()=>{const t=new Date,a=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${a}-${s}-${o}`},[m,Ae]=l.useState(null),[nt,Z]=l.useState(!0),[D,ee]=l.useState([]),[R,te]=l.useState(!1),[N,$]=l.useState(""),[I,ae]=l.useState(null),[it,C]=l.useState(""),[E,re]=l.useState([]),[_,se]=l.useState(!1),[q,oe]=l.useState(null),[j,M]=l.useState(""),[U,z]=l.useState(!1),[g,L]=l.useState({student_name:"",nickname:"",whatsapp:""}),[ne,ie]=l.useState(!1),[B,h]=l.useState(null),[W,O]=l.useState(!1),[v,G]=l.useState({courseCode:"",courseName:""}),[le,de]=l.useState(!1),[V,b]=l.useState(null),[ce,pe]=l.useState(!1),[ue,k]=l.useState(null),[lt,dt]=l.useState(!1),[ct,pt]=l.useState(""),[r,x]=l.useState({studentName:"",phone:"",course:"",feeType:"non_monthly",monthlyFeeAmount:"",feesPaid:"",paymentDate:Fe(),paymentMode:"Cash",periodFrom:"",periodTo:"",registrationNumber:""}),[n,Te]=l.useState(null),[S,De]=l.useState(!1),[Y,P]=l.useState(!1),[me,ge]=l.useState(!1),xe=l.useRef(null),[Re,$e]=l.useState(""),[Ie,Ee]=l.useState(""),he=!1,_e=async()=>{Z(!0);try{const t=await st.currentUser();t&&t.status===!0&&t.data&&Ae(t.data)}catch(t){console.error("Error fetching current user:",t)}finally{Z(!1)}};l.useEffect(()=>{_e(),qe(),fe()},[]);const qe=async()=>{te(!0),ae(null);try{const t=await Se.getAll();let a=[];t&&t.data&&Array.isArray(t.data)?a=t.data:Array.isArray(t)?a=t:t&&t.data&&t.data.data&&Array.isArray(t.data.data)&&(a=t.data.data),a.length>0&&(console.log("Student data structure:",a[0]),console.log("Available fields:",Object.keys(a[0]))),ee(a),a.length===0&&console.warn("No students found in database")}catch(t){console.error("Error fetching students:",t),ae("Failed to load students from database. Please try again later."),ee([])}finally{te(!1)}},fe=async()=>{se(!0),oe(null);try{const t=await Pe.getAll();let a=[];t&&t.status===!0&&Array.isArray(t.data)?a=t.data:Array.isArray(t)?a=t:t&&t.data&&Array.isArray(t.data)&&(a=t.data),re(a),a.length===0&&console.warn("No courses found in database")}catch(t){console.error("Error fetching courses:",t),oe("Failed to load courses from database. Please try again later."),re([])}finally{se(!1)}},ye=()=>m?m.employee&&m.employee.employeeName?m.employee.employeeName:m.userName?m.userName:"Authorized Collector":"System",be=()=>m?m.employee&&m.employee.designation?m.employee.designation.name:m.role||m.userType&&m.userType.userTypeName?m.role||m.userType.userTypeName:"Accounts Department":"",H=t=>{const{name:a,value:s}=t.target;L(o=>({...o,[a]:s})),B&&h(null)},Me=async t=>{if(t.preventDefault(),!g.student_name.trim()){h("Student name is required");return}if(!g.whatsapp.trim()){h("WhatsApp number is required");return}if(!/^\d{10}$/.test(g.whatsapp)){h("Please enter a valid 10-digit WhatsApp number");return}ie(!0),h(null);try{const s={student_name:g.student_name.trim(),nickname:g.nickname.trim()||g.student_name.trim(),whatsapp:g.whatsapp.trim()},o=await Se.createBasic(s);if(o&&o.status===!0){const i=o.data,u=i?.id||i?.studentId,c=i?.studentName||i?.student_name||"",p=i?.registrationNumber||i?.regNo||i?.reg_no||"";i&&u&&($(u.toString()),C(p),x(d=>({...d,studentName:c,phone:i.whatsapp||i.phone1||"",registrationNumber:p}))),L({student_name:"",nickname:"",whatsapp:""}),z(!1),alert(`Student "${c}" created successfully!
Registration Number: ${p}`)}else h(o?.message||"Failed to create student")}catch(s){console.error("Error creating student:",s),h(s.response?.data?.message||"Failed to create student. Please try again.")}finally{ie(!1)}},we=t=>{const{name:a,value:s}=t.target;G(o=>({...o,[a]:s})),V&&b(null)},Ue=async t=>{if(t.preventDefault(),!v.courseCode.trim()){b("Course code is required");return}if(!v.courseName.trim()){b("Course name is required");return}de(!0),b(null);try{const a={courseCode:v.courseCode.trim().toUpperCase(),courseName:v.courseName.trim()},s=await Pe.createBasic(a);if(s&&s.status===!0){const o=s.data;await fe(),o&&o.id&&(M(o.id.toString()),x(i=>({...i,course:o.courseName||""}))),G({courseCode:"",courseName:""}),O(!1),alert(`Course "${o.courseName}" created successfully!
Course Code: ${o.courseCode}`)}else b(s?.message||"Failed to create course")}catch(a){console.error("Error creating course:",a),b(a.response?.data?.message||"Failed to create course. Please try again.")}finally{de(!1)}};l.useEffect(()=>{(async()=>{try{const s=await(await fetch(Q)).blob(),o=new FileReader;o.onloadend=()=>{$e(o.result)},o.readAsDataURL(s);const u=await(await fetch(X)).blob(),c=new FileReader;c.onloadend=()=>{Ee(c.result)},c.readAsDataURL(u)}catch(a){console.error("Error loading images:",a)}})()},[]);const ze=t=>{const a=t.target.value;if($(a),a){const s=D.find(o=>o.studentId===parseInt(a)||o.id===parseInt(a)||o.student_id===parseInt(a));if(s){const o=s.registrationNumber||s.reg_no||s.regNo||s.registration_no||"";C(o),x(i=>({...i,studentName:s.studentName||s.student_name||"",phone:s.whatsapp||s.phone1||s.phone||"",registrationNumber:o}))}}else C(""),x(s=>({...s,studentName:"",phone:"",registrationNumber:""}))},Le=t=>{const a=t.target.value;if(M(a),a){const s=E.find(o=>o.id===parseInt(a));s&&x(o=>({...o,course:s.courseName||""}))}else M(""),x(s=>({...s,course:""}))},Be=(t,a,s,o)=>{const i="CNAT",u=`${t.trim()}_${a}_${s}_${o}`,p=(Ce=>{let w=0;for(let K=0;K<Ce.length;K++){const tt=Ce.charCodeAt(K);w=(w<<5)-w+tt,w=w&w}return Math.abs(w).toString(36).toUpperCase()})(u),d=new Date,A=d.getFullYear(),y=String(d.getMonth()+1).padStart(2,"0"),T=String(d.getDate()).padStart(2,"0"),Ze=`${A}${y}${T}`,et=p.substring(0,8);return`${i}-${Ze}-${et}`},f=t=>{const{name:a,value:s}=t.target;x(o=>({...o,[a]:s})),(a==="studentName"||a==="phone")&&($(""),C(""),x(o=>({...o,registrationNumber:""})))},F=(t,a)=>{if(!t||!a)return 0;const s=new Date(t),o=new Date(a),i=(o.getFullYear()-s.getFullYear())*12+(o.getMonth()-s.getMonth())+1;return i>0?i:0},ve=t=>{const a=t.target.value;x(s=>({...s,feeType:a,feesPaid:"",periodFrom:"",periodTo:"",monthlyFeeAmount:""}))},We=()=>{if(r.feeType==="monthly"){const t=F(r.periodFrom,r.periodTo),a=parseFloat(r.monthlyFeeAmount)||0,s=t*a;x(o=>({...o,feesPaid:s.toString()}))}};l.useEffect(()=>{r.feeType==="monthly"&&r.periodFrom&&r.periodTo&&r.monthlyFeeAmount&&We()},[r.periodFrom,r.periodTo,r.monthlyFeeAmount,r.feeType]);const Oe=async t=>{if(!N)return k("Please select a student from the database"),!1;if(!j)return k("Please select a course from the database"),!1;pe(!0),k(null);try{const a={receipt_no:t,student_id:parseInt(N),course_id:parseInt(j),fee_type:r.feeType,amount_paid:parseFloat(r.feesPaid),monthly_fee_amount:r.feeType==="monthly"?parseFloat(r.monthlyFeeAmount):null,period_from:r.feeType==="monthly"&&r.periodFrom?r.periodFrom:null,period_to:r.feeType==="monthly"&&r.periodTo?r.periodTo:null,payment_date:r.paymentDate,payment_mode:r.paymentMode},s=await ot.create(a);return s&&s.status===!0?(console.log("Receipt saved to database:",s.data),!0):(k(s?.message||"Failed to save receipt to database"),!1)}catch(a){return console.error("Error saving receipt to database:",a),k(a.response?.data?.message||"Failed to save receipt. Please try again."),!1}finally{pe(!1)}},Ne=t=>{if(!t||isNaN(t))return"";if(t=Math.floor(t),t===0)return"Zero Only";const a=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine"],s=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],o=["Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],i=d=>d===0?"":d<10?a[d]:d<20?o[d-10]:s[Math.floor(d/10)]+(d%10?" "+a[d%10]:""),u=d=>{if(d===0)return"";if(d<100)return i(d);const A=Math.floor(d/100),y=d%100;return a[A]+" Hundred"+(y?" and "+i(y):"")};let c="",p=t;if(p>=1e7){const d=Math.floor(p/1e7);c+=i(d)+" Crore",p%=1e7,p>0&&(c+=" ")}if(p>=1e5){const d=Math.floor(p/1e5);c+=i(d)+" Lakh",p%=1e5,p>0&&(c+=" ")}if(p>=1e3){const d=Math.floor(p/1e3);c+=u(d)+" Thousand",p%=1e3,p>0&&(c+=" ")}return p>0&&(c+=u(p)),c+" Only"},Ge=t=>t?new Date(t).toLocaleDateString("en-IN",{day:"2-digit",month:"long",year:"numeric"}):"",je=t=>t?new Date(t).toLocaleDateString("en-IN",{month:"long",year:"numeric"}):"",ke=t=>{switch(t){case"Cash":return"💵";case"Online (UPI)":return"📱";case"Online (Card)":return"💳";case"Online (Net Banking)":return"🏦";case"Cheque":return"📝";default:return"💰"}},J=async(t="jpeg")=>{const a=xe.current;if(!a)throw new Error("Receipt element not found");const s={overflow:a.style.overflow,width:a.style.width,position:a.style.position};a.style.overflow="visible",a.style.width="fit-content",a.style.position="relative";const o=a.scrollWidth,i=a.scrollHeight,u={quality:1,pixelRatio:3,backgroundColor:"#ffffff",cacheBust:!0,width:o,height:i,style:{margin:"0",padding:"0",transform:"none",overflow:"visible"},skipAutoScale:!1,preferDimensions:!0};let c;return t==="jpeg"?c=await at(a,u):c=await rt(a,u),a.style.overflow=s.overflow,a.style.width=s.width,a.style.position=s.position,c},Ve=async()=>{if(!n){alert("Please generate a receipt first");return}const t=r.phone;if(!t){alert("Student phone number is required to send via WhatsApp");return}let a=t.replace(/\D/g,"");a.length===10&&(a="91"+a),!a.startsWith("91")&&a.length===12&&(a=a.substring(0,2)==="91"?a:"91"+a),ge(!0);try{const s=await J("jpeg"),i=await(await fetch(s)).blob(),u=new File([i],`Receipt_${n.receiptNo}.jpg`,{type:"image/jpeg"}),c=`📄 *Fee Payment Receipt - Coder & AccoTax* 📄
...
Do you want to continue without saving to database?`))return;let a="",s="";if(r.feeType==="monthly"&&r.periodFrom&&r.periodTo){const i=F(r.periodFrom,r.periodTo),u=parseFloat(r.monthlyFeeAmount);a=`${je(r.periodFrom)} to ${je(r.periodTo)}`,s=` (${i} months × ₹${u.toLocaleString("en-IN")} = ₹${(i*u).toLocaleString("en-IN")})`}const o=Be(r.studentName,r.course,r.paymentDate,r.feesPaid);if(Te({studentName:r.studentName,phone:r.phone,course:r.course,feeType:r.feeType,feesPaid:r.feesPaid,monthlyFeeAmount:r.monthlyFeeAmount,paymentDate:Ge(r.paymentDate),paymentMode:r.paymentMode,period:a,monthlyBreakdown:s,receiptNo:o,registrationNumber:r.registrationNumber,collectedBy:ye(),collectorDesignation:be()}),N&&j){const i=await Oe(o);alert(i?"✓ Receipt generated and saved to database successfully!":"⚠️ Receipt generated but failed to save to database. You can still save/print the receipt.")}},Ke=()=>{if(!n){alert("Please generate a receipt first");return}const t=window.open("","_blank","width=800,height=600");if(!t){alert("Please allow pop-ups to print the receipt");return}const a=Ne(parseFloat(n.feesPaid)),s=parseFloat(n.feesPaid).toLocaleString("en-IN"),o=ke(n.paymentMode),i=new Date().toLocaleString("en-IN",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}),u=Re||"/assets/cnat.png",c=Ie||X;t.document.write(`
    <!DOCTYPE html>
    <html>
      <head>
