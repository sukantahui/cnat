...
1. ANTI-PATTERNS CATALOG:\r
   - God Object     &rarr; Cured by SRP.\r
   - Hardcoded 'new' &rarr; Cured by DIP & Dependency Injection.\r
   - Giant Switches &rarr; Cured by OCP & Strategy Pattern.\r
   - Fat Interfaces &rarr; Cured by ISP.\r
   - Fragile Child  &rarr; Cured by LSP.\r
\r
================================================================================\r
...
================================================================================`,o=[{question:"What is the 'God Object' anti-pattern and how do SOLID principles eliminate it?",shortAnswer:"A God Object is an oversized class that aggregates unrelated responsibilities (UI, database, calculations, email). Applying the Single Responsibility Principle (SRP) decomposes the God Object into cohesive, focused services.",explanation:"God Objects lead to severe merge conflicts and regression bugs.",hint:"A giant class doing everything; cured by applying SRP to split responsibilities.",level:"Beginner",codeExample:"// Anti-pattern: class ApplicationManager { void doEverything(); }"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_011 · Topic 11"}),e.jsx("span",{className:"px-3 py-1 bg-amber-500/10 text-amber-400 border border-amber-500/20 text-xs font-semibold rounded-full",children:"Anti-Pattern Diagnostics"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Code Smells & Anti-Patterns: God Object, Spaghetti Code & Tight Coupling"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Diagnose and eliminate the most destructive design flaws in enterprise software: identifying God Objects, tangled spaghetti logic, tight coupling, and shotgun surgery."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"CodeSmellsAndAntiPatternsDemo.java",highlightLines:[7,13,17,21,25]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Code Smells FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:i,title:"Module 002_011 Topic 11: Code Smells & Anti-Patterns",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_011_topic11_code_smells_note.txt"})}),e.jsx(s,{note:"If changing a button color requires editing 10 different files, you are suffering from 'Shotgun Surgery'! SOLID principles keep related code together and unrelated code separate. — Sukanta Hui"})]})}export{x as default};
