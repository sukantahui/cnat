...
\r
1. CRUD SUMMARY:\r
   - CREATE &rarr; 'pstmt.executeUpdate()' (Returns 1 on successful insert).\r
   - READ   &rarr; 'pstmt.executeQuery()'   (Returns ResultSet; iterate with 'rs.next()').\r
   - UPDATE &rarr; 'pstmt.executeUpdate()' (Returns count of updated rows).\r
   - DELETE &rarr; 'pstmt.executeUpdate()' (Returns count of deleted rows).\r
\r
2. IDEMPOTENCY:\r
