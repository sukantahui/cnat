import{b as a,j as e}from"./vendor-react-core-C47mfheO.js";import{T as v}from"./TeacherSukantaHui-3YGS5w6g.js";import{P as s}from"./PythonFileLoader-D8ceUcTQ.js";import{F as _}from"./FAQTemplate-D7324Ho6.js";import{P as w}from"./PlainTextPrint-COK-Ppq5.js";import"./vendor-icons-C5r6Bfkl.js";import"./PythonCodeBlock-Dc6jy8v_.js";import"./vendor-prism-BKuZ5wk-.js";const C=[{question:"What is the primary difference between `screen.onclick()` and `turtle.onclick()`?",shortAnswer:"`screen.onclick()` triggers anywhere on canvas background; `turtle.onclick()` triggers only when clicking that specific turtle's visible sprite.",explanation:"Allows separating global canvas interactions from individual clickable buttons and game entities.",hint:"Which method clicks global canvas versus a specific sprite?",level:"basic",codeExample:`screen.onclick(stamp_bg)
