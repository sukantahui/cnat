import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{J as t}from"./JavaFileLoader-BfBG3xz_.js";import{F as o}from"./FAQTemplate-CkSqDH4B.js";import{P as n}from"./PlainTextPrint-C08xhKA4.js";import{T as r}from"./TeacherSukantaHui-CyIG3xbg.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";import"./vendor-icons-CIaKtAt4.js";const i=`/**\r
...
================================================================================`,a=[{question:"Why should utility methods accept 'Collection<E>' rather than specific concrete types like 'ArrayList<E>'?",shortAnswer:"Following the OOP principle 'Program to an interface, not an implementation'. Accepting 'Collection<E>' allows the method to operate polymorphically on ANY collection type (ArrayList, LinkedList, HashSet, TreeSet, PriorityQueue) without requiring overloaded methods or restrictive type constraints.",explanation:"Standard design pattern found throughout Java libraries and Spring Framework.",hint:"Enables polymorphic interoperability across Lists, Sets, and Queues without tight coupling.",level:"Beginner",codeExample:"public static <E> void print(Collection<E> c) { ... } // Accepts Lists, Sets, Queues"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 007_001 · Topic 3"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Collection Contract"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The Core Collection Interface: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"java.util.Collection<E>"})," Contract"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Apply loose coupling principles: programming to the ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"java.util.Collection"})," interface to build generic utilities that operate seamlessly across Lists, Sets, and Queues."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"CoreCollectionInterfaceContractDemo.java",highlightLines:[7,10,13,14,15,27,28,32,34,35]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(o,{title:"Collection Interface FAQs",questions:a})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:l,title:"Module 007_001 Topic 3: java.util.Collection Interface",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"007_001_topic3_collection_interface_note.txt"})}),e.jsx(r,{note:"Always program to the interface! If you write 'void print(Collection<String> c)', your method can print an ArrayList today and a HashSet tomorrow without changing a single line of code! — Sukanta Hui"})]})}export{x as default};
