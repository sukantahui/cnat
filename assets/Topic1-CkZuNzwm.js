import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{J as t}from"./JavaFileLoader-BfBG3xz_.js";import{F as n}from"./FAQTemplate-CkSqDH4B.js";import{P as i}from"./PlainTextPrint-C08xhKA4.js";import{T as r}from"./TeacherSukantaHui-CC0AKmkm.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";import"./vendor-icons-BtJHuk7w.js";const a=`/**\r
...
================================================================================\r
`,o=[{question:"What does the acronym ACID stand for in database transaction management?",shortAnswer:"Atomicity, Consistency, Isolation, and Durability.",explanation:"The universal benchmark for relational database reliability.",hint:"Atomicity, Consistency, Isolation, Durability.",level:"Beginner",codeExample:"ACID = Atomicity + Consistency + Isolation + Durability"},{question:"Which of the ACID properties is directly controlled in JDBC by setting the Transaction Isolation Level?",shortAnswer:"Isolation (via connection.setTransactionIsolation(level)).",explanation:"Controls the visibility of uncommitted and concurrently committed changes.",hint:"Isolation.",level:"Beginner",codeExample:"conn.setTransactionIsolation(Connection.TRANSACTION_READ_COMMITTED);"}];function A(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 011_004 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Transactions & ACID"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The ACID Properties: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"Overview & Principles"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"The 4 pillars of database reliability: analyzing Atomicity, Consistency, Isolation, and Durability in mission-critical architectures."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"AcidPropertiesOverviewDemo.java",highlightLines:[18,25,34,43]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Transaction & ACID FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(i,{content:s,title:"Module 011_004 Topic 1: ACID Properties Overview",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"011_004_topic1_acid_properties_overview_note.txt"})}),e.jsx(r,{note:"ACID stands for Atomicity, Consistency, Isolation, and Durability! These four principles are what differentiate enterprise SQL databases from naive file stores! — Sukanta Hui"})]})}export{A as default};
