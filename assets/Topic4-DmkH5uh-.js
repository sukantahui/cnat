...
comparison makes it easy to identify the optimal solution."`,H=()=>{const[r,g]=a.useState("concept"),[x,u]=a.useState({}),[c,b]=a.useState(null),[d,y]=a.useState(null),f=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],v=[{id:1,title:"Example 1: Maximization with Two Corner Points",problem:`Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
x ≥ 0, y ≥ 0
