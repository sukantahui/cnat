...
}`}),e.jsx("p",{className:"text-xs text-slate-500",children:"Full Notification Center is in the next topic."})]}),e.jsx("footer",{className:"text-slate-400 text-sm pt-10 border-t border-slate-800",children:"You now understand professional DOM engineering fundamentals used in real UI frameworks."})]})}}export{N as default};
