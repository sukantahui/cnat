import{b as n,j as e,bh as r}from"./vendor-react-core-CaA1o1Cx.js";import{T as y}from"./TeacherSukantaHui-Ds9F9lLV.js";import{F as A}from"./FAQTemplate-D_90hN4m.js";import{P as v}from"./PlainTextPrint-yt10TRX1.js";import{P as k}from"./PythonFileLoader-DUNJ9gwR.js";import"./vendor-icons-ri6cs58t.js";import"./PythonCodeBlock-PUup0iW5.js";import"./vendor-prism-CCfIgi4B.js";const I=[{id:1,question:"What is the primary architectural difference between SAML 2.0, OAuth 2.0, and OpenID Connect (OIDC)?",shortAnswer:"SAML 2.0: Enterprise XML-based protocol for user authentication and Web Browser SSO. OAuth 2.0: Delegated authorization framework for API resource access. OpenID Connect (OIDC): Identity/Authentication layer built directly on top of OAuth 2.0 using JSON and JWTs.",explanation:"OAuth 2.0 grants API access (authorization); OIDC asserts user identity (authentication); SAML federates enterprise web logins.",hint:"SAML = Enterprise XML SSO; OAuth = API Authorization; OIDC = Identity layer over OAuth using JWTs.",level:"Basic",codeExample:`// Protocol Essence:
