import{b as o,j as e,bg as d}from"./vendor-react-core-Doz9nIC6.js";import{T as i}from"./TeacherSukantaHui-BaJcBHAy.js";import{J as a}from"./JavaFileLoader-BfBG3xz_.js";import"./vendor-icons-8ao-0upJ.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";const c=`\r
public class SelectionSortBasic {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nRoll numbers: " + "[");\r
        for (int i = 0; i < rollNos.length; i++) {\r
            System.out.print(rollNos[i] + (i < rollNos.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        selectionSort(rollNos);\r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Sorted rolls: " + "[");\r
        for (int i = 0; i < rollNos.length; i++) {\r
            System.out.print(rollNos[i] + (i < rollNos.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class SelectionSortOptimized {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Sorted heights: " + "[");\r
        for (int i = 0; i < heights.length; i++) {\r
            System.out.print(heights[i] + (i < heights.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
