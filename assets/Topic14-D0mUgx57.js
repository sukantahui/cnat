...
================================================================================\r
`,i=[{question:"How does the Strategy pattern eliminate massive if-else or switch-case conditional ladders?",shortAnswer:"By encapsulating each branch of the conditional logic into an independent strategy object implementing a common interface, allowing the client to execute the appropriate algorithm polymorphically without branching statements.",explanation:"Adheres to the Open-Closed Principle.",hint:"Encapsulates branching algorithm variants into polymorphic strategy objects.",level:"Beginner",codeExample:"context.setStrategy(new HighDiscountStrategy());"},{question:"What is the standard example of the Strategy pattern built directly into the Java Standard Library?",shortAnswer:"java.util.Comparator<T> passed to Collections.sort() or Stream.sorted().",explanation:"Allows passing custom comparison algorithms dynamically.",hint:"java.util.Comparator interface.",level:"Beginner",codeExample:"list.sort((a, b) -> Double.compare(a.score(), b.score()));"}];function h(){return t.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[t.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 012_001 · Topic 14"}),t.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"GoF Design Patterns"})]}),t.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The Strategy Pattern: ",t.jsx("code",{className:"text-emerald-400 font-mono",children:"Interchangeable Algorithms"})]}),t.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Algorithm abstraction: swapping payment calculations, sorting strategies, and compression algorithms dynamically using Java 8 Lambdas and Functions."})]}),t.jsxs("section",{className:"space-y-4",children:[t.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[t.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),t.jsx(e,{fileModule:o,title:"StrategyPatternDemo.java",highlightLines:[18,25,34,43]})]}),t.jsx("section",{className:"space-y-4",children:t.jsx(a,{title:"GoF Design Patterns FAQs",questions:i})}),t.jsx("section",{className:"space-y-4",children:t.jsx(r,{content:s,title:"Module 012_001 Topic 14: Strategy Pattern",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"012_001_topic14_strategy_pattern_note.txt"})}),t.jsx(n,{note:"In Java 8+, the Strategy pattern became effortless! Instead of creating 5 separate strategy classes, any Functional Interface (like Function<Double, Double> or Comparator<T>) is instantly a Strategy! — Sukanta Hui"})]})}export{h as default};
