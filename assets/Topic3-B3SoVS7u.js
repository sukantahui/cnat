import{j as e}from"./index-BQNsLvl4.js";import{E as s}from"./EditablePythonCodeBlock-CvO-TvqP.js";import"./index-Bf_FrdBe.js";import"./createLucideIcon-DfWMkJeo.js";import"./braces-DoP_KH8v.js";import"./layout-list-wnHrvZcu.js";import"./play-BGY4BZxw.js";import"./type-B3clx7CX.js";import"./refresh-cw-DeSTVkrw.js";import"./copy-ggF1ebug.js";import"./download-DAPiigzn.js";import"./eye-off-C-SnOcmU.js";import"./eye-Cp7rdNMW.js";function j(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Comparison Operators in Python"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Comparison (or relational) operators compare two values and return",e.jsx("code",{children:" True "})," or ",e.jsx("code",{children:" False"}),". They are commonly used in decision-making, loops, and validations."]}),e.jsxs("section",{className:"space-y-3",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Comparison Operators in Python"}),e.jsxs("ul",{className:"list-disc ml-6 text-slate-300 text-sm space-y-1",children:[e.jsxs("li",{children:[e.jsx("code",{children:"=="})," → Equal to"]}),e.jsxs("li",{children:[e.jsx("code",{children:"!="})," → Not equal to"]}),e.jsxs("li",{children:[e.jsx("code",{children:">"})," → Greater than"]}),e.jsxs("li",{children:[e.jsx("code",{children:"<"})," → Less than"]}),e.jsxs("li",{children:[e.jsx("code",{children:">="})," → Greater than or equal to"]}),e.jsxs("li",{children:[e.jsx("code",{children:"<="})," → Less than or equal to"]})]}),e.jsx(s,{initialCode:`a = 10
b = 20
