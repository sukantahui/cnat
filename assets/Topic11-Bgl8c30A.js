import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{J as s}from"./JavaScriptEditableCodeBlock-anV405v0.js";import"./vendor-monaco-Bv7hoEkV.js";import"./vendor-icons-CIaKtAt4.js";const i=`// Example 1: Totals – sum, average, product\r
\r
const students = [\r
...
console.log("Marks frequency:", marksFrequency);`,l=new Date().getFullYear(),d=l-1998,p=()=>{const a=[{name:"Swadeep",marks:85,city:"Barrackpore CNAT"},{name:"Tuhina",marks:92,city:"Naihati CNAT"},{name:"Abhronila",marks:78,city:"Barrackpore CNAT"},{name:"Debangshu",marks:88,city:"Naihati CNAT"},{name:"Ritaja",marks:95,city:"Barrackpore CNAT"}],t=a.reduce((r,n)=>r+n.marks,0);return e.jsxs("div",{className:"min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-6 md:p-8 leading-relaxed",children:[e.jsx("style",{children:`
