import{b as f,j as e}from"./vendor-react-core-BBXbtqt1.js";import{F as C}from"./vendor-monaco-sD6ueU9e.js";import{ac as k,aj as N,bV as L,ad as T,ae as b,af as z,m as M,a6 as E,a7 as F,bb as H,bc as R,c as D,D as O,bW as P,r as J,s as B}from"./vendor-icons-CKN6-nXc.js";class w extends f.Component{constructor(t){super(t),this._postMessageHandler=n=>{!n.data||!n.data.type||n.data.type==="console"&&this.setState(c=>({consoleOutput:[...c.consoleOutput,{type:n.data.level||"log",message:n.data.message}]}))},window.addEventListener("message",this._postMessageHandler,!1);const o=n=>this.normalizeCode(n||""),a=t.initialSnippets||{},i=o(a.javascript??t.initialCode??""),l=o(a.html??`<!-- HTML goes here -->
