import{j as e}from"./index-CUXXvONC.js";import{E as s}from"./EditablePythonCodeBlock-Dpqbbyu1.js";import"./index-CBpdwEID.js";import"./createLucideIcon-O_Er4fpW.js";import"./braces-B4AyVXmG.js";import"./layout-list-GoT0ASd9.js";import"./play-DNNbdgtV.js";import"./type-Bunlk4m9.js";import"./refresh-cw-BO9f_BLL.js";import"./copy-rP0aAxF9.js";import"./download-C-zK-a1m.js";import"./eye-off-DR1p6kU7.js";import"./eye-CH8Le7yy.js";function j(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Python Indentation, Comments, Variables & User Input"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"This topic explains the foundation of Python syntax—indentation rules, comments, variables, naming conventions, core data types, type casting, and taking input from the user. These are essential concepts used in every Python program from beginner to advanced level."}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Python Indentation Rules"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Python uses **indentation instead of braces `","`** to define blocks. Incorrect indentation results in an error."]}),e.jsx(s,{initialCode:`# Correct indentation
if 5 > 2:
