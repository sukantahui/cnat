...
console.log(finalPrice);`}),e.jsx("p",{className:"text-slate-400 text-xs italic",children:"Try this in your JavaScript Playground!"})]})}export{n as default};
