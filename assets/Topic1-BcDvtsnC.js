...
the method correctly."`,O=()=>{const[x,h]=n.useState("concept"),[b,u]=n.useState({}),[c,y]=n.useState(null),[m,p]=n.useState(null),v=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],f=[{id:1,title:"Example 1: Converting to Standard Form",problem:`Convert the following LP problem to standard form:
Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
