import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as n}from"./JavaFileLoader-CVw5Mqo9.js";import{F as t}from"./FAQTemplate-BamsZuNW.js";import{P as r}from"./PlainTextPrint-CGJ_aUDk.js";import{T as o}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const a=`/**\r
...
1. SPECIAL-VALUE METHODS:\r
   - 'offer(e)' → returns 'false' if bounded queue is full.\r
   - 'poll()' → returns 'null' if queue is empty.\r
   - 'peek()' → returns 'null' without removing head.\r
   - Zero exception allocation overhead; high throughput standard.\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,s=[{question:"Why are 'offer()', 'poll()', and 'peek()' overwhelmingly preferred in concurrent, network, and high-performance Java applications?",shortAnswer:"Because creating and throwing Java exceptions incurs severe CPU and memory performance penalties (allocating exception objects, capturing stack traces, and unwinding the JVM execution stack). Returning special values ('false' on full, 'null' on empty) allows algorithms to handle buffer states using lightweight branch checks (e.g. 'if (item == null)'), achieving maximum throughput.",explanation:"Fundamental performance guideline for Java concurrency and messaging architectures.",hint:"Avoids the heavy JVM performance penalty of creating and unwinding exception stack traces.",level:"Intermediate",codeExample:"Task t = queue.poll(); if (t != null) { process(t); } // Zero exception overhead"}];function h(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 007_004 · Topic 3"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Special Value Methods"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Special-Value Methods: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"offer()"}),", ",e.jsx("code",{className:"text-sky-400 font-mono",children:"poll()"})," & ",e.jsx("code",{className:"text-amber-400 font-mono",children:"peek()"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Build high-throughput queue consumers: utilizing ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"offer(e)"}),", ",e.jsx("code",{className:"text-sky-300 font-mono",children:"poll()"}),", and ",e.jsx("code",{className:"text-amber-300 font-mono",children:"peek()"})," for zero-exception buffer management."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:a,title:"QueueSpecialValueMethodsDemo.java",highlightLines:[7,10,16,17,24,25,26,33,34]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Special-Value Methods FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:l,title:"Module 007_004 Topic 3: Special-Value Queue Methods",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"007_004_topic3_special_value_queue_methods_note.txt"})}),e.jsx(o,{note:"'poll()' and 'offer()' are the industry standard in production microservices and concurrency! If you want clean, lightning-fast code that never crashes on empty queues, always use special-value methods! — Sukanta Hui"})]})}export{h as default};
