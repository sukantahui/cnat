import{b as o,j as e,bg as d}from"./vendor-react-core-Doz9nIC6.js";import{T as i}from"./TeacherSukantaHui-BaJcBHAy.js";import{J as l}from"./JavaFileLoader-BfBG3xz_.js";import"./vendor-icons-8ao-0upJ.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";const c=`\r
public class BubbleSortDescending {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nStudent high scores: " + "[");\r
        for (int i = 0; i < highScores.length; i++) {\r
            System.out.print(highScores[i] + (i < highScores.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        bubbleSortDescending(highScores);\r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Ranked scores (highest first): " + "[");\r
        for (int i = 0; i < highScores.length; i++) {\r
            System.out.print(highScores[i] + (i < highScores.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class BubbleSortDescendingOptimized {\r
    ...
    public static void main(String[] args) {\r
        ...
        for (int i = 0; i < descending.length; i++) {\r
            System.out.print(descending[i] + (i < descending.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Original: " + "[");\r
        for (int i = 0; i < ascending.length; i++) {\r
            System.out.print(ascending[i] + (i < ascending.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        bubbleSortDescending(ascending);\r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Sorted descending: " + "[");\r
        for (int i = 0; i < ascending.length; i++) {\r
            System.out.print(ascending[i] + (i < ascending.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class BubbleSortDescendingWithCompare {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Original numbers: " + "[");\r
