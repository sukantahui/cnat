import{c as q,r as n,j as e,e as ne,f as Ne,Q as ke,g as oe}from"./index-BH7vN50S.js";import{P as W}from"./prism-json-BDj9u0af.js";/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Se=[["path",{d:"m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526",key:"1yiouv"}],["circle",{cx:"12",cy:"8",r:"6",key:"1vp47v"}]],ie=q("award",Se);/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ze=[["path",{d:"M10 14.66v1.626a2 2 0 0 1-.976 1.696A5 5 0 0 0 7 21.978",key:"1n3hpd"}],["path",{d:"M14 14.66v1.626a2 2 0 0 0 .976 1.696A5 5 0 0 1 17 21.978",key:"rfe1zi"}],["path",{d:"M18 9h1.5a1 1 0 0 0 0-5H18",key:"7xy6bh"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M6 9a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1z",key:"1mhfuq"}],["path",{d:"M6 9H4.5a1 1 0 0 1 0-5H6",key:"tex48p"}]],Ee=q("trophy",ze);function Te({code:b="",initialCode:l="",language:o="javascript"}){const c=l||b,[N,v]=n.useState("");return n.useEffect(()=>{const k=W.highlight(c,W.languages[o]||W.languages.javascript,o);v(k)},[c,o]),e.jsx("div",{className:"my-4 rounded-xl overflow-hidden border border-slate-700 bg-[#0f172a] shadow-lg",children:e.jsx("pre",{className:"p-4 overflow-auto text-sm leading-6",children:e.jsx("code",{className:`language-${o}`,dangerouslySetInnerHTML:{__html:N}})})})}const de="quizEngine_",Ie="quizLeaderboard_";function ce(b){const l=[...b];for(let o=l.length-1;o>0;o--){const c=Math.floor(Math.random()*(o+1));[l[o],l[c]]=[l[c],l[o]]}return l}function Z(b,l){if(!Array.isArray(b))return[];const o=ce(b),c=l?Math.min(l,o.length):o.length;return o.slice(0,c).map(v=>{const k=v.options.map((j,F)=>({text:j,originalIndex:F})),O=ce(k),B=O.findIndex(j=>j.originalIndex===v.answerIndex);return{...v,options:O.map(j=>j.text),answerIndex:B}})}function $e(){const b="certificate_counter";let l=parseInt(localStorage.getItem(b),10);(isNaN(l)||l<1)&&(l=1);const o=new Date().getFullYear(),c=String(l).padStart(5,"0"),N=`CAT-${o}-${c}`;return localStorage.setItem(b,l+1),N}function De({title:b="Quiz Test",questions:l=[],testId:o="test_default",questionLimit:c=25,certificateHeader:N="Coder & AccoTax",certificateSubtitle:v="Barrackpore · www.codernaccotax.co.in",certificateTitle:k="Certificate of Completion",leaderboardTitle:O="Coder & AccoTax Leaderboard",showStudentName:B=!0,passPercent:j=60,onResultSubmit:F}){const S=de+o,P=Ie+o,H=de+"best_"+o,[u,R]=n.useState([]),[C,A]=n.useState({}),[w,z]=n.useState({}),[h,E]=n.useState(0),[g,T]=n.useState(!1),[D,_]=n.useState(!1),[y,G]=n.useState(""),[J,xe]=n.useState(!1),[Y,U]=n.useState([]),[ee,K]=n.useState({}),[m,te]=n.useState(c||25),[L,pe]=n.useState("All"),se=n.useRef([]),re=n.useRef(!1),p=n.useMemo(()=>{if(!Array.isArray(l))return[];if(L==="All")return l;const t=L.toLowerCase();let s=l.filter(a=>a.level?String(a.level).toLowerCase()===t:!0);return s.length||(s=l),s},[l,L]);n.useEffect(()=>{const t=localStorage.getItem(P);if(t)try{const s=JSON.parse(t);U(Array.isArray(s)?s:[])}catch{U([])}},[P]),n.useEffect(()=>{const t=localStorage.getItem(H);if(t)try{const s=JSON.parse(t);s&&typeof s=="object"&&K(s)}catch{K({})}},[H]),n.useEffect(()=>{if(!J||!p||!p.length)return;const t=localStorage.getItem(S);if(t)try{const r=JSON.parse(t),x=r&&r.submitted&&Object.keys(r.submitted).length>0;if(Array.isArray(r.quiz)&&r.quiz.length){R(r.quiz),A(r.responses||{}),z(r.submitted||{}),E(r.score||0),T(!!r.isFinished);const i=r.quiz&&r.quiz.length||c;te(i);return}else if(!x&&Array.isArray(r.quiz)){R(r.quiz),A(r.responses||{}),z(r.submitted||{}),E(r.score||0),T(!1);return}}catch{}const s=m&&m>0?Math.min(m,p.length):Math.min(c||25,p.length),a=Z(p,s);R(a),A({}),z({}),E(0),T(!1),_(!1)},[J,p,m,S,c]),n.useEffect(()=>{if(!u.length)return;const t={quiz:u,responses:C,submitted:w,score:h,isFinished:g};localStorage.setItem(S,JSON.stringify(t))},[u,C,w,h,g,S]);const me=t=>{const s=se.current[t];if(!s)return;const a=s.getBoundingClientRect().top+window.scrollY-120;window.scrollTo({top:a,behavior:"smooth"})},ue=(t,s)=>{w[t]||A(a=>({...a,[t]:s}))},be=(t,s)=>{if(w[t.id])return;C[t.id]===t.answerIndex&&E(r=>r+1),z(r=>{const x={...r,[t.id]:!0};return Object.keys(x).length===u.length&&T(!0),x}),!D&&s+1<u.length&&setTimeout(()=>me(s+1),600)},fe=()=>{if(!p.length)return;const t=m&&m>0?Math.min(m,p.length):Math.min(c||25,p.length),s=Z(p,t);R(s),A({}),z({}),E(0),T(!1),_(!1),localStorage.removeItem(S),window.scrollTo({top:0,behavior:"smooth"})},ae=u.filter(t=>w[t.id]&&C[t.id]!==t.answerIndex),he=D?ae:u,ge=()=>{if(!u.length)return;const t=u.length,s=t?Number((h/t*100).toFixed(2)):0,a={name:y.trim()||"Guest",score:h,total:t,percent:s,date:new Date().toISOString()};U(r=>{const x=[...r,a];x.sort((d,f)=>f.percent!==d.percent?f.percent-d.percent:f.score!==d.score?f.score-d.score:new Date(f.date)-new Date(d.date));const i=x.slice(0,10);return localStorage.setItem(P,JSON.stringify(i)),i}),K(r=>{const x={...r},i=t,d=x[i];return(!d||s>d.percent)&&(x[i]={score:h,total:t,percent:s,date:a.date}),localStorage.setItem(H,JSON.stringify(x)),x}),typeof F=="function"&&F({...a,testId:o})};n.useEffect(()=>{!re.current&&g&&ge(),re.current=g},[g,h,u.length]);const ye=()=>{const t=y||"Student Name",s=u.length,a=s?(h/s*100).toFixed(2):"0.00",r=new Date().toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"}),x=$e(),i=parseFloat(a);let d="D";i>=85?d="A+":i>=70?d="A":i>=60?d="B":i>=50&&(d="C");const f=i>=j,M=`
<!DOCTYPE html>
<html>
<head>
<title>${k}</title>
...
<div class="page">
  <div class="certificate">
    ...
    <div class="seal">
      <img src="${oe}" alt="Coder & AccoTax Logo" />
    </div>
  </div>
</div>
