import{r as c,j as t}from"./index-CJBYzsBp.js";import{P as v}from"./PrintButton-C1X6baug.js";import{J as u}from"./JavaCodeBlock-mMDJ51Fq.js";import{P as j}from"./prism-Dc-XSp4L.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
