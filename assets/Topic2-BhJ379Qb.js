import{r as a,j as e}from"./index-D8vKF2mq.js";import{J as t}from"./JavaFileLoader-WyjnB8lQ.js";import{T as s}from"./TeacherSukantaHui-DjhHYUAb.js";import{F as r}from"./FAQTemplate-vk816vUa.js";import"./JavaCodeBlock-Cn8snDcq.js";import"./prism-DqVe0I4H.js";import"./browser-iABTCUld.js";import"./prism-java-BwO6k4I_.js";import"./github-CLhUlPeX.js";import"./createLucideIcon-DTJ5VPt2.js";import"./git-branch-ivLG4H_K.js";import"./clsx-B-dksMZM.js";const n=[{question:"What happens if you declare an abstract method in a non-abstract class?",shortAnswer:"Compiler error: 'The abstract method can only be defined by an abstract class'.",explanation:"Java requires that any class containing an abstract method must be declared abstract. This ensures that incomplete classes cannot be instantiated.",hint:"If a class has an abstract method, it's incomplete — mark it abstract.",level:"basic",codeExample:"class Bad { abstract void m(); } // ERROR"},{question:"Can you instantiate an abstract class using the 'new' keyword?",shortAnswer:"No, abstract classes cannot be instantiated directly.",explanation:"Abstract classes are incomplete (may have abstract methods without bodies). Java prevents creating instances to avoid calling undefined methods.",hint:"You can only instantiate concrete subclasses.",level:"basic",codeExample:`abstract class A {}
...
}`,A=()=>{const[c,d]=a.useState(!1);return e.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 py-12 px-4 sm:px-6 lg:px-8",children:[e.jsx("style",{children:`
