...
\r
1. PARSING METHODS:\r
   - 'Integer.parseInt(str)'    &rarr; Returns primitive 'int'.\r
   - 'Double.parseDouble(str)'  &rarr; Returns primitive 'double'.\r
   - 'Boolean.parseBoolean(str)'&rarr; Returns 'true' (case-insensitive) or 'false'.\r
   - 'Integer.valueOf(str)'     &rarr; Returns cached 'Integer' object.\r
\r
================================================================================\r
...
Integer b = Integer.valueOf("42");`}];function I(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_003 · Topic 10"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"String Parsing API"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Parsing Strings to Primitives: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"parseInt()"}),", ",e.jsx("code",{className:"text-sky-400 font-mono",children:"parseDouble()"})," & ",e.jsx("code",{className:"text-amber-400 font-mono",children:"parseBoolean()"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Learn how to convert raw string inputs from web requests into strongly-typed primitives: understanding ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"parseInt()"})," versus ",e.jsx("code",{className:"text-indigo-300 font-mono",children:"valueOf()"}),"."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:s,title:"ParsingStringsToPrimitivesDemo.java",highlightLines:[7,14,18,22,27,28]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"String Parsing FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{content:i,title:"Module 003_003 Topic 10: String to Primitive Parsing",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_003_topic10_string_parsing_note.txt"})}),e.jsx(a,{note:"If you need a primitive int, call 'Integer.parseInt()'. If you need an object for a List, call 'Integer.valueOf()'! — Sukanta Hui"})]})}export{I as default};
