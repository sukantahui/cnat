import{b as d,j as e}from"./vendor-react-core-Doz9nIC6.js";function z(s){const r=[...s];for(let a=r.length-1;a>0;a--){const c=Math.floor(Math.random()*(a+1));[r[a],r[c]]=[r[c],r[a]]}return r}function $({data:s}){const[r,a]=d.useState([]),[c,g]=d.useState("all"),[x,u]=d.useState(50),[p,b]=d.useState(!1),[l,f]=d.useState([]);if(!s||!s.questions)return e.jsx("p",{className:"p-4 text-red-400",children:"No questions found."});const j=[...new Set(s.questions.map(t=>t.topic))],v=c==="all"?s.questions:s.questions.filter(t=>t.topic===c);function w(t){a(i=>i.includes(t)?i.filter(h=>h!==t):[...i,t])}const n=t=>t?t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):"",k=()=>{if(!l.length)return;const t={name:"Coder & AccoTax",phone:"+91 7003756860",website:"https://codernaccotax.co.in"},i=`${window.location.origin}/assets/cnat-stamp.png`,h=`${s.subject} – ${s.topic} (${s.class}, ${s.board})`,m=window.open("","_blank");m.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
                <title>${n(h)}</title>
