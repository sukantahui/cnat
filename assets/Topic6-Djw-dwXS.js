import{j as e}from"./index-CNd73Haf.js";import{E as s}from"./EditablePythonCodeBlock-BCJ0JjXJ.js";import"./index-C68hWScs.js";import"./braces-Cz3Z1Lm3.js";import"./layout-list-jrwsTbkC.js";import"./play-k0XU6a0C.js";import"./type-l-7TR-1d.js";import"./refresh-cw-Cs1Cy281.js";import"./copy-Dqgrnt6d.js";import"./download-D0l-akX2.js";import"./eye-off-BFt-f9pX.js";import"./eye-CWJNugV0.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Core Data Types in Python — int, float, str, bool"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["Python has four essential built-in data types used in the foundation of every program:",e.jsx("code",{children:"int"}),", ",e.jsx("code",{children:"float"}),", ",e.jsx("code",{children:"str"}),", and ",e.jsx("code",{children:"bool"}),". These types are dynamically assigned, meaning Python automatically decides the type based on the value."]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. int (Integer)"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Used for whole numbers — no decimals allowed. Python can store very large integers without overflow."}),e.jsx(s,{initialCode:`a = 10
b = -50
