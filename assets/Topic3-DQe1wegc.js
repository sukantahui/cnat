import{b as a,j as e}from"./vendor-react-core-D9iF7FwR.js";import{T as v}from"./TeacherSukantaHui-Bldu0y17.js";import{P as s}from"./PythonFileLoader-D5JKxZvU.js";import{F as _}from"./FAQTemplate-DmdkpHR-.js";import{P as w}from"./PlainTextPrint-CS96sBe2.js";import"./vendor-icons-Beb6eGc1.js";import"./PythonCodeBlock-Dy3OqNFl.js";import"./vendor-prism-SANIKoEh.js";const C=[{question:"What is the primary difference between `screen.onclick()` and `turtle.onclick()`?",shortAnswer:"`screen.onclick()` triggers anywhere on canvas background; `turtle.onclick()` triggers only when clicking that specific turtle's visible sprite.",explanation:"Allows separating global canvas interactions from individual clickable buttons and game entities.",hint:"Which method clicks global canvas versus a specific sprite?",level:"basic",codeExample:`screen.onclick(stamp_bg)
