import{b as p,j as e}from"./vendor-react-core-Doz9nIC6.js";import{T as u}from"./TeacherSukantaHui-BaJcBHAy.js";import{F as f}from"./FAQTemplate-BHhlgA96.js";import{P as O}from"./PlainTextPrint-C08xhKA4.js";import{E as b}from"./EditableCCodeBlock-B2f2kdYR.js";import"./vendor-icons-8ao-0upJ.js";import"./vendor-monaco-Bv7hoEkV.js";const y=[{question:"What is the exact time complexity of the C loop: for(int i = 1; i < n; i *= 2)?",options:["O(n)","O(log_2 n)","O(n^2)","O(sqrt(n))"],correctAnswer:1,explanation:"In each step, i doubles (1, 2, 4, 8, ... 2^k). The loop terminates when 2^k >= n, which yields k = ceil(log_2 n) iterations, resulting in O(log n) time complexity."},{question:`What is the time complexity of the nested loops:
for(int i = 1; i < n; i *= 2)
