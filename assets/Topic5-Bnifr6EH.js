import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as a}from"./FAQTemplate-BamsZuNW.js";import{P as r}from"./PlainTextPrint-CGJ_aUDk.js";import{T as n}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const i=`/**\r
...
================================================================================`,o=[{question:"What are the implicit modifiers applied to regular methods in an interface?",shortAnswer:"They are implicitly 'public' and 'abstract'.",explanation:"Even if declared simply as 'void run();', the compiler translates it to 'public abstract void run();'.",hint:"Implicitly public and abstract.",level:"Beginner",codeExample:"interface Worker { void work(); // public abstract void work(); }"}];function h(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_008 · Topic 5"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Method Contracts"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Interface Methods: Implicitly ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"public abstract"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Learn why traditional interface methods are implicitly public abstract, and how the compiler verifies implementations in child classes."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"TraditionalInterfaceMethodsDemo.java",highlightLines:[12,13,17,22,31,32]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Traditional Interface Methods FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 002_008 Topic 5: Interface Methods",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_008_topic5_interface_methods_note.txt"})}),e.jsx(n,{note:"Writing 'void run();' in an interface is identical to 'public abstract void run();'. Keep your code clean and let Java handle the defaults! — Sukanta Hui"})]})}export{h as default};
