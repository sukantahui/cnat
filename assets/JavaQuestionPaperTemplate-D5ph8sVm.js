import{r as c,j as t}from"./index-C0mc_94R.js";import{P as v}from"./PrintButton-BboEEhdv.js";import{J as u}from"./JavaCodeBlock-DVZM98Yl.js";import{P as j}from"./prism-Dde13G4z.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
