...
ToastCenter.info("Welcome to Coder & AccoTax.");`})]}),t.jsxs("footer",{className:"pt-8 pb-6 border-t border-slate-800 text-slate-400 text-sm",children:[t.jsx("p",{className:"mb-1",children:"In this **Animated Notification Center** topic, you learned how to design a reusable, high-quality toast system with DOM APIs, animations, queues and helpers."}),t.jsx("p",{children:'This is the same pattern used in real dashboards and SPA frameworks. With this, your students move from "JavaScript learner" to **UI engineer** level. 🚀'})]})]})}}export{T as default};
