import{b as o,j as e,bg as d}from"./vendor-react-core-Doz9nIC6.js";import{T as s}from"./TeacherSukantaHui-DDN87fI5.js";import{J as a}from"./JavaFileLoader-BfBG3xz_.js";import"./vendor-icons-DEsnU7fn.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";const m=`\r
public class FindSmallestBasic {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nTemperatures: " + "[");\r
        for (int i = 0; i < temperatures.length; i++) {\r
            System.out.print(temperatures[i] + (i < temperatures.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        ...
        for (int i = 0; i < ages.length; i++) {\r
            System.out.print(ages[i] + (i < ages.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class FindSmallestWithIndex {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nStudent heights: " + "[");\r
        for (int i = 0; i < heights.length; i++) {\r
            System.out.print(heights[i] + (i < heights.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class FindSmallestMultiple {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nBarrackpore School Scores: " + "[");\r
        for (int i = 0; i < studentScores.length; i++) {\r
            System.out.print(studentScores[i] + (i < studentScores.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class FindSmallestObjects {\r
    ...
    public static void main(String[] args) {\r
        ...
        \r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Products: " + "[");\r
        for (int i = 0; i < products.length; i++) {\r
            System.out.print(products[i] + (i < products.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        \r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nPrices: " + "[");\r
        for (int i = 0; i < prices.length; i++) {\r
            System.out.print(prices[i] + (i < prices.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
}`}),e.jsx("p",{className:"text-sm text-emerald-700 dark:text-emerald-300 mt-2",children:"Smallest value emerges"})]})]}),e.jsxs("p",{className:"text-center text-slate-400 dark:text-gray-300 mt-4 text-sm",children:["💡 Only ONE character changes: ",e.jsx("code",{className:"bg-gray-200 dark:bg-gray-700 px-1 rounded",children:">"})," becomes ",e.jsx("code",{className:"bg-gray-200 dark:bg-gray-700 px-1 rounded",children:"<"})]})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"⚙️ How It Works"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"space-y-3 text-slate-400 dark:text-gray-300",children:[e.jsxs("p",{children:["1️⃣ ",e.jsx("strong",{children:"Initialize"})," min = arr[0] (assume first element is smallest)"]}),e.jsxs("p",{children:["2️⃣ ",e.jsx("strong",{children:"Traverse"})," array from index 1 to n-1"]}),e.jsxs("p",{children:["3️⃣ ",e.jsx("strong",{children:"Compare"})," each element with current min"]}),e.jsxs("p",{children:["4️⃣ ",e.jsx("strong",{children:"Update min"})," if current element is smaller"]}),e.jsxs("p",{children:["5️⃣ ",e.jsx("strong",{children:"After loop"}),", min contains the smallest value"]}),e.jsxs("p",{children:["6️⃣ ",e.jsx("strong",{children:"Optional"})," - Track index of min element"]})]}),e.jsxs("div",{className:"bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 p-4 rounded-lg",children:[e.jsx("h3",{className:"font-semibold text-slate-200 mb-2",children:"Analogy"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300",children:"Finding lightest backpack:"}),e.jsxs("ul",{className:"text-sm text-slate-400 dark:text-gray-300 mt-2 list-disc list-inside",children:[e.jsx("li",{children:"Start with first backpack's weight as lightest"}),e.jsx("li",{children:"Check each backpack one by one"}),e.jsx("li",{children:"If lighter found, update lightest"}),e.jsx("li",{children:"After checking all, you know the lightest!"})]})]})]})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"🌍 Real-World Examples"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300",children:[e.jsx("h3",{className:"font-semibold text-slate-200 mb-2",children:"💰 Lowest Price"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300",children:"Shopping app finding cheapest product in Barrackpore market - comparing prices to find minimum!"})]}),e.jsxs("div",{className:"bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300",children:[e.jsx("h3",{className:"font-semibold text-slate-200 mb-2",children:"🏃 Fastest Race Time"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300",children:"Sports meet finding winner - smallest time wins!"})]}),e.jsxs("div",{className:"bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300",children:[e.jsx("h3",{className:"font-semibold text-slate-200 mb-2",children:"🌡️ Lowest Temperature"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300",children:"Weather app finding coldest day in Shyamnagar this week."})]}),e.jsxs("div",{className:"bg-slate-950/60 dark:bg-gray-700/50 p-4 rounded-lg group hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300",children:[e.jsx("h3",{className:"font-semibold text-slate-200 mb-2",children:"📊 Lowest Score"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300",children:"Teacher finding lowest test score to identify students needing extra help."})]})]})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"📊 Complexity Analysis"}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-3",children:[e.jsxs("div",{className:"text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg",children:[e.jsx("p",{className:"text-xs text-slate-400",children:"Best Case"}),e.jsx("p",{className:"text-xl font-bold text-green-600",children:"O(n)"}),e.jsx("p",{className:"text-xs",children:"Still check all elements"})]}),e.jsxs("div",{className:"text-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg",children:[e.jsx("p",{className:"text-xs text-slate-400",children:"Average Case"}),e.jsx("p",{className:"text-xl font-bold text-yellow-600",children:"O(n)"}),e.jsx("p",{className:"text-xs",children:"n comparisons"})]}),e.jsxs("div",{className:"text-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg",children:[e.jsx("p",{className:"text-xs text-slate-400",children:"Worst Case"}),e.jsx("p",{className:"text-xl font-bold text-red-600",children:"O(n)"}),e.jsx("p",{className:"text-xs",children:"n comparisons"})]}),e.jsxs("div",{className:"text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg",children:[e.jsx("p",{className:"text-xs text-slate-400",children:"Space"}),e.jsx("p",{className:"text-xl font-bold text-blue-600",children:"O(1)"}),e.jsx("p",{className:"text-xs",children:"Only 1 variable"})]})]})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"⚠️ Edge Cases to Consider"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:[e.jsxs("div",{className:"p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg",children:[e.jsx("span",{className:"font-semibold text-yellow-800",children:"Single element array"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300 mt-1",children:"Returns that element directly"})]}),e.jsxs("div",{className:"p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg",children:[e.jsx("span",{className:"font-semibold text-yellow-800",children:"All elements equal"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300 mt-1",children:"Returns the value (any works)"})]}),e.jsxs("div",{className:"p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg",children:[e.jsx("span",{className:"font-semibold text-yellow-800",children:"Negative numbers"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300 mt-1",children:"Works fine - most negative is minimum"})]}),e.jsxs("div",{className:"p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg",children:[e.jsx("span",{className:"font-semibold text-yellow-800",children:"Empty array"}),e.jsx("p",{className:"text-sm text-slate-400 dark:text-gray-300 mt-1",children:"Should throw exception or return special value"})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl p-6",children:[e.jsx("h3",{className:"text-xl font-semibold text-white mb-3",children:"💡 Tips & Tricks"}),e.jsxs("ul",{className:"space-y-2 text-slate-300",children:[e.jsxs("li",{children:["• ",e.jsx("strong",{children:"One character difference:"})," Finding min uses ",e.jsx("code",{className:"bg-gray-200 dark:bg-gray-700 px-1 rounded",children:"<"})," instead of ",e.jsx("code",{className:"bg-gray-200 dark:bg-gray-700 px-1 rounded",children:">"})]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"Track index too:"})," Use ",e.jsx("code",{className:"bg-gray-200 dark:bg-gray-700 px-1 rounded",children:"minIndex"})," if position matters"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"Handle empty array:"})," Always check ",e.jsx("code",{className:"bg-gray-200 dark:bg-gray-700 px-1 rounded",children:"if (arr == null || arr.length == 0)"})]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"Use Integer.MAX_VALUE:"})," Alternative initialization for empty check"]}),e.jsxs("li",{children:["• ",e.jsx("strong",{children:"Find both min and max:"})," Can do in single pass for efficiency!"]})]})]}),e.jsx(s,{note:"Finding min is the perfect partner to finding max! I tell students: 'If you can find the tallest, you can find the shortest - just flip the comparison.' This builds pattern recognition. Challenge: Find both min and max in one pass - it's only slightly more complex!"})]}),n==="visual"&&e.jsxs("div",{className:"space-y-6 animate-[fadeInUp_0.4s_ease-out]",children:[e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"👁️ Visual Walkthrough"}),e.jsx(u,{}),e.jsx("p",{className:"text-center text-sm text-slate-400 mt-4",children:"Watch how the minimum value updates as we scan through the array"})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"📐 Algorithm Flowchart"}),e.jsx(p,{})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"📝 Dry Run Example"}),e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"min-w-full divide-y divide-gray-200 dark:divide-gray-700",children:[e.jsx("thead",{className:"bg-slate-950/60 dark:bg-gray-700/50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"px-3 py-2 text-left text-sm font-semibold",children:"Step"}),e.jsx("th",{className:"px-3 py-2 text-left text-sm font-semibold",children:"i"}),e.jsx("th",{className:"px-3 py-2 text-left text-sm font-semibold",children:"arr[i]"}),e.jsx("th",{className:"px-3 py-2 text-left text-sm font-semibold",children:"Current Min"}),e.jsx("th",{className:"px-3 py-2 text-left text-sm font-semibold",children:"Comparison"}),e.jsx("th",{className:"px-3 py-2 text-left text-sm font-semibold",children:"Action"})]})}),e.jsx("tbody",{className:"divide-y divide-gray-200 dark:divide-gray-700",children:[{step:1,i:0,val:45,min:45,compare:"-",action:"Initialize min = 45"},{step:2,i:1,val:67,min:45,compare:"67 < 45? No",action:"No change"},{step:3,i:2,val:23,min:45,compare:"23 < 45? Yes",action:"✓ Update min = 23"},{step:4,i:3,val:89,min:23,compare:"89 < 23? No",action:"No change"},{step:5,i:4,val:12,min:23,compare:"12 < 23? Yes",action:"✓ Update min = 12"},{step:6,i:5,val:78,min:12,compare:"78 < 12? No",action:"No change"},{step:7,i:6,val:34,min:12,compare:"34 < 12? No",action:"No change"}].map((r,t)=>e.jsxs("tr",{className:r.action.includes("Update")?"bg-emerald-50 dark:bg-emerald-900/20":"",children:[e.jsx("td",{className:"px-3 py-2 text-sm",children:r.step}),e.jsx("td",{className:"px-3 py-2 text-sm",children:r.i}),e.jsx("td",{className:"px-3 py-2 text-sm",children:r.val}),e.jsx("td",{className:"px-3 py-2 text-sm font-semibold",children:r.min}),e.jsx("td",{className:"px-3 py-2 text-sm",children:r.compare}),e.jsx("td",{className:"px-3 py-2 text-sm",children:r.action})]},t))})]})})]}),e.jsx(s,{note:"The visual animation clearly shows the 'min' variable decreasing. I have students compare this with the max animation - they'll see it's the mirror image. This reinforces that algorithms are patterns, and small changes produce different results!"})]}),n==="code"&&e.jsxs("div",{className:"space-y-6 animate-[fadeInUp_0.4s_ease-out]",children:[e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"💻 Code Examples"}),e.jsxs("div",{className:"space-y-6",children:[e.jsx(a,{fileModule:m,title:"FindSmallestBasic.java",highlightLines:[]}),e.jsx(a,{fileModule:c,title:"FindSmallestWithIndex.java",highlightLines:[]}),e.jsx(a,{fileModule:x,title:"FindSmallestMultiple.java",highlightLines:[]}),e.jsx(a,{fileModule:h,title:"FindSmallestObjects.java",highlightLines:[]})]})]}),e.jsx(s,{note:"Compare the code with find max - they're almost identical! This is a powerful lesson: understanding one operation teaches the other. Have students modify the max code to find min by changing just one character. This builds confidence and pattern recognition!"})]}),n==="practice"&&e.jsxs("div",{className:"space-y-6 animate-[fadeInUp_0.4s_ease-out]",children:[e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"⚠️ Common Pitfalls"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg",children:[e.jsx("span",{className:"text-red-600 text-xl",children:"❌"}),e.jsxs("div",{children:[e.jsx("p",{className:"font-semibold",children:"Using > instead of <"}),e.jsxs("p",{className:"text-sm",children:["Using ",e.jsx("code",{className:"bg-gray-200 px-1 rounded",children:"if (arr[i] > min)"})," finds maximum instead of minimum!"]})]})]}),e.jsxs("div",{className:"flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg",children:[e.jsx("span",{className:"text-red-600 text-xl",children:"❌"}),e.jsxs("div",{children:[e.jsx("p",{className:"font-semibold",children:"Initializing min = 0"}),e.jsx("p",{className:"text-sm",children:"Fails if all numbers are positive - min would incorrectly remain 0"})]})]}),e.jsxs("div",{className:"flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg",children:[e.jsx("span",{className:"text-red-600 text-xl",children:"❌"}),e.jsxs("div",{children:[e.jsx("p",{className:"font-semibold",children:"Not handling empty array"}),e.jsx("p",{className:"text-sm",children:"Accessing arr[0] on empty array causes ArrayIndexOutOfBoundsException"})]})]})]})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"✅ Best Practices"}),e.jsxs("ul",{className:"space-y-2 text-slate-400 dark:text-gray-300 list-disc list-inside",children:[e.jsx("li",{children:"Always check for null and empty array before processing"}),e.jsxs("li",{children:["Use ",e.jsx("code",{className:"bg-gray-200 px-1 rounded",children:"Integer.MAX_VALUE"})," for generic initialization"]}),e.jsx("li",{children:"Consider returning index instead of value when position matters"}),e.jsx("li",{children:"Document behavior for empty arrays (exception or special return)"}),e.jsxs("li",{children:["Use meaningful variable names: ",e.jsx("code",{className:"bg-gray-200 px-1 rounded",children:"minValue"})," not ",e.jsx("code",{className:"bg-gray-200 px-1 rounded",children:"m"})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl p-6",children:[e.jsx("h3",{className:"text-xl font-semibold text-white mb-3",children:"💭 Think About..."}),e.jsxs("ul",{className:"space-y-2 text-slate-300",children:[e.jsx("li",{children:"🤔 How would you find the second smallest element?"}),e.jsx("li",{children:"🤔 Can we find both min and max in fewer than 2n comparisons?"}),e.jsx("li",{children:"🤔 How would you find the minimum absolute value?"}),e.jsx("li",{children:"🤔 What's the difference between finding min in sorted vs unsorted array?"})]})]}),e.jsxs("div",{className:"bg-slate-800/40 border border-slate-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6",children:[e.jsx("h2",{className:"text-2xl font-semibold text-white mb-4",children:"🎯 Questions & Answers"}),e.jsx("div",{className:"space-y-4",children:g.map((r,t)=>e.jsxs("details",{className:"group border border-slate-800 rounded-lg",children:[e.jsx("summary",{className:"cursor-pointer p-4 font-medium text-slate-200 hover:bg-slate-950/60 dark:hover:bg-gray-700/50 transition-all duration-300",children:r.question}),e.jsx("div",{className:"p-4 pt-0 text-slate-400 dark:text-gray-300 border-t border-slate-800",children:r.answer})]},t))})]}),e.jsx(s,{note:"Finding min reinforces the pattern from finding max. I challenge students: 'Write one method that can find either min or max based on a parameter.' This builds flexible, reusable code skills. In Barrackpoor, we use min to find lowest scores for improvement plans!"})]})]})]}),e.jsx("style",{children:`
        @keyframes fadeInUp {
          from {
            opacity: 0;
