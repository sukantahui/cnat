...
function check(n){
  if(n>0){
    ...
    console.log("Not positive")
        ...
        `}),e.jsx("p",{className:"text-slate-400 text-xs italic",children:"Try it inside the JavaScript Playground!"})]})}export{m as default};
