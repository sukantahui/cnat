...
def test():
    return 10
    print("Hello")`}),e.jsxs("div",{className:"bg-red-900/30 border-l-4 border-red-400 p-3 text-sm text-red-200",children:[e.jsx("strong",{children:"⚠ Teacher Warning:"}),e.jsx("code",{children:"break"})," and ",e.jsx("code",{children:"continue"})," can be used only inside loops, while ",e.jsx("code",{children:"return"})," can be used only inside functions."]})]})]})}}export{f as default};
