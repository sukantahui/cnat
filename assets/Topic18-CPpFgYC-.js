...
1. MODULE 007_005 GRAND SUMMARY:\r
   ...
   - Treeification: >= 8 nodes (table >= 64) &rarr; TreeNode<K,V> (O(log n)).\r
   - Untreeification: <= 6 nodes &rarr; converts back to Node<K,V> (hysteresis).\r
