...
2. EXECUTION SEMANTICS:\r
   - If stream is empty &rarr; returns 'Optional.empty()'.\r
   - If stream has 1 element &rarr; returns 'Optional.of(element)' without invoking accumulator.\r
   - If stream has N elements &rarr; first element is used as initial accumulator, then combined\r
