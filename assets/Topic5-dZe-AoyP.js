...
solution changes."`,I=()=>{const[t,d]=a.useState("concept"),[s,l]=a.useState({}),[r,c]=a.useState(null),[i,h]=a.useState(null),x=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],g=[{id:1,title:"Example 1: Redundant Constraint",problem:`Maximize Z = 3x + 2y
Subject to:
x + y ≤ 10
2x + y ≤ 16
x ≤ 8
...
Conclusion: x + y ≤ 8 is redundant. Constraints 1 and 2 are essential.`}],m=[{id:1,title:"Find the Redundant Constraint",problem:`Maximize Z = 4x + 3y
Subject to:
2x + y ≤ 12
x + 3y ≤ 15
x ≤ 5
