import{j as e}from"./index-BZ1-3x1c.js";import{E as s}from"./EditableCodeBlock-CKZO-IaZ.js";import"./index-DAcJ947v.js";import"./braces-ZDFjoAI2.js";import"./file-code-D4gRmL_O.js";import"./layout-list-Dn_aCmq2.js";import"./play-CsDulOQL.js";import"./type-kdgV3pfK.js";import"./refresh-cw-CkAsW6bT.js";import"./wand-sparkles-DS7jgEjp.js";import"./copy-DRd4XZHU.js";import"./download-B2rqWgWV.js";import"./eye-off-BQZr5nas.js";import"./eye-hnPwCMtS.js";const t="animate-[fadeIn_0.8s_ease-out]",b=()=>e.jsxs("div",{className:`space-y-10 ${t}`,children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx("h2",{className:"text-xl font-bold text-sky-300 tracking-wide animate-[slideDown_0.5s_ease-out]",children:"Synchronous vs Asynchronous Code"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed animate-[fadeIn_1s_ease-out]",children:["JavaScript is ",e.jsx("strong",{children:"single-threaded"})," and executes code in a"," ",e.jsx("strong",{children:"synchronous"})," order unless asynchronous features are used. In Coder & AccoTax learning apps, async code is crucial for loading quizzes, scores, and student reports without blocking the UI."]})]}),e.jsxs("div",{className:"p-4 border border-sky-700 bg-sky-900/30 rounded-xl shadow-md animate-[fadeIn_1.2s_ease-out]",children:[e.jsx("h4",{className:"text-sky-300 font-semibold mb-1 text-sm",children:"💡 Why Learn Async?"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Async code improves speed and user experience by preventing the UI from freezing. It allows tasks like API calls, timers, and database operations to run efficiently."})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold text-slate-200 animate-[slideRight_0.5s_ease-out]",children:"1. Synchronous Code (Blocking)"}),e.jsx(s,{initialCode:`console.log("1. Start");
