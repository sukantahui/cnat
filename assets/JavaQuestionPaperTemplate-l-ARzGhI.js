import{r as c,j as t}from"./index-DaJZPAzN.js";import{P as v}from"./PrintButton-CkASLXDL.js";import{J as u}from"./JavaCodeBlock-Bcd8JLFq.js";import{P as j}from"./prism-e-aEJA5c.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
