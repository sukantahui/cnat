import{b as a,j as e,bm as i}from"./vendor-react-core-BBXbtqt1.js";import{T as f}from"./TeacherSukantaHui-VMH_OtYp.js";import{F as w}from"./FAQTemplate-BamsZuNW.js";import{P as v}from"./PlainTextPrint-CGJ_aUDk.js";import{P as k}from"./PythonFileLoader-YugaCzY9.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const A=[{id:1,question:"What two core technical specifications constitute the FIDO2 standard framework?",shortAnswer:"1. W3C Web Authentication (WebAuthn): The standardized JavaScript browser API; 2. FIDO Client-to-Authenticator Protocol 2 (CTAP2): The protocol enabling browsers to communicate with external hardware authenticators (USB/NFC/BLE) and platform security chips.",explanation:"WebAuthn operates at the application/browser layer, while CTAP2 manages low-level binary message framing to physical security keys.",hint:"W3C WebAuthn (browser API) + FIDO CTAP2 (hardware communication protocol).",level:"Basic",codeExample:`// FIDO2 Architecture:
