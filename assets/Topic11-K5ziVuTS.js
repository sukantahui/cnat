...
# Cleanup
rm -rf testdata test.tar test.tar.gz test.tar.bz2 test.tar.xz test_gz9.tar.gz test_bz2_9.tar.bz2 test_xz9.tar.xz`,U=()=>{const c=new Date().getFullYear()-1998,[r,d]=s.useState("create"),[a,h]=s.useState("gzip"),[n,p]=s.useState(6),[i,x]=s.useState(!1),[N,_]=s.useState(!1),[m,l]=s.useState(!1);s.useEffect(()=>{l(!0),setTimeout(()=>l(!1),300)},[r,a,n,i]);const g=()=>a==="gzip"?".tar.gz":a==="bzip2"?".tar.bz2":a==="xz"?".tar.xz":".tar",f=()=>{let t="tar ";return r==="create"&&(t+="-c"),r==="extract"&&(t+="-x"),r==="list"&&(t+="-t"),i&&(t+="v"),a==="gzip"&&(t+="z"),a==="bzip2"&&(t+="j"),a==="xz"&&(t+="J"),t+="f archive"+g(),r==="create"&&(t+=" /path/to/source"),t},z=()=>r==="create"?`${i?`file1.txt
file2.txt
subdir/file3.txt
`:""}Compression level: ${n}
