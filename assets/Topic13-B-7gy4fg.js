...
})();`}),t.jsxs("p",{className:"text-slate-400 text-xs",children:["💡 Now you can simply call ",t.jsx("code",{children:'ToastManager.success("Saved!")'})," from anywhere."]})]}),t.jsxs("section",{className:"space-y-6",children:[t.jsx("h2",{className:"text-2xl font-semibold text-indigo-300",children:"6. Full Project – Notification Center (Summary Version)"}),t.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["This final snippet shows a **compact but complete** version of the Notification Center. You can copy this into a separate ",t.jsx("code",{children:"toast.js"})," file and reuse it across projects."]}),t.jsx(e,{language:"javascript",initialCode:`// toast.js
(function () {
...
})();`}),t.jsx("p",{className:"text-slate-400 text-sm",children:"📌 Now in any page, you can simply call:"}),t.jsx(e,{language:"javascript",initialCode:`ToastCenter.success("Student added successfully!");
ToastCenter.error("Failed to save marks.");
ToastCenter.info("Welcome to Coder & AccoTax.");`})]}),t.jsxs("footer",{className:"pt-8 pb-6 border-t border-slate-800 text-slate-400 text-sm",children:[t.jsx("p",{className:"mb-1",children:"In this **Animated Notification Center** topic, you learned how to design a reusable, high-quality toast system with DOM APIs, animations, queues and helpers."}),t.jsx("p",{children:'This is the same pattern used in real dashboards and SPA frameworks. With this, your students move from "JavaScript learner" to **UI engineer** level. 🚀'})]})]})}}export{N as default};
