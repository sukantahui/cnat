import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as a}from"./FAQTemplate-BamsZuNW.js";import{P as r}from"./PlainTextPrint-CGJ_aUDk.js";import{T as n}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const o=`/**\r
...
================================================================================`,i=[{question:"What capability does implementing 'java.lang.Iterable<T>' grant to a custom Java class?",shortAnswer:"Implementing 'java.lang.Iterable<T>' allows instances of your custom class to be used as the target of the enhanced for-each loop ('for (T item : myCustomClass)'). It requires overriding 'public Iterator<T> iterator()' and automatically inherits the functional 'forEach(Consumer)' default method introduced in Java 8.",explanation:"The root gateway to all collection iteration in the Java language.",hint:"Enables using instances directly in enhanced for-each loops and grants the forEach() method.",level:"Beginner",codeExample:"public class CustomBatch implements Iterable<Student> { public Iterator<Student> iterator() { ... } }"}];function f(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 007_001 · Topic 2"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Root Interface"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["The Root Interface: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"java.lang.Iterable<T>"})," & ",e.jsx("code",{className:"text-sky-400 font-mono",children:"forEach()"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master collection iteration roots: understanding how ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"Iterable<T>"})," powers enhanced for-each loops, iterator cursors, and Java 8 functional consumers."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:o,title:"IterableInterfaceAndForEachDemo.java",highlightLines:[7,10,18,19,20,25,26,27,32]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Iterable FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 007_001 Topic 2: java.lang.Iterable",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"007_001_topic2_iterable_interface_note.txt"})}),e.jsx(n,{note:"Any time you write 'for (String s : list)', Java is quietly calling 'list.iterator()' behind the scenes! By implementing 'Iterable<T>', you can make your own custom classes work in for-each loops too! — Sukanta Hui"})]})}export{f as default};
