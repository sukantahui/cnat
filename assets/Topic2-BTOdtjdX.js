import{j as e}from"./index-Ci-Q4Ner.js";import{E as s}from"./EditablePythonCodeBlock-DkW4Rnvh.js";import"./index-BovWnrwo.js";import"./braces-D0GgDFCR.js";import"./layout-list-CNeoJZsF.js";import"./play-CUvMdlUb.js";import"./type-BkofYUDL.js";import"./refresh-cw-DVq0w9yy.js";import"./copy-CVYVE7uU.js";import"./download-D2yIxL3J.js";import"./eye-off-CfVEqTtg.js";import"./eye-DWv5isVy.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Variables, Keywords, Identifiers & Python’s Dynamic Typing"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"In Python, variables do not need explicit type declarations. Their type is determined automatically based on the assigned value. This topic explains how variables work, naming rules, Python keywords, and how Python stores and reuses memory references."}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. What is a Variable?"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"A variable is a name that refers to a value stored in memory. Python creates a variable automatically when you assign a value to it."}),e.jsx(s,{initialCode:`x = 10
y = 3.14
name = "Sukanta Hui"
is_student = True
