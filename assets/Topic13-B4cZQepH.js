import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as n}from"./JavaFileLoader-CVw5Mqo9.js";import{F as t}from"./FAQTemplate-BamsZuNW.js";import{P as a}from"./PlainTextPrint-CGJ_aUDk.js";import{T as o}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const r=`/**\r
...
// Deep: clone.loc == orig.loc (false)`}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_010 · Topic 13"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Memory Mutation"})]}),e.jsx("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:"Shallow Copy vs Deep Copy Mechanics in Memory"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Trace how shallow copies share heap references, discover the accidental mutation side-effects on nested objects, and contrast with independent deep copying."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:r,title:"ShallowVsDeepCopyMemoryDemo.java",highlightLines:[12,17,24,38,43,44]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Shallow vs Deep Copy FAQs",questions:l})}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{content:i,title:"Module 002_010 Topic 13: Shallow vs Deep Copy",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_010_topic13_shallow_deep_copy_note.txt"})}),e.jsx(o,{note:"If Swadeep and Tuhina share the same house address object in a shallow copy, changing Tuhina's city will change Swadeep's city too! That is why shallow copy can be dangerous for mutable fields. — Sukanta Hui"})]})}export{b as default};
