import{j as e}from"./index-CNNP-EED.js";import{E as s}from"./EditablePythonCodeBlock-Cc3UyVDk.js";import"./index-B_hKKDE8.js";import"./braces-QBjObA3O.js";import"./layout-list-CeTmCPSq.js";import"./play-DAKE_zJf.js";import"./type-BjJFPXAY.js";import"./refresh-cw-DrD0jpdY.js";import"./copy-BQOvbT5P.js";import"./download-COgPc9qQ.js";import"./eye-off-BSiLqLab.js";import"./eye-Q1EsGrCZ.js";function h(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Introduction to Python Operators"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Operators are symbols used to perform operations on variables and values. Python provides a wide range of operators—from arithmetic to logical to expression evaluation. This topic lays the foundation for mastering them."}),e.jsxs("section",{className:"space-y-3",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Arithmetic Operators"}),e.jsxs("p",{className:"text-sm text-slate-300",children:["Arithmetic operators perform mathematical operations. Python supports: ",e.jsx("strong",{children:"+, -, *, /, //, %, **"})]}),e.jsx(s,{initialCode:`a = 10
b = 3
