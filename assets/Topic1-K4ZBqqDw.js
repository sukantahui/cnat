...
================================================================================`,i=[{question:"Explain the key differences between an Operating System 'Process' and a Java 'Thread'.",shortAnswer:"A 'Process' is an independent heavyweight program executing in its own isolated memory address space; processes communicate via complex Inter-Process Communication (IPC) and a crash in one does not affect others. A 'Thread' is a lightweight unit of execution within a process that shares the JVM Heap, Metaspace, and open file handles with other threads in that same process, communicating easily via shared objects with fast context switching.",explanation:"Core operating systems and multithreading foundation question.",hint:"Processes have isolated memory spaces; threads share heap memory within the same process.",level:"Beginner",codeExample:"long pid = ProcessHandle.current().pid(); // OS Process ID"}];function y(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 008_001 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Process vs Thread"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:[e.jsx("code",{className:"text-emerald-400 font-mono",children:"Process"})," vs ",e.jsx("code",{className:"text-sky-400 font-mono",children:"Thread"}),": Address Space Isolation vs Shared Memory Concurrency"]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Understand runtime boundaries: contrasting isolated OS process address spaces and Inter-Process Communication against lightweight in-process shared memory threads."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(s,{fileModule:a,title:"ProcessVsThreadComparisonDemo.java",highlightLines:[7,10,13,14,15,19,20,21,22,23,24]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Process vs Thread FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:o,title:"Module 008_001 Topic 1: Process vs Thread",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"008_001_topic1_process_vs_thread_note.txt"})}),e.jsx(n,{note:"Think of an OS Process like an entire house with its own private address and fence. Inside the house, the family members are Threads—they share the kitchen (Heap memory) and living room, but each person has their own private notebook (Call Stack)! — Sukanta Hui"})]})}export{y as default};
