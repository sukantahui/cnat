import{b as o,j as e,bh as i}from"./vendor-react-core-CaA1o1Cx.js";const R=()=>{const[j,k]=o.useState([]),[u,c]=o.useState(null),[q,D]=o.useState({}),[_,f]=o.useState([{id:1,name:"Swadeep",action:"Submit Assignment",location:"Barrackpore",status:"pending"},{id:2,name:"Tuhina",action:"Ask Question",location:"Shyamnagar",status:"completed"},{id:3,name:"Abhronila",action:"Request Leave",location:"Naihati",status:"pending"},{id:4,name:"Debangshu",action:"Report Issue",location:"Ichapur",status:"in-progress"}]),[d,b]=o.useState({value1:0,value2:0,operation:"+",result:0,history:[]}),[T,x]=o.useState([{id:1,text:"Learn onClick with arguments",completed:!0,priority:"high"},{id:2,text:"Practice onChange patterns",completed:!1,priority:"medium"},{id:3,text:"Master form onSubmit",completed:!1,priority:"high"},{id:4,text:"Build event handling app",completed:!1,priority:"low"}]),[p,m]=o.useState([{id:101,name:"React Book",price:29.99,quantity:1,category:"Books"},{id:102,name:"JavaScript Guide",price:19.99,quantity:2,category:"Books"},{id:103,name:"Web Dev Course",price:99.99,quantity:1,category:"Courses"}]),l=(t,a="info")=>{k(s=>[{id:Date.now(),message:t,type:a,timestamp:new Date().toLocaleTimeString()},...s.slice(0,9)])},N=(t,a)=>{c({name:t,location:a}),l(`Inline arrow: ${t} from ${a}`,"inline-arrow")},w=(t,a)=>()=>{c({name:t,location:a}),l(`Wrapper function: ${t} from ${a}`,"wrapper")},C=t=>{const a=t.target.dataset.name,s=t.target.dataset.location;a&&s&&(c({name:a,location:s}),l(`Data attribute: ${a} from ${s}`,"data-attr"))},y=((t,a)=>(...s)=>{l(`Starting: ${a}`,"logging");const r=t(...s);return l(`Completed: ${a}`,"logging"),r})((t,a)=>{f(s=>s.map(r=>r.id===t?{...r,status:a}:r))},"Update Action Status"),g=t=>{const a=parseFloat(d.value1)||0,s=parseFloat(d.value2)||0;let r;switch(t){case"+":r=a+s;break;case"-":r=a-s;break;case"*":r=a*s;break;case"/":r=s!==0?a/s:"Error: Division by zero";break;default:r=0}b(n=>({...n,operation:t,result:r,history:[`${a} ${t} ${s} = ${r}`,...n.history.slice(0,4)]})),l(`Calculator: ${a} ${t} ${s} = ${r}`,"calculator")},S=(t,a)=>{b(s=>({...s,[t]:a}))},h=(t,a)=>{switch(a){case"toggle":x(r=>r.map(n=>n.id===t?{...n,completed:!n.completed}:n)),l(`Toggled todo ${t}`,"todo");break;case"delete":x(r=>r.filter(n=>n.id!==t)),l(`Deleted todo ${t}`,"todo");break;case"priority-up":const s={low:"medium",medium:"high",high:"high"};x(r=>r.map(n=>n.id===t?{...n,priority:s[n.priority]||n.priority}:n)),l(`Increased priority for todo ${t}`,"todo");break}},v=(t,a)=>{switch(a){case"increment":m(s=>s.map(r=>r.id===t?{...r,quantity:r.quantity+1}:r)),l(`Incremented item ${t}`,"cart");break;case"decrement":m(s=>s.map(r=>r.id===t&&r.quantity>1?{...r,quantity:r.quantity-1}:r)),l(`Decremented item ${t}`,"cart");break;case"remove":m(s=>s.filter(r=>r.id!==t)),l(`Removed item ${t} from cart`,"cart");break}},A=(t,a)=>{l(`Custom event with data: ${JSON.stringify(a)}`,"custom"),console.log("Original event:",t.type)},U=()=>{k([]),c(null),D({}),f([{id:1,name:"Swadeep",action:"Submit Assignment",location:"Barrackpore",status:"pending"},{id:2,name:"Tuhina",action:"Ask Question",location:"Shyamnagar",status:"completed"},{id:3,name:"Abhronila",action:"Request Leave",location:"Naihati",status:"pending"},{id:4,name:"Debangshu",action:"Report Issue",location:"Ichapur",status:"in-progress"}]),b({value1:0,value2:0,operation:"+",result:0,history:[]}),x([{id:1,text:"Learn onClick with arguments",completed:!0,priority:"high"},{id:2,text:"Practice onChange patterns",completed:!1,priority:"medium"},{id:3,text:"Master form onSubmit",completed:!1,priority:"high"},{id:4,text:"Build event handling app",completed:!1,priority:"low"}]),m([{id:101,name:"React Book",price:29.99,quantity:1,category:"Books"},{id:102,name:"JavaScript Guide",price:19.99,quantity:2,category:"Books"},{id:103,name:"Web Dev Course",price:99.99,quantity:1,category:"Courses"}]),l("All examples reset","reset")},I=p.reduce((t,a)=>t+a.price*a.quantity,0);return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 p-4 md:p-8 transition-colors duration-500",children:[e.jsx("style",{children:`
