import{r as d,u as A,j as e,L as I}from"./index-D8vKF2mq.js";import{c as a}from"./clsx-B-dksMZM.js";import{c as P}from"./createLucideIcon-DTJ5VPt2.js";import{Z as B}from"./zap-CqUXHZjQ.js";import{L as h}from"./Topic7-B6gJxdmC.js";import{C as T}from"./cpu-B4yLEwYV.js";import{C as c}from"./circle-check-big-BQLaoYLE.js";import{P as D}from"./puzzle-DNJTKpmX.js";import{G as R}from"./git-branch-ivLG4H_K.js";import{A as U}from"./x-eJHJrUf-.js";const L=[["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]],E=P("box",L),Q=()=>{const[x,u]=d.useState(!0),[i,g]=d.useState("basics"),[n,b]=d.useState(0),[p,f]=d.useState(!1),{moduleSlug:M,topicIndex:z}=A(),y=()=>{u(!x)};d.useEffect(()=>{f(!0)},[]);const m={title:"React Components: Building Blocks of UI",analogy:"Like Lego bricks - small, reusable pieces that combine to create complex structures",description:"Components are independent, reusable pieces of UI. They can be as small as a button or as large as an entire page.",characteristics:["Receive data via props","Return JSX describing UI","Can maintain internal state","Reusable across application"]},l=[{title:"Simple Button Component",code:`function PrimaryButton({ children, onClick }) {
  return (
    <button 
      onClick={onClick}
