...
================================================================================`,i=[{question:"Which wrapper classes in Java DO NOT have any caching mechanism, and why?",shortAnswer:"'Float' and 'Double' do not have any caching pools. Because there are infinite floating-point decimal values between any two numbers (e.g. between 0.0 and 1.0), maintaining a cache would be computationally impossible and waste memory.",explanation:"Byte, Short, Integer, Long, Character, and Boolean all support caching.",hint:"Float and Double do not cache values due to infinite decimal fractions.",level:"Intermediate",codeExample:"Double d1 = 1.0, d2 = 1.0; // (d1 == d2) is ALWAYS false!"}];function C(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_003 · Topic 7"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Cache Landscape"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Caching in Other Wrappers: ",e.jsx("code",{className:"text-sky-400 font-mono",children:"Byte"}),", ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"Character"})," & ",e.jsx("code",{className:"text-amber-400 font-mono",children:"Boolean"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Survey caching mechanisms across the entire wrapper family: ASCII character pooling, byte caching, and why ",e.jsx("code",{className:"text-rose-400 font-mono",children:"Float"})," and ",e.jsx("code",{className:"text-rose-400 font-mono",children:"Double"})," never cache instances."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:o,title:"OtherWrapperCachingMechanicsDemo.java",highlightLines:[7,14,15,16,17,18,19,20,21,28,29]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Wrapper Caching FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{content:s,title:"Module 003_003 Topic 7: Wrapper Caching Landscape",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_003_topic7_other_caching_note.txt"})}),e.jsx(r,{note:"Byte caches all 256 possible byte values, while Float and Double have zero caching because of infinite fractions! — Sukanta Hui"})]})}export{C as default};
