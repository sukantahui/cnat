import{b as a,j as e}from"./vendor-react-core-BBXbtqt1.js";import{T as v}from"./TeacherSukantaHui-VMH_OtYp.js";import{P as s}from"./PythonFileLoader-YugaCzY9.js";import{F as _}from"./FAQTemplate-BamsZuNW.js";import{P as w}from"./PlainTextPrint-CGJ_aUDk.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const C=[{question:"What is the primary difference between `screen.onclick()` and `turtle.onclick()`?",shortAnswer:"`screen.onclick()` triggers anywhere on canvas background; `turtle.onclick()` triggers only when clicking that specific turtle's visible sprite.",explanation:"Allows separating global canvas interactions from individual clickable buttons and game entities.",hint:"Which method clicks global canvas versus a specific sprite?",level:"basic",codeExample:`screen.onclick(stamp_bg)
