import{b as p,j as e}from"./vendor-react-core-D9iF7FwR.js";import{T as u}from"./TeacherSukantaHui-Bldu0y17.js";import{F as f}from"./FAQTemplate-DmdkpHR-.js";import{P as O}from"./PlainTextPrint-CS96sBe2.js";import{E as b}from"./EditableCCodeBlock-BWI9JrQC.js";import"./vendor-icons-Beb6eGc1.js";import"./vendor-monaco-CEXMEfXF.js";const y=[{question:"What is the exact time complexity of the C loop: for(int i = 1; i < n; i *= 2)?",options:["O(n)","O(log_2 n)","O(n^2)","O(sqrt(n))"],correctAnswer:1,explanation:"In each step, i doubles (1, 2, 4, 8, ... 2^k). The loop terminates when 2^k >= n, which yields k = ceil(log_2 n) iterations, resulting in O(log n) time complexity."},{question:`What is the time complexity of the nested loops:
for(int i = 1; i < n; i *= 2)
