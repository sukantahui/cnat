import{j as e,a as s}from"./index-Be2ZQ4sg.js";function l(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Logical Operators in Python (and, or, not)"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Logical operators allow you to combine multiple conditions. They always return",e.jsx("code",{children:" True "})," or ",e.jsx("code",{children:" False"})," based on the rules of logic."]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Types of Logical Operators in Python"}),e.jsxs("ul",{className:"list-disc ml-6 text-slate-300 text-sm space-y-1",children:[e.jsxs("li",{children:[e.jsx("code",{children:"and"})," → True if **both** conditions are True"]}),e.jsxs("li",{children:[e.jsx("code",{children:"or"})," → True if **at least one** condition is True"]}),e.jsxs("li",{children:[e.jsx("code",{children:"not"})," → Reverses a boolean value"]})]}),e.jsx(s,{initialCode:`x = 10
y = 20
