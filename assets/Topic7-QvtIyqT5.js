import{j as e}from"./index-BjcB6RzK.js";import{E as s}from"./EditablePythonCodeBlock-BUl0L0Jq.js";import"./index-DMsSvuEi.js";import"./braces-rmDTwsn1.js";import"./layout-list-DXswQ4wB.js";import"./play-DX16GKke.js";import"./type-KuLbSU6d.js";import"./refresh-cw-BiBGBwpy.js";import"./copy-DI4a0ux7.js";import"./download-D9OBzpJs.js";import"./eye-off-BvUSmI0w.js";import"./eye-CPtAr_i7.js";function m(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Topic 7 — Evaluating Expressions (Step-by-Step Rules)"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["In Python, an ",e.jsx("strong",{children:"expression"})," is anything that produces a value. Python evaluates expressions by following operator precedence, associativity, and left-to-right execution rules. Understanding this process is crucial for writing predictable, bug-free programs."]}),e.jsx("h2",{className:"text-xl font-semibold text-sky-400",children:"1. The Step-by-Step Evaluation Flow"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"Python evaluates expressions using this order:"}),e.jsxs("ul",{className:"list-disc pl-6 text-slate-300 text-sm space-y-1",children:[e.jsx("li",{children:"Break the expression into smaller sub-expressions."}),e.jsx("li",{children:"Apply **precedence** rules to decide which operator goes first."}),e.jsx("li",{children:"Apply **associativity** (usually left → right)."}),e.jsx("li",{children:"Simplify step-by-step until a final single value remains."})]}),e.jsx(s,{initialCode:`# Example
result = 5 + 2 * 3
