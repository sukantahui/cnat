import{j as e,E as s}from"./index-CwtuFwkW.js";function t(){return e.jsxs("div",{className:"space-y-10",children:[e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-sky-300",children:["Nested ",e.jsx("span",{className:"text-sky-400",children:"if"})," Statements"]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["A ",e.jsx("strong",{children:"nested if statement"})," is an ",e.jsx("code",{className:"text-sky-300",children:"if"})," placed inside another ",e.jsx("code",{className:"text-sky-300",children:"if"}),". It allows you to perform **multi-level decision making**, where one decision depends on the outcome of another."]}),e.jsx(s,{language:"javascript",initialCode:`let score = 85;
