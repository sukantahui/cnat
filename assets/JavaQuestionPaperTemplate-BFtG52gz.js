import{r as c,j as t}from"./index-BpX9yBGC.js";import{P as v}from"./PrintButton-DdDfy0mJ.js";import{J as u}from"./JavaCodeBlock-CCHhybLy.js";import{P as j}from"./prism-BHdG3xKe.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
