...
'detour' that handles ≥ and = constraints."`,O=()=>{const[s,c]=i.useState("concept"),[x,m]=i.useState({}),[l,h]=i.useState(null),[o,g]=i.useState(null),p=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],y=[{id:1,title:"Example 1: Maximization with Simplex (All ≤)",problem:`Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
x, y ≥ 0
