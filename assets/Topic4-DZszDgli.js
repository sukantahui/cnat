...
1. SHADOWING DISAMBIGUATION:\r
   - 'name'                 &rarr; Local variable / parameter.\r
   - 'this.name'            &rarr; Inner class instance variable.\r
   - 'OuterClass.this.name' &rarr; Enclosing Outer class instance variable.\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,o=[{question:"How do you explicitly reference an outer class instance variable when it is shadowed by an inner class member and a method parameter?",shortAnswer:"Use the syntax 'OuterClassName.this.fieldName'. In Java, 'this.fieldName' refers to the inner class instance variable, whereas prefixing the outer class name ('OuterClass.this') directs the compiler to the enclosing outer instance.",explanation:"Standard resolution pattern for deeply nested GUI listeners and builder classes.",hint:"Use OuterClass.this.variableName to disambiguate outer instance state.",level:"Intermediate",codeExample:"System.out.println(OuterClass.this.centerLocation);"}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_007 · Topic 4"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Scope Disambiguation"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"OuterClass.this"})," Syntax for Variable Shadowing"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Disambiguate three levels of variable scope: cleanly accessing method parameters, inner class instance fields with ",e.jsx("code",{className:"text-sky-300 font-mono",children:"this"}),", and enclosing outer fields with ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"Outer.this"}),"."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"OuterClassThisShadowingDemo.java",highlightLines:[7,10,14,18,19,20]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Variable Shadowing FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 003_007 Topic 4: OuterClass.this Syntax",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_007_topic4_outer_this_note.txt"})}),e.jsx(r,{note:"Whenever you have the same variable name in a method parameter, inner class, and outer class, 'OuterClass.this.field' is your universal rescue syntax! — Sukanta Hui"})]})}export{b as default};
