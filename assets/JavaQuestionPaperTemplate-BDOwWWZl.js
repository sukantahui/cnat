import{r as c,j as t}from"./index-D2oyZ1_5.js";import{P as v}from"./PrintButton-BIXF-Grb.js";import{J as u}from"./JavaCodeBlock-DLXsyqd0.js";import{P as j}from"./prism-CZHQu0su.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
