...
================================================================================`,i=[{question:"Why is attaching structured metadata fields (errorCode, transactionId, timestamp) to custom exceptions essential in modern enterprise microservices?",shortAnswer:"Because structured metadata transforms raw error strings into machine-parseable audit records. It allows centralized API gateways and logging frameworks (e.g. ELK, Datadog) to extract error codes, correlate distributed transaction IDs, and generate standardized JSON error responses (RFC 7807 Problem Details) automatically.",explanation:"Standard practice in REST APIs and financial transactions.",hint:"Enables machine-parseable logging, distributed transaction tracing, and standardized JSON error payloads.",level:"Intermediate",codeExample:"public class ApiException extends RuntimeException { private final int status; private final String code; }"}];function I(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 004_003 · Topic 8"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Enterprise Metadata"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Adding Domain Metadata to Custom Exceptions (",e.jsx("code",{className:"text-emerald-400 font-mono",children:"errorCode"}),", ",e.jsx("code",{className:"text-sky-400 font-mono",children:"transactionId"}),")"]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Architect production-ready exceptions: enriching error objects with machine-parseable error codes, UTC timestamps, and correlation IDs for distributed tracing."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"CustomExceptionDomainMetadataDemo.java",highlightLines:[7,10,11,12,13,16,17,18,19,20,29,30]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{title:"Exception Metadata FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:o,title:"Module 004_003 Topic 8: Exception Domain Metadata",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"004_003_topic8_exception_metadata_note.txt"})}),e.jsx(a,{note:"In enterprise systems, loggers shouldn't just print 'Error!'. By attaching an errorCode ('ERR_GST_404') and transactionId, your support team in Barrackpore can locate the exact failing database query in 5 seconds! — Sukanta Hui"})]})}export{I as default};
