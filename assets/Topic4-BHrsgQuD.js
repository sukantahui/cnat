import{j as e}from"./index-gsr__VoO.js";import{C as t}from"./CodeBlock-BgpCxG5L.js";import"./EditableCodeBlock-Wuc9XhDe.js";import"./prism-CyJ4Ug4E.js";import"./prism-json-D0UlpdKh.js";import"./file-code-BIP47i_q.js";import"./copy-_YtngGN_.js";import"./download-BR7jb7LT.js";import"./play-DRLvq0m8.js";import"./index-BWD-23kO.js";import"./braces-CoES6LeI.js";import"./layout-list-BJ8vQIye.js";import"./refresh-cw-CbGJFCpt.js";import"./wand-sparkles-BWFL7YwY.js";function j(){return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("h2",{className:"text-xl font-semibold text-sky-300",children:["Constructor Functions & the ",e.jsx("code",{children:"new"})," Keyword"]}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["Constructor functions are a traditional way in JavaScript to create multiple similar objects. They work together with the ",e.jsx("code",{children:"new"})," keyword to produce new instances."]}),e.jsx("h3",{className:"text-lg font-semibold text-slate-200",children:"Basic Constructor Function"}),e.jsx(t,{code:`function Student(name, course, score) {
  this.name = name;
  this.course = course;
  this.score = score;
}
...
s.showMarks();`,language:"javascript"}),e.jsx("p",{className:"text-slate-400 text-sm",children:"This is the foundation for learning ES6 Classes and OOP structure."})]})}export{j as default};
