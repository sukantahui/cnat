import{j as e}from"./index-CTaFCVvl.js";import{E as s}from"./EditablePythonCodeBlock--aRgIxEG.js";import"./index-RG1_EAcX.js";import"./braces-DR1B3IWk.js";import"./layout-list-BRs4SSFE.js";import"./play-rkdgOENq.js";import"./type-Wnld5au3.js";import"./refresh-cw-ClGJKkyE.js";import"./copy-DY-fjKN5.js";import"./download-CVsa0i-2.js";import"./eye-off-DQCWcKuS.js";import"./eye-RMvPMGzV.js";function p(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Nested Conditions in Python — Multi-Level Decision Making"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["Nested conditions allow you to place one ",e.jsx("code",{children:"if"})," statement inside another. They help model real-life situations where a decision depends on multiple layers of checks. For example: verifying age, then checking ID, then checking membership."]}),e.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"1. What is a Nested Condition?"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["A nested condition is simply an ",e.jsx("code",{children:"if"})," inside another ",e.jsx("code",{children:"if"}),". Python executes inner blocks only if the outer conditions are satisfied."]}),e.jsx(s,{initialCode:`age = 22
has_id = True
