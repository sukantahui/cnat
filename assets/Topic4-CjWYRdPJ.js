import{j as e}from"./index-CTaFCVvl.js";import{C as t}from"./CodeBlock-KTgzcmhn.js";import"./EditableCodeBlock-KOhOfWQC.js";import"./prism-BVjeagNH.js";import"./prism-json-D0UlpdKh.js";import"./file-code-DdaZ0WP2.js";import"./copy-DY-fjKN5.js";import"./download-CVsa0i-2.js";import"./play-rkdgOENq.js";import"./index-RG1_EAcX.js";import"./braces-DR1B3IWk.js";import"./layout-list-BRs4SSFE.js";import"./type-Wnld5au3.js";import"./refresh-cw-ClGJKkyE.js";import"./wand-sparkles-Dq-Tbn4Z.js";import"./eye-off-DQCWcKuS.js";import"./eye-RMvPMGzV.js";function y(){return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("h2",{className:"text-xl font-semibold text-sky-300",children:["Constructor Functions & the ",e.jsx("code",{children:"new"})," Keyword"]}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["Constructor functions are a traditional way in JavaScript to create multiple similar objects. They work together with the ",e.jsx("code",{children:"new"})," keyword to produce new instances."]}),e.jsx("h3",{className:"text-lg font-semibold text-slate-200",children:"Basic Constructor Function"}),e.jsx(t,{code:`function Student(name, course, score) {
  this.name = name;
  this.course = course;
  this.score = score;
}
