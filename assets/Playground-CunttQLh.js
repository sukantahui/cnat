import{b as f,j as e}from"./vendor-react-core-Doz9nIC6.js";import{F as C}from"./vendor-monaco-Bv7hoEkV.js";import{u as k,aJ as N,bP as L,v as T,w as b,x as z,R as M,y as E,z as H,aG as R,aH as F,g as D,D as O,bQ as P,E as J,d as B}from"./vendor-icons-CH1iX9C8.js";class w extends f.Component{constructor(t){super(t),this._postMessageHandler=n=>{!n.data||!n.data.type||n.data.type==="console"&&this.setState(c=>({consoleOutput:[...c.consoleOutput,{type:n.data.level||"log",message:n.data.message}]}))},window.addEventListener("message",this._postMessageHandler,!1);const o=n=>this.normalizeCode(n||""),a=t.initialSnippets||{},i=o(a.javascript??t.initialCode??""),l=o(a.html??`<!-- HTML goes here -->
