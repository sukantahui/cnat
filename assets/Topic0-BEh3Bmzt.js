...
document.body.append(message);`})]}),e.jsx("footer",{className:"pt-6 border-t border-slate-800 text-slate-400 text-sm",children:e.jsxs("p",{children:["Next, we will explore",e.jsxs("span",{className:"text-sky-300",children:[" ","appending, inserting, and removing DOM elements"]}),"— the core of dynamic UI building."]})})]})}}export{g as default};
