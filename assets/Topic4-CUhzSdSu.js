import{j as e}from"./index-DLefW0Tp.js";import{E as s}from"./EditablePythonCodeBlock-cMO86PJw.js";import"./index-Ck8vhGSy.js";import"./braces-DSBAqnLT.js";import"./layout-list-CIbLHTf3.js";import"./play-Bonc3cvQ.js";import"./type-Bom_9Shz.js";import"./refresh-cw-DfWESQEa.js";import"./copy-Im6obCcV.js";import"./download-B1qWbheC.js";import"./eye-off-B1nx00rT.js";import"./eye-s8A1LQPP.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Python Indentation, Comments, Variables & User Input"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"This topic explains the foundation of Python syntax—indentation rules, comments, variables, naming conventions, core data types, type casting, and taking input from the user. These are essential concepts used in every Python program from beginner to advanced level."}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Python Indentation Rules"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Python uses **indentation instead of braces `","`** to define blocks. Incorrect indentation results in an error."]}),e.jsx(s,{initialCode:`# Correct indentation
if 5 > 2:
