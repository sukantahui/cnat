...
================================================================================`,o=[{question:"What is the role of the 'import' statement in Java, and which package is imported automatically by default?",shortAnswer:"The 'import' statement brings classes from other packages into the current compilation scope so you can refer to them by their simple class names rather than fully qualified names. The 'java.lang' package is imported automatically into every Java file.",explanation:"Without 'import java.util.List', you would have to write 'java.util.List list = new java.util.ArrayList();'.",hint:"Enables using simple class names; java.lang is imported automatically.",level:"Beginner",codeExample:"import java.util.List; // java.lang.* is automatic"}];function h(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_009 · Topic 3"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Scope Importation"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Importing Packages & Classes Using ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"import"})," Statements"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Learn how ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"import"})," statements bring foreign package types into scope, and discover why ",e.jsx("code",{className:"text-indigo-400 font-mono",children:"java.lang"})," is universally auto-imported."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(a,{fileModule:s,title:"ImportingPackagesSyntaxDemo.java",highlightLines:[7,10,11,22,23]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Import Statements FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:i,title:"Module 002_009 Topic 3: import Statements",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_009_topic3_import_statements_note.txt"})}),e.jsx(n,{note:"Import statements do not copy code or slow down your program at runtime; they simply tell the compiler: 'When I type List, I mean java.util.List!' — Sukanta Hui"})]})}export{h as default};
