...
================================================================================\r
`,i=[{question:"What is the primary performance advantage of compile-time annotation processing (APT) over runtime reflection?",shortAnswer:"APT generates pure, standard Java source code at compile time with zero runtime reflection overhead, resulting in instant application startup, zero reflection overhead during execution, and full compile-time type safety.",explanation:"Pioneered by frameworks like Dagger, MapStruct, and Quarkus.",hint:"Eliminates runtime reflection overhead and enables instant startup times.",level:"Intermediate",codeExample:"Generated code runs as standard direct method calls."},{question:"What standard Java interface must a custom compile-time annotation processor implement?",shortAnswer:"javax.annotation.processing.Processor (typically extended via javax.annotation.processing.AbstractProcessor).",explanation:"Registered via META-INF/services/javax.annotation.processing.Processor or @AutoService.",hint:"javax.annotation.processing.Processor (or AbstractProcessor).",level:"Advanced",codeExample:"public class MyProcessor extends AbstractProcessor { ... }"}];function A(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 010_002 · Topic 12"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Java Annotations & APT"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Compile-Time Annotation Processing: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"APT & javax.annotation.processing.Processor"})," (Capstone)"]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Zero runtime overhead: how Lombok, MapStruct, and AutoValue hook into javac compilation rounds to generate source code and bytecode at build time."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"CompileTimeAptCapstoneDemo.java",highlightLines:[18,25,34,43,52]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Java Annotations FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 010_002 Topic 12: Compile-Time APT Capstone",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"010_002_topic12_compile_time_apt_capstone_note.txt"})}),e.jsx(o,{note:"Congratulations on completing Module 2 of Segment 10! You now understand both Runtime Reflection Annotations and Compile-Time Annotation Processors (APT)! Next up: The inner engine of Java — JVM Architecture & ClassLoaders! — Sukanta Hui"})]})}export{A as default};
