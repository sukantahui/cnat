import{j as t}from"./vendor-react-core-BBXbtqt1.js";import{J as e}from"./JavaFileLoader-CVw5Mqo9.js";import{F as n}from"./FAQTemplate-BamsZuNW.js";import{P as a}from"./PlainTextPrint-CGJ_aUDk.js";import{T as s}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const r=`/**\r
...
1. INSTANTIATION RULES:\r
   - 'new AbstractClass()' → COMPILE ERROR ("cannot be instantiated").\r
...
================================================================================`,i=[{question:"Why does the Java compiler prohibit creating an object of an abstract class ('new AbstractClass()')?",shortAnswer:"Because an abstract class is conceptually incomplete and may contain abstract methods with no code body; if an instance were created, calling an abstract method would have no bytecode to execute.",explanation:"To guarantee runtime reliability, Java permits instantiation only of fully concrete subclasses.",hint:"Incomplete definition with missing method bodies would cause undefined runtime behavior.",level:"Beginner",codeExample:"// Compile Error: Base b = new Base();"}];function x(){return t.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[t.jsx("style",{children:`
        ...
        `}),t.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_007 · Topic 2"}),t.jsx("span",{className:"px-3 py-1 bg-amber-500/10 text-amber-400 border border-amber-500/20 text-xs font-semibold rounded-full",children:"Compiler Prohibitions"})]}),t.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Why Abstract Classes CANNOT Be Directly Instantiated with ",t.jsx("code",{className:"text-rose-400 font-mono",children:"new"})]}),t.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Deep-dive into the architectural reasons why Java strictly prohibits direct instantiation of abstract types, guaranteeing zero runtime undefined method crashes."})]}),t.jsxs("section",{className:"space-y-4",children:[t.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[t.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),t.jsx(e,{fileModule:r,title:"AbstractInstantiationRestrictionsDemo.java",highlightLines:[10,12,16,32]})]}),t.jsx("section",{className:"space-y-4",children:t.jsx(n,{title:"Abstract Class Instantiation FAQs",questions:i})}),t.jsx("section",{className:"space-y-4",children:t.jsx(a,{content:o,title:"Module 002_007 Topic 2: Abstract Instantiation Restrictions",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_007_topic2_instantiation_restrictions_note.txt"})}),t.jsx(s,{note:"You cannot build a 'Generic Vehicle' on a factory line—you can only build a Car, a Truck, or a Motorcycle! That is why Abstract Classes cannot be instantiated with new. — Sukanta Hui"})]})}export{x as default};
