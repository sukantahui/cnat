import{b as o,j as e,bg as s}from"./vendor-react-core-Doz9nIC6.js";import{S as r}from"./ShellFileLoader-E94sGNTM.js";import"./vendor-prism-ZrEUZN6d.js";const x=`#!/bin/bash
...
cat "$LOG_DIR/server_$TIMESTAMP.log"`,p=`#!/bin/bash
...
# Cleanup
rm -f "$POSIX_LOG" "/tmp/tee_deploy.log"`,b=`#!/bin/bash
...
# Cleanup
rm -f /tmp/app_config.conf /tmp/deploy.sh /tmp/template.txt`,y=`#!/bin/bash
