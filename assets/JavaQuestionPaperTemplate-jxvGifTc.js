import{b as W,j as e}from"./vendor-react-core-D9iF7FwR.js";import{J as B}from"./JavaCodeBlock-Cnk_cOEs.js";import{P as I}from"./vendor-prism-SANIKoEh.js";function J({code:n="",highlightLines:P=[],title:q="Java Code (BlueJ)"}){const[T,L]=W.useState([]),S=W.useRef(null);return W.useEffect(()=>{const A=I.highlight(n,I.languages.java,"java");L(A.split(`
