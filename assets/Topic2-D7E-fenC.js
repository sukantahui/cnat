import{b as u,j as e}from"./vendor-react-core-BBXbtqt1.js";import{T as g}from"./TeacherSukantaHui-VMH_OtYp.js";import{P as d}from"./PythonFileLoader-YugaCzY9.js";import{F as f}from"./FAQTemplate-BamsZuNW.js";import{P as b}from"./PlainTextPrint-CGJ_aUDk.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const w=[{question:"What is Turtle State Pollution?",shortAnswer:"When a helper function modifies position, heading, or pen attributes without restoring them, breaking subsequent caller drawing.",explanation:"Unrestored mutations cause unpredictable side effects in complex scenes.",hint:"What do you call unintended side effects left behind by a drawing function?",level:"basic",codeExample:"# Unrestored heading causes subsequent lines to be skewed"},{question:"Which methods return the turtle's current position, heading, and pen status?",shortAnswer:"`t.position()` (or `t.pos()`), `t.heading()`, and `t.isdown()`.",explanation:"These getter methods inspect the current kinematic state of the turtle.",hint:"What three methods read position, angle, and pen contact?",level:"basic",codeExample:`pos = t.pos()
head = t.heading()
