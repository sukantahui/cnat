...
================================================================================`,s=[{question:"Why does repeated String concatenation ('s += i') inside a loop cause severe O(N^2) performance degradation?",shortAnswer:"Because Strings are immutable, each '+' inside a loop instantiates a new StringBuilder, copies all previous characters, and creates a new String object. Over N iterations, it copies N*(N+1)/2 characters, creating quadratic O(N^2) CPU overhead and massive GC pressure.",explanation:"Always use StringBuilder or StringBuffer for loop concatenation.",hint:"Copies previous characters repeatedly, resulting in O(N^2) time complexity.",level:"Advanced",codeExample:"StringBuilder sb = new StringBuilder(); for (...) sb.append(item);"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
          @keyframes fadeIn {
            from { opacity: 0; transform: translateY(8px); }
            to { opacity: 1; transform: translateY(0); }
          }
          .animate-fade-in { animation: fadeIn 0.5s ease-out forwards; }
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_001 · Topic 14"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Performance Capstone"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Performance Pitfalls of Repeated String Concatenation in Loops"}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Benchmark and diagnose the infamous ",e.jsx("code",{className:"text-rose-400 font-mono",children:"O(N^2)"})," string concatenation trap: comparing loop garbage generation against high-throughput ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"StringBuilder"})," pipelines."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"StringConcatenationPitfallsCapstoneDemo.java",highlightLines:[7,16,17,24,26,28]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Loop Concatenation FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:o,title:"Module 003_001 Topic 14: Concatenation Pitfalls",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_001_topic14_concatenation_pitfalls_note.txt"})}),e.jsx(a,{note:"Congratulations on completing Module 003_001! You have mastered the entire lifecycle of Java Strings, String Constant Pool mechanics, immutability benefits, and performance optimization rules! — Sukanta Hui"})]})}export{x as default};
