...
1. MATH METHODS CHEATSHEET:\r
   ...
   - 'Math.ceil(d)'  : Rounds up &rarr; double.\r
   - 'Math.floor(d)' : Rounds down &rarr; double.\r
   - 'Math.round(d)' : Nearest integer &rarr; long.\r
   - 'Math.pow(a, b)': $a^b$ &rarr; double.\r
   - 'Math.sqrt(d)'  : Square root &rarr; double.\r
\r
================================================================================\r
...
Math.floor(4.9); // 4.0
Math.round(4.5); // 5`}];function M(){return t.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[t.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_004 · Topic 1"}),t.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Method Catalog"})]}),t.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Math Methods: ",t.jsx("code",{className:"text-emerald-400 font-mono",children:"ceil()"}),", ",t.jsx("code",{className:"text-sky-400 font-mono",children:"floor()"}),", ",t.jsx("code",{className:"text-amber-400 font-mono",children:"round()"})," & ",t.jsx("code",{className:"text-purple-400 font-mono",children:"sqrt()"})]}),t.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the complete mathematical library: directional ceiling/floor bounds, precision exponents with ",t.jsx("code",{className:"text-purple-300 font-mono",children:"pow()"}),", and trigonometric calculations."]})]}),t.jsxs("section",{className:"space-y-4",children:[t.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[t.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),t.jsx(e,{fileModule:o,title:"MathMethodsCatalogDemo.java",highlightLines:[7,14,15,16,17,21,22,27,28]})]}),t.jsx("section",{className:"space-y-4",children:t.jsx(r,{title:"Math Methods FAQs",questions:l})}),t.jsx("section",{className:"space-y-4",children:t.jsx(n,{content:s,title:"Module 003_004 Topic 1: Math Methods",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_004_topic1_math_methods_note.txt"})}),t.jsx(a,{note:"If you are calculating pagination in a web app with 21 items and 10 per page, write '(int) Math.ceil(21.0 / 10)' to get 3 pages! — Sukanta Hui"})]})}export{M as default};
