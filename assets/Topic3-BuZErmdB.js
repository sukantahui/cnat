...
s1.equals(s2); // true (same fields)`}];function f(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_010 · Topic 3"}),e.jsx("span",{className:"px-3 py-1 bg-amber-500/10 text-amber-400 border border-amber-500/20 text-xs font-semibold rounded-full",children:"Core Contract"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The ",e.jsx("code",{className:"text-amber-400 font-mono",children:"equals(Object obj)"})," Method: Reference Identity (",e.jsx("code",{className:"text-rose-400 font-mono",children:"=="}),") vs Semantic Equality"]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Master the foundational comparison distinction in Java: memory reference addresses vs logical content equality."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:r,title:"EqualsVsReferenceComparisonDemo.java",highlightLines:[17,18,19,20,34,37]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"equals() vs == FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{content:o,title:"Module 002_010 Topic 3: equals() vs ==",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_010_topic3_equals_vs_identity_note.txt"})}),e.jsx(s,{note:"'==' asks: 'Are these two variables pointing to the exact same spot in RAM?' while equals() asks: 'Do these two students have the same name and ID?'. Never use == for business object comparisons! — Sukanta Hui"})]})}export{f as default};
