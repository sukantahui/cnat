import{j as e}from"./index-b7ec57y3.js";import{E as s}from"./EditablePythonCodeBlock-BLu1YgFp.js";import"./index-YcsC-9l3.js";import"./createLucideIcon-rpwAtNd4.js";import"./braces-DaWynF8W.js";import"./layout-list-DHPnG2KL.js";import"./play-iDwqm0pH.js";import"./type-BCGOc5XA.js";import"./refresh-cw-DOKtjFB2.js";import"./copy-Ds2YEQZf.js";import"./download-zjLbxNEf.js";import"./eye-off-C83yZDwu.js";import"./eye-Dx1fNgme.js";function f(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Conditional Statements in Python — if, elif, else"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["Conditional statements allow a program to make decisions. Python evaluates a condition as ",e.jsx("strong",{children:"True"})," or ",e.jsx("strong",{children:"False"}),"and executes the matching code block. This is one of the most powerful tools for creating logic, validations, menus, and real-world applications."]}),e.jsxs("h2",{className:"text-xl font-semibold text-sky-300",children:["1. The ",e.jsx("code",{children:"if"})," Statement"]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["An ",e.jsx("code",{children:"if"})," block runs only when its condition is ",e.jsx("strong",{children:"True"}),". Python uses indentation (usually 4 spaces) to define the block."]}),e.jsx(s,{initialCode:`age = 20
