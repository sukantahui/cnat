import{c as Y,r as i,j as e,f as W,g as de}from"./index-DmMPx_vc.js";import{P as J}from"./prism-json-CHRsBE-6.js";import{q as ce}from"./js-control-flow-test-R02ArAoA.js";/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xe=[["path",{d:"m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526",key:"1yiouv"}],["circle",{cx:"12",cy:"8",r:"6",key:"1vp47v"}]],Z=Y("award",xe);/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const me=[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]],pe=Y("rotate-ccw",me);/**
 * @license lucide-react v0.544.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const he=[["path",{d:"M10 14.66v1.626a2 2 0 0 1-.976 1.696A5 5 0 0 0 7 21.978",key:"1n3hpd"}],["path",{d:"M14 14.66v1.626a2 2 0 0 0 .976 1.696A5 5 0 0 1 17 21.978",key:"rfe1zi"}],["path",{d:"M18 9h1.5a1 1 0 0 0 0-5H18",key:"7xy6bh"}],["path",{d:"M4 22h16",key:"57wxv0"}],["path",{d:"M6 9a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1z",key:"1mhfuq"}],["path",{d:"M6 9H4.5a1 1 0 0 1 0-5H6",key:"tex48p"}]],ue=Y("trophy",he);function be({code:m="",initialCode:r="",language:n="javascript"}){const l=r||m,[j,y]=i.useState("");return i.useEffect(()=>{const N=J.highlight(l,J.languages[n]||J.languages.javascript,n);y(N)},[l,n]),e.jsx("div",{className:"my-4 rounded-xl overflow-hidden border border-slate-700 bg-[#0f172a] shadow-lg",children:e.jsx("pre",{className:"p-4 overflow-auto text-sm leading-6",children:e.jsx("code",{className:`language-${n}`,dangerouslySetInnerHTML:{__html:j}})})})}const fe="quizEngine_",ge="quizLeaderboard_";function q(m){const r=[...m];for(let n=r.length-1;n>0;n--){const l=Math.floor(Math.random()*(n+1));[r[n],r[l]]=[r[l],r[n]]}return r}function D(m,r){if(!Array.isArray(m))return[];const n=q(m),l=r?Math.min(r,n.length):n.length;return n.slice(0,l).map(y=>{const N=y.options.map((b,f)=>({text:b,originalIndex:f})),C=q(N),F=C.findIndex(b=>b.originalIndex===y.answerIndex);return{...y,options:C.map(b=>b.text),answerIndex:F}})}function ye(){const m="certificate_counter";let r=parseInt(localStorage.getItem(m),10);(isNaN(r)||r<1)&&(r=1);const n=new Date().getFullYear(),l=String(r).padStart(5,"0"),j=`CAT-${n}-${l}`;return localStorage.setItem(m,r+1),j}function ve({title:m="Quiz Test",questions:r=[],testId:n="test_default",questionLimit:l=25,certificateHeader:j="Coder & AccoTax – Premium Computer Training Institute",certificateSubtitle:y="Barrackpore · www.codernaccotax.co.in",certificateTitle:N="Certificate of Completion",leaderboardTitle:C="Coder & AccoTax Leaderboard",showStudentName:F=!0,onResultSubmit:b}){const f=fe+n,O=ge+n,[d,I]=i.useState([]),[w,A]=i.useState({}),[v,E]=i.useState({}),[h,T]=i.useState(0),[g,$]=i.useState(!1),[S,_]=i.useState(!1),[M,Q]=i.useState(""),[P,H]=i.useState([]),[k,L]=i.useState(l),K=i.useRef([]),V=i.useRef(!1);i.useEffect(()=>{const t=localStorage.getItem(O);if(t)try{const s=JSON.parse(t);H(Array.isArray(s)?s:[])}catch{H([])}},[O]),i.useEffect(()=>{const t=localStorage.getItem(f);if(t)try{const a=JSON.parse(t),o=a.quiz||D(r,l);I(o),A(a.responses||{}),E(a.submitted||{}),T(a.score||0),$(a.isFinished||!1);const x=a.quiz&&a.quiz.length||l;L(Math.min(x,r.length||x));return}catch{}const s=D(r,l);I(s),L(Math.min(l,r.length||l))},[r,l,f]),i.useEffect(()=>{if(!d.length)return;const t={quiz:d,responses:w,submitted:v,score:h,isFinished:g};localStorage.setItem(f,JSON.stringify(t))},[d,w,v,h,g,f]);const ee=t=>{const s=K.current[t];s&&s.scrollIntoView({behavior:"smooth",block:"center"})},te=(t,s)=>{v[t]||A(a=>({...a,[t]:s}))},se=(t,s)=>{if(v[t.id])return;w[t.id]===t.answerIndex&&T(o=>o+1),E(o=>{const x={...o,[t.id]:!0};return Object.keys(x).length===d.length&&$(!0),x}),!S&&s+1<d.length&&setTimeout(()=>ee(s+1),600)},re=()=>{const t=D(r,k);I(t),A({}),E({}),T(0),$(!1),_(!1),Q(""),localStorage.removeItem(f)},X=d.filter(t=>v[t.id]&&w[t.id]!==t.answerIndex),ae=S?X:d,ne=()=>{if(!d.length)return;const t=d.length,s=t?Number((h/t*100).toFixed(2)):0,a={name:M.trim()||"Guest",score:h,total:t,percent:s,date:new Date().toISOString()};H(o=>{const x=[...o,a];x.sort((c,u)=>u.percent!==c.percent?u.percent-c.percent:u.score!==c.score?u.score-c.score:new Date(u.date)-new Date(c.date));const p=x.slice(0,10);return localStorage.setItem(O,JSON.stringify(p)),p}),typeof b=="function"&&b({...a,testId:n})};i.useEffect(()=>{!V.current&&g&&ne(),V.current=g},[g,h,d.length,M]);const le=()=>{const t=M||"Student Name",s=d.length,a=s?(h/s*100).toFixed(2):"0.00",o=new Date().toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"}),x=ye(),p=`
<!DOCTYPE html>
<html>
<head>
<title>${N}</title>
