import{j as e}from"./index-BZ1-3x1c.js";import{E as s}from"./EditablePythonCodeBlock-DYuYnXKI.js";import"./index-DAcJ947v.js";import"./braces-ZDFjoAI2.js";import"./layout-list-Dn_aCmq2.js";import"./play-CsDulOQL.js";import"./type-kdgV3pfK.js";import"./refresh-cw-CkAsW6bT.js";import"./copy-DRd4XZHU.js";import"./download-B2rqWgWV.js";import"./eye-off-BQZr5nas.js";import"./eye-hnPwCMtS.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Variables, Keywords, Identifiers & Python’s Dynamic Typing"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"In Python, variables do not need explicit type declarations. Their type is determined automatically based on the assigned value. This topic explains how variables work, naming rules, Python keywords, and how Python stores and reuses memory references."}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. What is a Variable?"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"A variable is a name that refers to a value stored in memory. Python creates a variable automatically when you assign a value to it."}),e.jsx(s,{initialCode:`x = 10
y = 3.14
name = "Sukanta Hui"
is_student = True
