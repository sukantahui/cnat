...
and careful with the ratio test."`,B=()=>{const[d,u]=o.useState("concept"),[x,f]=o.useState({}),[c,y]=o.useState(null),[h,w]=o.useState(null),j=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],N=[{id:1,title:"Example 1: Basic Entering and Leaving Variables",problem:`Given the tableau:
┌─────┬─────┬─────┬─────┬─────┬─────┐
│  B  │  x  │  y  │ s₁  │ s₂  │ RHS │
├─────┼─────┼─────┼─────┼─────┼─────┤
│ s₁  │  2  │  1  │  1  │  0  │ 10  │
