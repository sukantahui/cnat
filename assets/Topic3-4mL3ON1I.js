import{j as t}from"./index-CNNP-EED.js";import{C as e}from"./CodeBlock-BB4J-Mgy.js";import"./prism-CQDD5-RF.js";import"./prism-json-D0UlpdKh.js";import"./file-code-D8YGDSR0.js";import"./copy-BQOvbT5P.js";import"./download-COgPc9qQ.js";import"./play-DAKE_zJf.js";function x(){return t.jsxs("div",{className:"space-y-6",children:[t.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"break & continue"}),t.jsxs("p",{className:"text-slate-300 text-sm",children:[t.jsx("strong",{children:"break"})," stops the loop completely.",t.jsx("br",{}),t.jsx("strong",{children:"continue"})," skips the current iteration."]}),t.jsx("h3",{className:"text-lg text-slate-200 font-semibold",children:"break Example"}),t.jsx(e,{code:`for (let i = 1; i <= 10; i++) {
  if (i === 5) break;
  console.log(i);
}
