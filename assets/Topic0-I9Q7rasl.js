import{j as e}from"./index-b7ec57y3.js";import{E as s}from"./EditableCodeBlock-CUU3m7bV.js";import"./index-YcsC-9l3.js";import"./createLucideIcon-rpwAtNd4.js";import"./braces-DaWynF8W.js";import"./file-code-BayAKhuW.js";import"./layout-list-DHPnG2KL.js";import"./play-iDwqm0pH.js";import"./type-BCGOc5XA.js";import"./refresh-cw-DOKtjFB2.js";import"./wand-sparkles-Dm8J8N6Z.js";import"./copy-Ds2YEQZf.js";import"./download-zjLbxNEf.js";import"./eye-off-C83yZDwu.js";import"./eye-Dx1fNgme.js";const t="animate-[fadeIn_0.8s_ease-out]",j=()=>e.jsxs("div",{className:`space-y-10 ${t}`,children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx("h2",{className:"text-xl font-bold text-sky-300 tracking-wide animate-[slideDown_0.5s_ease-out]",children:"Synchronous vs Asynchronous Code"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed animate-[fadeIn_1s_ease-out]",children:["JavaScript is ",e.jsx("strong",{children:"single-threaded"})," and executes code in a"," ",e.jsx("strong",{children:"synchronous"})," order unless asynchronous features are used. In Coder & AccoTax learning apps, async code is crucial for loading quizzes, scores, and student reports without blocking the UI."]})]}),e.jsxs("div",{className:"p-4 border border-sky-700 bg-sky-900/30 rounded-xl shadow-md animate-[fadeIn_1.2s_ease-out]",children:[e.jsx("h4",{className:"text-sky-300 font-semibold mb-1 text-sm",children:"💡 Why Learn Async?"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Async code improves speed and user experience by preventing the UI from freezing. It allows tasks like API calls, timers, and database operations to run efficiently."})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-semibold text-slate-200 animate-[slideRight_0.5s_ease-out]",children:"1. Synchronous Code (Blocking)"}),e.jsx(s,{initialCode:`console.log("1. Start");
