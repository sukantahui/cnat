import{b as o,j as e}from"./vendor-react-core-BBXbtqt1.js";import{T as w}from"./TeacherSukantaHui-VMH_OtYp.js";import{P as m}from"./PythonFileLoader-YugaCzY9.js";import{F as v}from"./FAQTemplate-BamsZuNW.js";import{P as j}from"./PlainTextPrint-CGJ_aUDk.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const _=[{question:"What is the Entity-List pattern in multi-object animation?",shortAnswer:"Storing all moving game objects inside a Python list (e.g. `enemies = [...]`) and updating/rendering them in a single `for` loop.",explanation:"Allows scaling from 1 object to 500 objects with identical codebase structure.",hint:"What data structure stores a collection of animated game objects?",level:"basic",codeExample:`for entity in entities:
    entity.update()
