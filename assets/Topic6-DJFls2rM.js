import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as r}from"./FAQTemplate-BamsZuNW.js";import{P as n}from"./PlainTextPrint-CGJ_aUDk.js";import{T as s}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const a=`/**\r
...
1. READ/WRITE DECISION MATRIX:\r
   - '<? extends T>': PRODUCER → read 'T', cannot write.\r
   - '<? super T>': CONSUMER → write 'T', read 'Object'.\r
   - '<?>': UNBOUNDED → read 'Object', cannot write.\r
   - Only 'null' can be written to '<? extends T>' or '<?>'.\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,o=[{question:"Summarize the complete Read/Write rule matrix for 'List<?>', 'List<? extends T>', and 'List<? super T>'.",shortAnswer:"1. 'List<?>': Reads as 'Object', Writes prohibited (only null). 2. 'List<? extends T>': Reads as 'T' (Data Producer), Writes prohibited (only null). 3. 'List<? super T>': Reads as 'Object', Writes permitted for 'T' and subtypes of 'T' (Data Consumer).",explanation:"The foundational mental model for all Java generic collection manipulation.",hint:"extends = read as T, no write; super = write as T, read as Object; ? = read as Object, no write.",level:"Intermediate",codeExample:"List<? extends T> prod; T t = prod.get(0); List<? super T> cons; cons.add(t);"}];function T(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 006_004 · Topic 6"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Read/Write Rules"})]}),e.jsx("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:"The Read/Write Rules with Wildcards: Complete Decision Matrix"}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the complete decision matrix: analyzing why ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"<? extends T>"})," is read-only as T while ",e.jsx("code",{className:"text-purple-300 font-mono",children:"<? super T>"})," is write-enabled for T."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"WildcardReadWriteRulesSummaryDemo.java",highlightLines:[7,10,16,17,24,25,26]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{title:"Read/Write Rules FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 006_004 Topic 6: Wildcard Read/Write Rules",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"006_004_topic6_wildcard_read_write_rules_note.txt"})}),e.jsx(s,{note:"If you only remember one thing from generics, remember this: 'extends' is for reading (get), and 'super' is for writing (add)! This simple rule will make you pass any Java interview with flying colors! — Sukanta Hui"})]})}export{T as default};
