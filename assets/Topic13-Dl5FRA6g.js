...
================================================================================`,o=[{question:"What is the primary syntax rule for 'super()' constructor invocation in Java?",shortAnswer:"'super(...)' MUST be the very first executable statement in the subclass constructor body.",explanation:"Any code before 'super()' causes a compile error: 'call to super must be first statement in constructor'.",hint:"super() must be on line 1.",level:"Beginner",codeExample:"public Child(int id) { super(id); this.flag = true; }"}];function b(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_003 · Topic 13"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Compiler Syntax Constraints"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Rules of ",e.jsx("code",{className:"text-indigo-400 font-mono",children:"super()"}),": The First Statement Mandate"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the exact compiler laws governing ",e.jsx("code",{className:"text-indigo-300 font-mono",children:"super(...)"}),": line 1 placement, permitted static expressions in arguments, and parent-first memory guarantees."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"SuperCallFirstStatementRulesDemo.java",highlightLines:[22,23,24,34]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{title:"Rules of super() FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 002_003 Topic 13: Rules of super() Call",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_003_topic13_super_rules_note.txt"})}),e.jsx(a,{note:"Just like this(), super() must sit on Line 1. The parent must be born before the child can add its own state! — Sukanta Hui"})]})}export{b as default};
