import{b as l,j as e}from"./vendor-react-core-D9iF7FwR.js";import{C as V}from"./cnat-Cw7eyaib.js";import{p as Y}from"./paid-stamp-DDbnMIS8.js";import{t as Ye,a as Qe}from"./vendor-canvas-e-rorcri.js";import{s as ye}from"./studentService-CIPRkBgl.js";import{c as be}from"./courseService-C2Gcbf6X.js";import{l as He}from"./loginService-BC6Cz5ro.js";import"./api-9gFnePCv.js";const nt=()=>{const we=()=>{const t=new Date,a=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return`${a}-${s}-${n}`},[u,ve]=l.useState(null),[Je,Q]=l.useState(!0),[A,H]=l.useState([]),[F,J]=l.useState(!1),[Ne,T]=l.useState(""),[D,K]=l.useState(null),[Ke,N]=l.useState(""),[X,Z]=l.useState([]),[$,ee]=l.useState(!1),[R,te]=l.useState(null),[I,E]=l.useState(!1),[g,q]=l.useState({student_name:"",nickname:"",whatsapp:""}),[ae,re]=l.useState(!1),[M,h]=l.useState(null),[U,z]=l.useState(!1),[v,_]=l.useState({courseCode:"",courseName:""}),[se,oe]=l.useState(!1),[L,b]=l.useState(null),[r,f]=l.useState({studentName:"",phone:"",course:"",feeType:"non_monthly",monthlyFeeAmount:"",feesPaid:"",paymentDate:we(),paymentMode:"Cash",periodFrom:"",periodTo:"",registrationNumber:""}),[o,je]=l.useState(null),[j,ke]=l.useState(!1),[B,k]=l.useState(!1),[ne,ie]=l.useState(!1),le=l.useRef(null),[Ce,Se]=l.useState(""),[Pe,Ae]=l.useState(""),Fe=async()=>{Q(!0);try{const t=await He.currentUser();t&&t.status===!0&&t.data&&ve(t.data)}catch(t){console.error("Error fetching current user:",t)}finally{Q(!1)}};l.useEffect(()=>{Fe(),Te(),de()},[]);const Te=async()=>{J(!0),K(null);try{const t=await ye.getAll();let a=[];t&&t.data&&Array.isArray(t.data)?a=t.data:Array.isArray(t)?a=t:t&&t.data&&t.data.data&&Array.isArray(t.data.data)&&(a=t.data.data),H(a),a.length===0&&console.warn("No students found in database")}catch(t){console.error("Error fetching students:",t),K("Failed to load students from database. Please try again later."),H([])}finally{J(!1)}},de=async()=>{ee(!0),te(null);try{const t=await be.getAll();let a=[];t&&t.status===!0&&Array.isArray(t.data)?a=t.data:Array.isArray(t)?a=t:t&&t.data&&Array.isArray(t.data)&&(a=t.data),Z(a),a.length===0&&console.warn("No courses found in database")}catch(t){console.error("Error fetching courses:",t),te("Failed to load courses from database. Please try again later."),Z([])}finally{ee(!1)}},ce=()=>u?u.employee&&u.employee.employeeName?u.employee.employeeName:u.userName?u.userName:"Authorized Collector":"System",pe=()=>u?u.employee&&u.employee.designation?u.employee.designation.name:u.role||u.userType&&u.userType.userTypeName?u.role||u.userType.userTypeName:"Accounts Department":"",W=t=>{const{name:a,value:s}=t.target;q(n=>({...n,[a]:s})),M&&h(null)},De=async t=>{if(t.preventDefault(),!g.student_name.trim()){h("Student name is required");return}if(!g.whatsapp.trim()){h("WhatsApp number is required");return}if(!/^\d{10}$/.test(g.whatsapp)){h("Please enter a valid 10-digit WhatsApp number");return}re(!0),h(null);try{const s={student_name:g.student_name.trim(),nickname:g.nickname.trim()||g.student_name.trim(),whatsapp:g.whatsapp.trim()},n=await ye.createBasic(s);if(n&&n.status===!0){const i=n.data,m=i?.id||i?.studentId,c=i?.studentName||i?.student_name||"",p=i?.registrationNumber||i?.regNo||i?.reg_no||"";i&&m&&(T(m.toString()),N(p),f(d=>({...d,studentName:c,phone:i.whatsapp||i.phone1||"",registrationNumber:p}))),q({student_name:"",nickname:"",whatsapp:""}),E(!1),alert(`Student "${c}" created successfully!
