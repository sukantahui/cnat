import{r as l,j as e,a as u}from"./index-Do7ncMju.js";import{c as x}from"./clsx-B-dksMZM.js";import{P as j}from"./PythonCodeBlock-DlDiNVmq.js";import"./prism-B9ltoSp8.js";import"./browser-B9t-54wy.js";function t({fileModule:s,title:r=null,highlightLines:m=[],showEscapes:d=!1}){const[h,c]=l.useState(""),[g,i]=l.useState(!0);l.useEffect(()=>{if(!s){i(!1);return}typeof s=="string"?(c(o(s)),i(!1)):p(s)},[s,d]);function o(n){let a=n.replace(/\r\n/g,`
`);return d?a.replace(/\n/g,`\\n
