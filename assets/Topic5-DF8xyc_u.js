...
================================================================================`,o=[{question:"What is the core rule of the Liskov Substitution Principle (LSP)?",shortAnswer:"LSP states that objects of a superclass should be replaceable with objects of its subclasses without breaking application correctness, altering expected behavior, or throwing unexpected UnsupportedOperationExceptions.",explanation:"Named after Turing Award winner Barbara Liskov.",hint:"Subclasses must behave correctly in place of their parent classes without throwing unexpected exceptions.",level:"Intermediate",codeExample:"void process(Parent p) { p.doWork(); /* Works with any valid child! */ }"}];function h(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_011 · Topic 5"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"SOLID: L"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["L — Liskov Substitution Principle (LSP): ",e.jsx("span",{className:"text-emerald-400",children:"Behavioral Subtyping"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Understand why inheritance must preserve behavioral contracts: preventing subclass overrides from throwing unexpected exceptions and corrupting calling pipelines."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"LiskovSubstitutionPrincipleDemo.java",highlightLines:[11,20,26,31,36,47]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"LSP FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{content:s,title:"Module 002_011 Topic 5: Liskov Substitution Principle",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_011_topic5_lsp_note.txt"})}),e.jsx(r,{note:"If a subclass overrides a parent method by throwing 'UnsupportedOperationException', it is not a true subtype! It violates LSP and breaks callers who rely on polymorphism. — Sukanta Hui"})]})}export{h as default};
