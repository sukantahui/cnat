...
while True:
    ...
    pass
print("Program continues")`}),e.jsxs("div",{className:"bg-yellow-900/30 border-l-4 border-yellow-400 p-3 text-sm text-yellow-200",children:[e.jsx("strong",{children:"👩‍🏫 Teacher Note:"}),e.jsx("code",{children:"pass"})," is useful when writing program structure before implementing logic."]})]})]})}}export{g as default};
