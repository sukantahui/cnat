import{b as u,j as e}from"./vendor-react-core-D9iF7FwR.js";import{T as _}from"./TeacherSukantaHui-Bldu0y17.js";import{P as h}from"./PythonFileLoader-D5JKxZvU.js";import{F as w}from"./FAQTemplate-DmdkpHR-.js";import{P as j}from"./PlainTextPrint-CS96sBe2.js";import"./vendor-icons-Beb6eGc1.js";import"./PythonCodeBlock-Dy3OqNFl.js";import"./vendor-prism-SANIKoEh.js";const k=[{question:"How do you detect collision with the right screen boundary for a circular ball?",shortAnswer:"`if x + radius >= max_x:`",explanation:"Because coordinate `(x, y)` is at the center, the rightmost edge of the circle is at `x + radius`.",hint:"How is the circle's rightmost coordinate calculated relative to its center?",level:"basic",codeExample:`if x + radius >= max_x:
    x = max_x - radius
