...
`,v=window.open("","_blank");v.document.write(_),v.document.close()},z=()=>{const h=ie(),x=n?(r/n*100).toFixed(2):"0.00",N=x>=85?"A+ 🌟":x>=70?"A 👍":x>=60?"B 🙂":x>=50?"C ⚠️":"D ❌",b=x>=C,w=b?"PASSED ✅":"NOT PASSED ❌",A=b?`🎉 *Congratulations!*  
