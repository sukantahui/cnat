...
1. HIERARCHY CONSTRUCTOR DISPATCH:\r
   - Invocation order: Child → Parent → GrandParent (via super() calls).\r
   - Execution order: GrandParent → Parent → Child (bodies run top-down).\r
\r
================================================================================\r
