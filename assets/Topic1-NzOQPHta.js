import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as a}from"./FAQTemplate-BamsZuNW.js";import{P as r}from"./PlainTextPrint-CGJ_aUDk.js";import{T as n}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const s=`/**\r
...
================================================================================`,l=[{question:"Which two primitive types do not have wrapper classes named simply with their capitalized primitive name?",shortAnswer:"'int' maps to 'Integer' (not Int), and 'char' maps to 'Character' (not Char). The other six simply capitalize the primitive name (Byte, Short, Long, Float, Double, Boolean).",explanation:"All 8 wrapper classes are immutable and declared 'final'.",hint:"int → Integer and char → Character.",level:"Beginner",codeExample:"Integer i = 10; Character c = 'A';"}];function g(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_003 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Type Mapping"})]}),e.jsx("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:"The 8 Wrapper Classes Matching 8 Primitives"}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the exact one-to-one mapping across all 8 Java primitive types and their corresponding immutable, ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"final"})," wrapper classes."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"EightWrapperClassesMappingDemo.java",highlightLines:[7,14,15,16,17,18,19,20,21]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"8 Wrapper Classes FAQs",questions:l})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:i,title:"Module 003_003 Topic 1: 8 Wrapper Classes",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_003_topic1_wrapper_mapping_note.txt"})}),e.jsx(n,{note:"Remember: All 8 wrapper classes are final and immutable! Once an Integer holds 100, its internal value can never be modified. — Sukanta Hui"})]})}export{g as default};
