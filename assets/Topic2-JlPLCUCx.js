import{b as a,j as e}from"./vendor-react-core-BBXbtqt1.js";import{T as h}from"./TeacherSukantaHui-VMH_OtYp.js";import{P as l}from"./PythonFileLoader-YugaCzY9.js";import{F as p}from"./FAQTemplate-BamsZuNW.js";import{P as m}from"./PlainTextPrint-CGJ_aUDk.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const u=[{question:"What is the default colormode in Python Turtle?",shortAnswer:"colormode(1.0) — where RGB values are floats from 0.0 to 1.0.",explanation:"By default, Turtle expects RGB tuples to contain floats within [0.0, 1.0].",hint:"Are RGB channels floats (0.0 to 1.0) or integers (0 to 255) by default?",level:"basic",codeExample:"t.color((0.5, 0.2, 0.8))  # Default float mode"},{question:"How do you enable standard 0-255 integer RGB mode in Turtle?",shortAnswer:"Call `screen.colormode(255)` or `turtle.colormode(255)`.",explanation:"Setting colormode(255) allows passing standard 8-bit integer RGB tuples like `(255, 128, 0)`.",hint:"What method changes the color representation scale?",level:"basic",codeExample:`screen = turtle.Screen()
