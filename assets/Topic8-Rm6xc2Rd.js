...
1. RULE 1 INVARIANT:\r
   - 'a.equals(b) == true' → 'a.hashCode() == b.hashCode()' MUST hold 100% of the time.\r
...
================================================================================`,l=[{question:"Why is it mandatory that if 'a.equals(b)' is true, 'a.hashCode()' must equal 'b.hashCode()'?",shortAnswer:"Because hash-based collections (HashMap/HashSet) use hashCode() first to locate the bucket. If two logically equal objects had different hash codes, the collection would look in different buckets and fail to find or deduplicate the object.",explanation:"This rule preserves collection consistency across all Java APIs.",hint:"Guarantees that equal objects land in the exact same hash bucket.",level:"Intermediate",codeExample:"if (a.equals(b)) assert a.hashCode() == b.hashCode();"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_010 · Topic 8"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Contract Rule 1"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Rule 1: If ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"a.equals(b)"})," is True, ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"a.hashCode()"})," MUST Equal ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"b.hashCode()"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Learn why equal objects must strictly produce identical hash codes to ensure deterministic bucket routing in hash-based data structures."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"EqualsImpliesSameHashCodeDemo.java",highlightLines:[18,25,36,39]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Rule 1 FAQs",questions:l})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:o,title:"Module 002_010 Topic 8: Rule 1 Equal HashCodes",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_010_topic8_rule1_note.txt"})}),e.jsx(r,{note:"If two student badges are equal, they must return the exact same integer from hashCode(). Never use random numbers or memory addresses inside hashCode()! — Sukanta Hui"})]})}export{x as default};
