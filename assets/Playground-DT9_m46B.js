import{b as f,j as e}from"./vendor-react-core-D9iF7FwR.js";import{F as C}from"./vendor-monaco-CEXMEfXF.js";import{$ as k,b4 as N,bO as L,a0 as T,a1 as b,a2 as z,m as M,a3 as E,a4 as F,b1 as H,b2 as R,c as O,D,bP as P,r as J,s as $}from"./vendor-icons-CBbStT7G.js";class w extends f.Component{constructor(t){super(t),this._postMessageHandler=n=>{!n.data||!n.data.type||n.data.type==="console"&&this.setState(c=>({consoleOutput:[...c.consoleOutput,{type:n.data.level||"log",message:n.data.message}]}))},window.addEventListener("message",this._postMessageHandler,!1);const o=n=>this.normalizeCode(n||""),a=t.initialSnippets||{},i=o(a.javascript??t.initialCode??""),l=o(a.html??`<!-- HTML goes here -->
