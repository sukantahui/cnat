...
check your work at each step."`,X=()=>{const[h,j]=l.useState("concept"),[y,k]=l.useState({}),[p,N]=l.useState(null),[g,S]=l.useState(null),Z=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],R=[{id:1,title:"Example 1: Complete Iteration",problem:`Perform one complete Simplex iteration on:
Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
