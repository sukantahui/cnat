import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as n}from"./FAQTemplate-BamsZuNW.js";import{P as o}from"./PlainTextPrint-CGJ_aUDk.js";import{T as r}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const a=`/**\r
...
1. MODULE DIRECTIVES CHEATSHEET:\r
   - 'requires M;'        → Module depends on M.\r
   - 'requires transitive M;' → Anyone requiring this module also gets M.\r
   - 'exports P;'         → Package P public types accessible to callers.\r
   - 'exports P to M1, M2;' → Qualified export to specific modules only.\r
   - 'opens P;'           → Opens package P for runtime reflection.\r
\r
================================================================================\r
...
================================================================================`,i=[{question:"What is the difference between 'exports' and 'opens' in a 'module-info.java' descriptor?",shortAnswer:"'exports' makes public classes in the package accessible at both compile-time and runtime. 'opens' allows runtime deep reflection (including private field access) by frameworks like Spring Boot or Jackson without exposing compile-time access.",explanation:"If you don't 'open' a package, reflection frameworks like Hibernate will fail with an IllegalAccessException.",hint:"'exports' for compile-time public API; 'opens' for runtime reflection by frameworks.",level:"Advanced",codeExample:"module com.app { exports com.app.api; opens com.app.model to spring.core; }"}];function y(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_009 · Topic 14"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"JPMS Directives"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:[e.jsx("code",{className:"text-purple-400 font-mono",children:"module-info.java"})," Syntax: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"requires"}),", ",e.jsx("code",{className:"text-sky-400 font-mono",children:"exports"})," & ",e.jsx("code",{className:"text-amber-400 font-mono",children:"opens"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the configuration grammar of Java 9 module descriptors: declaring dependency graphs with ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"requires"}),", exposing APIs with ",e.jsx("code",{className:"text-sky-300 font-mono",children:"exports"}),", and granting reflection with ",e.jsx("code",{className:"text-amber-300 font-mono",children:"opens"}),"."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"ModuleDescriptorSyntaxDemo.java",highlightLines:[7,14,17,20,24]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"module-info.java FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(o,{content:s,title:"Module 002_009 Topic 14: module-info.java Directives",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_009_topic14_module_info_note.txt"})}),e.jsx(r,{note:"If you are using Spring Boot or Jackson to convert objects to JSON, always remember to 'opens com.app.model;' in your module-info so Jackson can reflectively inspect your fields! — Sukanta Hui"})]})}export{y as default};
