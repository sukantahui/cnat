import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as n}from"./FAQTemplate-BamsZuNW.js";import{P as a}from"./PlainTextPrint-CGJ_aUDk.js";import{T as r}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const o=`/**\r
...
================================================================================`,s=[{question:"Compare the two primary categories of Race Conditions: 'Read-Modify-Write' vs 'Check-Then-Act'.",shortAnswer:"1. 'Read-Modify-Write': Occurs when the next state of a variable depends on its previous state (e.g. 'counter++' or 'balance += amount'). Multiple threads read the same stale value, calculate their updates in local registers, and write back, overwriting and losing each other's increments. 2. 'Check-Then-Act': Occurs when a thread verifies a condition (e.g. 'if (instance == null)' or 'if (map.containsKey(key))'), but before it can perform the subsequent action, another thread interleaves and mutates the state, rendering the verified condition invalid.",explanation:"Comprehensive taxonomy of race conditions in computer science.",hint:"Read-Modify-Write causes lost updates (count++); Check-Then-Act causes actions on stale conditions (lazy singleton).",level:"Intermediate",codeExample:"// RMW: count++; | CTA: if (instance == null) instance = new Helper();"}];function y(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 008_005 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Race Taxonomies"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Categories of Race Conditions: ",e.jsx("code",{className:"text-rose-400 font-mono",children:"Read-Modify-Write"})," & ",e.jsx("code",{className:"text-amber-400 font-mono",children:"Check-Then-Act"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Classify concurrency hazards: contrasting lost update anomalies in ",e.jsx("code",{className:"text-rose-300 font-mono",children:"Read-Modify-Write"})," counters with stale verification bugs in ",e.jsx("code",{className:"text-amber-300 font-mono",children:"Check-Then-Act"})," lazy initializations."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:o,title:"RaceConditionCategoriesTaxonomyDemo.java",highlightLines:[7,10,16,17,21,22,30,31,38,39]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Race Categories FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{content:i,title:"Module 008_005 Topic 1: Categories of Race Conditions",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"008_005_topic1_race_condition_categories_note.txt"})}),e.jsx(r,{note:"Almost all concurrency bugs fall into one of these two buckets: Either you are updating a number without locking (Read-Modify-Write), or you are checking if something is null before creating it (Check-Then-Act)! Master both and you master concurrency! — Sukanta Hui"})]})}export{y as default};
