import{j as e}from"./index-BpX9yBGC.js";import{E as s}from"./EditablePythonCodeBlock-CDqGQ3t5.js";import"./index-DZzRudEq.js";import"./braces-BbI-6Ty8.js";import"./layout-list-B_IFuJft.js";import"./play-DH_OxpbG.js";import"./type-Dp2t6Gfg.js";import"./refresh-cw-BzjppSKX.js";import"./copy-DyUhmCDX.js";import"./download-Cy_wnQFp.js";import"./eye-off-DCaPhBkD.js";import"./eye-DZru3oP4.js";function p(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Nested Conditions in Python — Multi-Level Decision Making"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["Nested conditions allow you to place one ",e.jsx("code",{children:"if"})," statement inside another. They help model real-life situations where a decision depends on multiple layers of checks. For example: verifying age, then checking ID, then checking membership."]}),e.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"1. What is a Nested Condition?"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["A nested condition is simply an ",e.jsx("code",{children:"if"})," inside another ",e.jsx("code",{children:"if"}),". Python executes inner blocks only if the outer conditions are satisfied."]}),e.jsx(s,{initialCode:`age = 22
has_id = True
