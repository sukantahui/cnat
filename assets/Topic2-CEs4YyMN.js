...
================================================================================`,i=[{question:"What powerful stream navigation feature does 'BufferedInputStream' support that raw 'FileInputStream' does NOT support?",shortAnswer:"'BufferedInputStream' supports 'mark(readlimit)' and 'reset()'. Because it caches data in an internal RAM array, you can mark a stream position, read ahead to inspect/preview headers or magic bytes, and then call 'reset()' to rewind the stream cursor back to the marked position without restarting the stream.",explanation:"bis.markSupported() returns true on BufferedInputStream, whereas FileInputStream returns false.",hint:"Supports mark(readlimit) and reset() for rewindable lookahead parsing.",level:"Intermediate",codeExample:"bis.mark(100); bis.read(header); bis.reset(); // Rewinds to mark"}];function S(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 005_003 · Topic 2"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Byte Decorator"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:[e.jsx("code",{className:"text-emerald-400 font-mono",children:"BufferedInputStream"})," & ",e.jsx("code",{className:"text-sky-400 font-mono",children:"BufferedOutputStream"}),": Wrapping Byte Streams"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Apply the Decorator pattern to binary I/O: wrapping raw streams, executing buffered writes, and leveraging ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"mark()"})," and ",e.jsx("code",{className:"text-sky-300 font-mono",children:"reset()"})," lookahead parsing."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:s,title:"BufferedByteStreamsDecoratorDemo.java",highlightLines:[7,10,18,19,21,28,29,36,42,45]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Buffered Byte Streams FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{content:o,title:"Module 005_003 Topic 2: Buffered Byte Streams",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"005_003_topic2_buffered_byte_streams_note.txt"})}),e.jsx(n,{note:"BufferedInputStream is famous for 'mark()' and 'reset()'! When writing binary parsers for PNG images or PDF files, you can read the first 4 bytes to check the file type and reset back without closing the stream! — Sukanta Hui"})]})}export{S as default};
