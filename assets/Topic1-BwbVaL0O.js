...
================================================================================`,i=[{question:"What are the permissible key-value separator characters and comment markers in standard Java .properties files?",shortAnswer:"1. Separators: Key and value can be separated by '=', ':', or unquoted whitespace (' '). 2. Comments: Any line beginning with '#' or '!' is treated as a comment and ignored. 3. Multi-line: Long values can span multiple lines by escaping the line break with a trailing backslash ('\\').",explanation:"Defined by the ISO-8859-1 / UTF-8 Properties file specification.",hint:"Separators are '=', ':', or spaces; comment markers are '#' and '!'; multi-line uses trailing backslash.",level:"Beginner",codeExample:`# Comment\\nkey1=val1\\nkey2: val2\\nkey3 val3\\nmultiline=line1\\\\
  line2`}];function g(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 005_006 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Syntax Specification"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Structure & Syntax Rules of ",e.jsx("code",{className:"text-emerald-400 font-mono",children:".properties"})," Files"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master property file syntax: parsing key-value delimiters (",e.jsx("code",{className:"text-emerald-300 font-mono",children:"="}),", ",e.jsx("code",{className:"text-sky-300 font-mono",children:":"}),", spaces), handling ",e.jsx("code",{className:"text-amber-300 font-mono",children:"#"})," and ",e.jsx("code",{className:"text-rose-300 font-mono",children:"!"})," comments, and escaping multi-line values."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:s,title:"PropertiesFileSyntaxRulesDemo.java",highlightLines:[7,10,16,17,21,24,27,30,31,37]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Syntax Rules FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{content:o,title:"Module 005_006 Topic 1: .properties Syntax Rules",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"005_006_topic1_properties_syntax_rules_note.txt"})}),e.jsx(a,{note:"Did you know you can use both '=' and ':' in .properties files? Even a simple space 'db.port 5432' is a valid delimiter! Use '=' consistently for clean code readability! — Sukanta Hui"})]})}export{g as default};
