import{j as e}from"./index-CNd73Haf.js";import{E as s}from"./EditablePythonCodeBlock-BCJ0JjXJ.js";import"./index-C68hWScs.js";import"./braces-Cz3Z1Lm3.js";import"./layout-list-jrwsTbkC.js";import"./play-k0XU6a0C.js";import"./type-l-7TR-1d.js";import"./refresh-cw-Cs1Cy281.js";import"./copy-Dqgrnt6d.js";import"./download-D0l-akX2.js";import"./eye-off-BFt-f9pX.js";import"./eye-CWJNugV0.js";function p(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Nested Conditions in Python — Multi-Level Decision Making"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["Nested conditions allow you to place one ",e.jsx("code",{children:"if"})," statement inside another. They help model real-life situations where a decision depends on multiple layers of checks. For example: verifying age, then checking ID, then checking membership."]}),e.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"1. What is a Nested Condition?"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["A nested condition is simply an ",e.jsx("code",{children:"if"})," inside another ",e.jsx("code",{children:"if"}),". Python executes inner blocks only if the outer conditions are satisfied."]}),e.jsx(s,{initialCode:`age = 22
has_id = True
