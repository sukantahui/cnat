import{b as f,j as e}from"./vendor-react-core-Doz9nIC6.js";import{F as C}from"./vendor-monaco-Bv7hoEkV.js";import{h as k,aB as N,bJ as L,i as T,j as b,k as z,R as M,l as E,m as R,ay as F,az as H,n as D,D as O,bK as J,o as P,p as B}from"./vendor-icons-wprqVFW_.js";class w extends f.Component{constructor(t){super(t),this._postMessageHandler=n=>{!n.data||!n.data.type||n.data.type==="console"&&this.setState(c=>({consoleOutput:[...c.consoleOutput,{type:n.data.level||"log",message:n.data.message}]}))},window.addEventListener("message",this._postMessageHandler,!1);const o=n=>this.normalizeCode(n||""),a=t.initialSnippets||{},i=o(a.javascript??t.initialCode??""),l=o(a.html??`<!-- HTML goes here -->
