...
problem is infeasible."`,L=()=>{const[t,g]=i.useState("concept"),[c,m]=i.useState({}),[l,b]=i.useState(null),[o,u]=i.useState(null),y=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],p=[{id:1,title:"Example 1: Big-M with ≥ Constraints",problem:`Solve using Big-M Method:
Minimize Z = 4x + 3y
Subject to:
x + y ≥ 6
2x + y ≥ 8
