import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as s}from"./FAQTemplate-BamsZuNW.js";import{P as a}from"./PlainTextPrint-CGJ_aUDk.js";import{T as n}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const i=`/**\r
...
1. RESIZING MECHANICS:\r
   ...
   - If 0 → stays at original bucket 'j'.\r
   - If != 0 → moves to high bucket 'j + oldCap'.\r
   - Preserves original node order (prevents Java 7 circular loop bugs).\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,r=[{question:"How does Java 8+ redistribute bucket elements during HashMap resizing without recomputing hash codes?",shortAnswer:"When capacity doubles (e.g. from 16 to 32), the bitmask expands by exactly 1 higher bit (bit 4, representing 16). Java tests this single bit using '(e.hash & oldCap)'. If the bit is 0 ('(hash & oldCap) == 0'), the node remains at its original bucket index ('j'). If the bit is 1, the node moves to 'j + oldCap' (e.g. 5 + 16 = 21). This splits the bucket into two clean lists without recomputing any hash arithmetic.",explanation:"Masterpiece bitwise algorithm inside java.util.HashMap.resize().",hint:"If (e.hash & oldCap) == 0 → stays at index j; otherwise → moves to index j + oldCap.",level:"Advanced",codeExample:"if ((e.hash & oldCap) == 0) { /* stays at j */ } else { /* moves to j + oldCap */ }"}];function g(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 007_005 · Topic 13"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Bitwise Resizing"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Rehashing & Resizing: Doubling (",e.jsx("code",{className:"text-emerald-400 font-mono",children:"2x"}),") & Bitwise Node Redistribution (",e.jsx("code",{className:"text-sky-400 font-mono",children:"e.hash & oldCap"}),")"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Dissect table expansion algorithms: analyzing how ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"(e.hash & oldCap) == 0"})," splits bucket chains into low and high partitions with zero re-hashing computation."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"HashMapRehashingBitwiseRedistributionDemo.java",highlightLines:[7,10,13,14,21,22,28,29,34,35]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(s,{title:"Resizing FAQs",questions:r})}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{content:o,title:"Module 007_005 Topic 13: Rehashing & Resizing",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"007_005_topic13_rehashing_and_resizing_note.txt"})}),e.jsx(n,{note:"Java 8's resizing algorithm is pure mathematical genius! When the table doubles from 16 to 32, Java checks just 1 single bit with '(hash & 16)'. If it's 0, the node stays in bucket 5; if it's 1, it moves to bucket 21! No re-hashing required! — Sukanta Hui"})]})}export{g as default};
