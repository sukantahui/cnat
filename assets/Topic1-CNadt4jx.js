...
================================================================================`,l=[{question:"Why is the internal backing array 'transient Object[] elementData' in java.util.ArrayList marked as 'transient'?",shortAnswer:"If 'elementData' were serialized using default Java serialization, all trailing empty buffer slots (e.g. 90 empty null entries in an array of capacity 100 with size 10) would be written to the byte stream, wasting bandwidth and storage. Marking it 'transient' allows ArrayList to provide custom 'writeObject()' and 'readObject()' methods that serialize ONLY the actual active elements ('size').",explanation:"A classic high-performance serialization optimization in the JDK core library.",hint:"Prevents serializing empty unused buffer slots, saving network bandwidth and disk space.",level:"Advanced",codeExample:"transient Object[] elementData; // Custom writeObject serializes only active size"}];function A(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 007_002 · Topic 1"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Backing Array Internals"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:[e.jsx("code",{className:"text-emerald-400 font-mono",children:"java.util.ArrayList"})," Internal Mechanics: The Backing ",e.jsx("code",{className:"text-purple-400 font-mono",children:"Object[] elementData"})," Array"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Trace internal JVM memory layouts: inspecting the private ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"elementData"})," array via reflection to observe lazy initialization and capacity vs size."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"ArrayListBackingArrayInternalsDemo.java",highlightLines:[7,10,14,15,16,25,29,35,39]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Backing Array FAQs",questions:l})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:s,title:"Module 007_002 Topic 1: ArrayList Backing Array",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"007_002_topic1_arraylist_backing_array_note.txt"})}),e.jsx(r,{note:"Under the hood, an ArrayList is just a plain Java array ('Object[] elementData') that automatically swaps itself for a larger array whenever it runs out of space! That's why it gives you the speed of an array with the flexibility of a dynamic list! — Sukanta Hui"})]})}export{A as default};
