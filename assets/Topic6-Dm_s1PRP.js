...
1. THE GOLDEN RULE OF LOGGING:\r
   - Handle OR Throw &rarr; NEVER BOTH.\r
...
================================================================================`,s=[{question:"Why is 'Log and Throw' (logging an exception in a catch block and then immediately rethrowing it) considered a severe anti-pattern?",shortAnswer:"Because if every method layer in a call stack logs and rethrows the exception, a single failure produces duplicate 50-line stack traces in log files at every layer (DAO, Service, Controller). This floods log storage, clutters debugging, and triggers duplicate alert storms in monitoring systems like Splunk or Datadog.",explanation:"The golden rule is: 'Handle or Propagate, Never Both'.",hint:"Causes duplicate log spam across multiple layers and triggers false monitoring alerts.",level:"Intermediate",codeExample:"// BAD: catch(Ex e) { log.error(e); throw e; } // Logged multiple times!"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 004_005 · Topic 6"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Logging Anti-Pattern"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The ",e.jsx("code",{className:"text-rose-400 font-mono",children:"'Log and Throw'"})," Anti-Pattern: Preventing Log Clutter & Alert Storms"]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Clean up enterprise observability: learning why you must choose between handling an error or rethrowing it, preventing duplicate multi-tier stack trace pollution."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:a,title:"LogAndThrowAntiPatternDemo.java",highlightLines:[7,10,12,13,17,20,21,26,29]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Log and Throw FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:i,title:"Module 004_005 Topic 6: Log and Throw Anti-Pattern",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"004_005_topic6_log_and_throw_note.txt"})}),e.jsx(o,{note:"If your DAO logs an error, your Service logs the error, and your Controller logs the error, you get 3 identical error alerts at 3 AM for 1 single bug! Log it ONCE at the top boundary! — Sukanta Hui"})]})}export{x as default};
