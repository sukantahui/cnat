const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Topic0-C1T9mUuG.js","assets/index-D-07m6Qb.js","assets/index-D-k4TRvE.css","assets/network-ZYxr8ovD.js","assets/circle-alert-Cd9WD8lJ.js","assets/server-CAxvaoB5.js","assets/Topic1-B8UVLGfo.js","assets/Topic2-DFnPtTi-.js","assets/Topic3-Brvkv9Ko.js","assets/Topic4-C3CKYzTb.js","assets/PracticeEngineAdvance-CoruoM6y.js","assets/CodeBlockGeneral-D5SI5de-.js","assets/prism-Dw--ewGm.js","assets/prism-json-D0UlpdKh.js","assets/Topic5-DQSSsnp5.js","assets/index-Chjiymov.js","assets/Topic6-BjLPmS6z.js","assets/Topic7-BgS-42t8.js","assets/CodeBlock-BNkIv_4S.js","assets/file-code-n9BmD-WT.js","assets/copy-BeFV_rGJ.js","assets/download-B_C6cj02.js","assets/play-4rBxpZha.js","assets/Topic0-CfngloQT.js","assets/Topic1-CiCHFG8G.js"])))=>i.map(i=>d[i]);
import{u as Z,j as e,r as d,L as i,R as ee,A as j,b as H,B as te,l as y,n as se,C as G,X as re,_ as x}from"./index-D-07m6Qb.js";import{r as l}from"./general-roadmap-Bm9Nl7tM.js";const Q=Object.assign({"./topics/general-practice-test-one/Topic0.jsx":()=>x(()=>import("./Topic0-C1T9mUuG.js"),__vite__mapDeps([0,1,2,3,4,5])),"./topics/general-practice-test-one/Topic1.jsx":()=>x(()=>import("./Topic1-B8UVLGfo.js"),__vite__mapDeps([6,1,2])),"./topics/general-practice-test-one/Topic2.jsx":()=>x(()=>import("./Topic2-DFnPtTi-.js"),__vite__mapDeps([7,1,2])),"./topics/general-practice-test-one/Topic3.jsx":()=>x(()=>import("./Topic3-Brvkv9Ko.js"),__vite__mapDeps([8,1,2])),"./topics/general-practice-test-one/Topic4.jsx":()=>x(()=>import("./Topic4-C3CKYzTb.js"),__vite__mapDeps([9,1,2,10,11,12,13])),"./topics/general-practice-test-one/Topic5.jsx":()=>x(()=>import("./Topic5-DQSSsnp5.js"),__vite__mapDeps([14,1,2,11,12,13,15])),"./topics/general-practice-test-one/Topic6.jsx":()=>x(()=>import("./Topic6-BjLPmS6z.js"),__vite__mapDeps([16,1,2,10,11,12,13])),"./topics/general-practice-test-one/Topic7.jsx":()=>x(()=>import("./Topic7-BgS-42t8.js"),__vite__mapDeps([17,1,2,18,12,13,19,20,21,22])),"./topics/general-topics/Topic0.jsx":()=>x(()=>import("./Topic0-CfngloQT.js"),__vite__mapDeps([23,1,2])),"./topics/general-topics/Topic1.jsx":()=>x(()=>import("./Topic1-CiCHFG8G.js"),__vite__mapDeps([24,1,2]))});function ne(){const{moduleSlug:a,topicIndex:m}=Z();return e.jsx(le,{moduleSlug:a,topicIndex:m},`${a}-${m}`)}function le({moduleSlug:a,topicIndex:m}){const n=Number.parseInt(m,10)||0,P=d.useRef(null),[q,b]=d.useState(!1);let r=null,O=null;for(const s of l.segments){const t=s.modules.find(o=>o.slug===a);if(t){r=t,O=s;break}}if(!r)return e.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 p-10",children:[e.jsx("h1",{className:"text-2xl text-red-400 font-bold",children:"Module Not Found"}),e.jsx(i,{to:`/${l.folder}/roadmap`,className:"text-sky-400 underline mt-4 inline-block",children:"← Back to Roadmap"})]});const N=r.topics[n];if(!N)return e.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 p-10",children:[e.jsx("h1",{className:"text-2xl text-red-400 font-bold",children:"Topic Not Found"}),e.jsx(i,{to:`/${l.folder}/module/${a}`,className:"text-sky-400 underline mt-4 inline-block",children:"← Back to Module"})]});const v=`js-progress-${a}`,[C,S]=d.useState([]);d.useEffect(()=>{const s=localStorage.getItem(v)||"[]";let t=[];try{t=JSON.parse(s)}catch{t=[]}t.includes(n)||t.push(n),t.sort((o,c)=>o-c),localStorage.setItem(v,JSON.stringify(t)),S(t)},[n,v]);const h=r.topics.length,L=C.length,w=Math.round(L/h*100),B=n>0,A=n<h-1,D=()=>{localStorage.removeItem(v),S([])},I=`./topics/${a}/Topic${m}.jsx`,V=Q[I]?ee.lazy(Q[I]):null;d.useEffect(()=>{P.current&&P.current.scrollIntoView({behavior:"smooth",block:"center"})},[n]),d.useEffect(()=>{b(!1)},[a,m]);const[M,F]=d.useState(""),[p,J]=d.useState(()=>{try{return localStorage.getItem("student_name")||""}catch{return""}}),[k,K]=d.useState(!0),[W,E]=d.useState(!1),[Y,R]=d.useState(""),z=s=>s.map((t,o)=>`${o+1}. ${t}`).join(`
