...
echo "scale=50; 4*a(1)" | bc -l`,S=()=>{const d=new Date().getFullYear()-1998,[n,h]=a.useState("10 * 3.14159"),[i,u]=a.useState(2),[x,o]=a.useState(""),[m,l]=a.useState(!1);return a.useEffect(()=>{l(!0),setTimeout(()=>l(!1),300);try{let s=n;s=s.replace(/\^/g,"**");let t;if(s.includes("sqrt(")){const c=s.match(/sqrt\(([^)]+)\)/);c?t=Math.sqrt(parseFloat(c[1])):t=new Function("return ("+s+")")()}else t=new Function("return ("+s+")")();t=t.toFixed(i),o(t)}catch{o("Error: invalid expression")}},[n,i]),e.jsxs("div",{className:"min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans leading-relaxed",children:[e.jsx("style",{children:`
  ...
  `}),e.jsxs("section",{className:"max-w-6xl mx-auto px-4 py-12 md:py-16 animate-fade-slide-up",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsx("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent mb-4",children:"🧮 The `bc` Command"}),e.jsx("p",{className:"text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto",children:"Arbitrary-precision calculator language — perform math from simple arithmetic to complex scripting."})]}),e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-12 transition-all duration-300 hover:shadow-xl card-hover",children:[e.jsxs("h2",{className:"text-2xl font-semibold mb-4 flex items-center gap-2",children:[e.jsx("span",{className:"text-green-500",children:"$"})," Try bc live"]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("label",{className:"block text-sm font-medium mb-2",children:"Expression:"}),e.jsx("input",{type:"text",value:n,onChange:s=>h(s.target.value),className:"w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-mono",placeholder:"e.g., 10 * 3.14159"})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("label",{className:"block text-sm font-medium mb-2",children:"Scale (decimal places):"}),e.jsx("input",{type:"number",value:i,onChange:s=>u(parseInt(s.target.value)||0),min:"0",max:"20",className:"w-24 px-3 py-1 rounded-lg bg-gray-100 dark:bg-gray-700"})]}),e.jsxs("div",{className:"bg-gray-900 dark:bg-black rounded-lg p-4 font-mono text-sm text-green-400",children:[e.jsxs("div",{className:"flex items-center gap-2 text-gray-400 mb-2",children:[e.jsx("span",{className:"text-green-400",children:"$"}),e.jsxs("span",{children:['echo "scale=',i,"; ",n,'" | bc']})]}),e.jsx("pre",{className:b("transition-opacity duration-300",m?"opacity-70":"opacity-100"),children:x})]}),e.jsx("p",{className:"text-xs text-gray-500 dark:text-gray-400 mt-3 italic",children:'💡 `bc` stands for "basic calculator" — supports variables, functions, and conditionals.'})]})]}),e.jsx("section",{className:"max-w-6xl mx-auto px-4 py-8",children:e.jsxs("div",{className:"grid md:grid-cols-2 gap-8",children:[e.jsxs("div",{className:"space-y-6 animate-fade-slide-up",style:{animationDelay:"0.1s"},children:[e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md card-hover",children:[e.jsx("h2",{className:"text-2xl font-bold border-l-4 border-blue-500 pl-3 mb-4",children:"📖 What is `bc`?"}),e.jsxs("p",{className:"mb-3",children:["The ",e.jsx("code",{className:"bg-gray-100 dark:bg-gray-700 px-1 rounded",children:"bc"})," command is an arbitrary-precision calculator language. It can handle numbers of any size (limited only by memory) and supports decimal, binary, hex, and custom bases."]}),e.jsx("p",{children:"Unlike shell arithmetic (`$(( ))`), `bc` handles floating-point numbers, has variables, loops, functions, and is fully programmable."})]}),e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md card-hover",children:[e.jsx("h2",{className:"text-2xl font-bold border-l-4 border-green-500 pl-3 mb-4",children:"🎯 Prototype & Signature"}),e.jsx("div",{className:"font-mono text-sm bg-gray-100 dark:bg-gray-700 p-3 rounded",children:e.jsx("code",{children:"bc [ -hlwsqv ] [long-options] [ file ... ]"})}),e.jsxs("ul",{className:"mt-4 space-y-2",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Purpose:"})," Perform arbitrary-precision arithmetic and script math operations."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Return:"})," Outputs calculation result to stdout (exit 0 on success)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"When used:"})," When shell arithmetic is insufficient (floats, large numbers, complex expressions)."]})]})]})]}),e.jsxs("div",{className:"space-y-6 animate-fade-slide-up",style:{animationDelay:"0.2s"},children:[e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md card-hover",children:[e.jsx("h2",{className:"text-2xl font-bold border-l-4 border-purple-500 pl-3 mb-4",children:"🌍 Real-World Use Cases"}),e.jsxs("ul",{className:"list-disc pl-5 space-y-2",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Scientific calculations:"})," Pi to 1000 decimal places: ",e.jsx("code",{className:"text-sm",children:'echo "scale=1000; 4*a(1)" | bc -l'})]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Financial scripts:"})," Interest calculations with exact decimal precision."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Unit conversions:"})," Temperature, currency, or data size conversions in scripts."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"System monitoring:"})," Calculate average load, memory usage percentages."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Birthday/age calculations:"})," Floating-point division of days."]})]})]}),e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md card-hover",children:[e.jsx("h2",{className:"text-2xl font-bold border-l-4 border-amber-500 pl-3 mb-4",children:"💡 Professional Tips & Tricks"}),e.jsxs("ul",{className:"list-disc pl-5 space-y-2",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Use `-l` for math library:"})," Loads standard functions (sine, cosine, arctangent, natural log, exponential)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Set scale for decimal precision:"})," ",e.jsx("code",{className:"text-sm",children:"scale=10; 22/7"})," gives 10 decimal digits."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Use here-documents for multi-line scripts:"})," ",e.jsx("code",{className:"text-sm",children:"bc << EOF ... EOF"})]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Change input/output base:"})," ",e.jsx("code",{className:"text-sm",children:"obase=16; ibase=10; 255"})," → FF."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Define custom functions:"})," ",e.jsx("code",{className:"text-sm",children:"define f(x) { return x^2; }"})]})]})]})]})]})}),e.jsxs("section",{className:"max-w-6xl mx-auto px-4 py-8 animate-fade-slide-up",style:{animationDelay:"0.3s"},children:[e.jsx("h2",{className:"text-2xl font-bold mb-6 text-center",children:"🔄 How `bc` Processes Expressions"}),e.jsx("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md",children:e.jsxs("svg",{viewBox:"0 0 900 300",xmlns:"http://www.w3.org/2000/svg",className:"w-full h-auto",children:[e.jsx("rect",{x:"20",y:"30",width:"180",height:"80",rx:"8",fill:"#3b82f6",fillOpacity:"0.1",stroke:"#3b82f6",strokeWidth:"2",className:"svg-step-hover"}),e.jsx("text",{x:"110",y:"55",textAnchor:"middle",fill:"currentColor",fontSize:"14",fontWeight:"bold",children:"1. User input"}),e.jsx("text",{x:"110",y:"75",textAnchor:"middle",fill:"currentColor",fontSize:"12",children:'echo "10/3" | bc'}),e.jsx("line",{x1:"200",y1:"70",x2:"250",y2:"70",stroke:"#9ca3af",strokeWidth:"2",markerEnd:"url(#arrow4)"}),e.jsx("rect",{x:"260",y:"30",width:"180",height:"80",rx:"8",fill:"#10b981",fillOpacity:"0.1",stroke:"#10b981",strokeWidth:"2",className:"svg-step-hover"}),e.jsx("text",{x:"350",y:"55",textAnchor:"middle",fill:"currentColor",fontSize:"14",fontWeight:"bold",children:"2. Parse & tokenize"}),e.jsx("text",{x:"350",y:"75",textAnchor:"middle",fill:"currentColor",fontSize:"12",children:"variable, number, operator"}),e.jsx("line",{x1:"440",y1:"70",x2:"490",y2:"70",stroke:"#9ca3af",strokeWidth:"2",markerEnd:"url(#arrow4)"}),e.jsx("rect",{x:"500",y:"30",width:"180",height:"80",rx:"8",fill:"#f59e0b",fillOpacity:"0.1",stroke:"#f59e0b",strokeWidth:"2",className:"svg-step-hover"}),e.jsx("text",{x:"590",y:"55",textAnchor:"middle",fill:"currentColor",fontSize:"14",fontWeight:"bold",children:"3. Evaluate"}),e.jsx("text",{x:"590",y:"75",textAnchor:"middle",fill:"currentColor",fontSize:"12",children:"arbitrary-precision arithmetic"}),e.jsx("line",{x1:"680",y1:"70",x2:"730",y2:"70",stroke:"#9ca3af",strokeWidth:"2",markerEnd:"url(#arrow4)"}),e.jsx("rect",{x:"740",y:"30",width:"140",height:"80",rx:"8",fill:"#8b5cf6",fillOpacity:"0.1",stroke:"#8b5cf6",strokeWidth:"2",className:"svg-step-hover"}),e.jsx("text",{x:"810",y:"55",textAnchor:"middle",fill:"currentColor",fontSize:"14",fontWeight:"bold",children:"4. Output"}),e.jsx("text",{x:"810",y:"75",textAnchor:"middle",fill:"currentColor",fontSize:"12",children:"3.333333..."}),e.jsx("defs",{children:e.jsx("marker",{id:"arrow4",markerWidth:"10",markerHeight:"7",refX:"9",refY:"3.5",orient:"auto",children:e.jsx("polygon",{points:"0 0, 10 3.5, 0 7",fill:"#9ca3af"})})}),e.jsx("text",{x:"450",y:"200",textAnchor:"middle",fill:"#6b7280",fontSize:"12",fontStyle:"italic",children:"Input → parsing → arbitrary evaluation → formatted result"}),e.jsx("circle",{cx:"810",cy:"180",r:"15",fill:"#ef4444",fillOpacity:"0.3",children:e.jsx("animate",{attributeName:"r",values:"15;18;15",dur:"2s",repeatCount:"indefinite"})}),e.jsx("text",{x:"810",y:"184",textAnchor:"middle",fill:"currentColor",fontSize:"10",children:"Result"})]})})]}),e.jsxs("section",{className:"max-w-6xl mx-auto px-4 py-8 space-y-6 animate-fade-slide-up",style:{animationDelay:"0.4s"},children:[e.jsx("h2",{className:"text-2xl font-bold",children:"📁 Practical Shell Scripts"}),e.jsxs("div",{className:"grid gap-6",children:[e.jsx(r,{fileModule:f,title:"Basic Arithmetic",highlightLines:[4,10]}),e.jsx(r,{fileModule:y,title:"Variables & Scale",highlightLines:[6,14]}),e.jsx(r,{fileModule:v,title:"Math Library & Base Conversion",highlightLines:[8,16]}),e.jsx(r,{fileModule:w,title:"Scripting with bc",highlightLines:[12,20]})]})]}),e.jsxs("section",{className:"max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-8 animate-fade-slide-up",style:{animationDelay:"0.5s"},children:[e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md card-hover",children:[e.jsx("h2",{className:"text-xl font-bold text-red-500 dark:text-red-400 mb-4",children:"⚠️ Common Pitfalls"}),e.jsxs("ul",{className:"list-disc pl-5 space-y-2",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Forgetting to set scale:"})," `bc` defaults to scale=0 (integer division). 5/2 = 2, not 2.5."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Confusing `ibase` and `obase` order:"})," Set `obase` before `ibase` if they differ, because `ibase` affects how `obase` is read."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Using `^` for exponentiation:"})," `bc` uses `^` (power), not `**`. However, in POSIX, `^` is used; GNU bc supports both."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Not quoting expressions with asterisks:"}),' `*` may be expanded by shell; use quotes or escape: `"3 * 4"`.']}),e.jsxs("li",{children:[e.jsx("strong",{children:"Assuming `bc -l` loads everything:"})," It loads standard math functions but still uses scale=20; you may need to set scale separately."]})]})]}),e.jsxs("div",{className:"bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md card-hover",children:[e.jsx("h2",{className:"text-xl font-bold text-green-500 dark:text-green-400 mb-4",children:"✅ Best Practices"}),e.jsxs("ul",{className:"list-disc pl-5 space-y-2",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Always set scale for decimal results:"})," ",e.jsx("code",{className:"text-sm",children:"scale=10"})," before division."]}),e.jsx("li",{children:e.jsx("strong",{children:"Use `bc << EOF ... EOF` for multi-line calculations."})}),e.jsxs("li",{children:[e.jsx("strong",{children:"Combine with `printf` for formatting:"})," ",e.jsx("code",{className:"text-sm",children:'printf "%.2f\\n" $(bc <<< "scale=2; 10/3")'})]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Store results in variables:"})," ",e.jsx("code",{className:"text-sm",children:'result=$(bc <<< "10 * 3.14")'})]}),e.jsx("li",{children:e.jsx("strong",{children:"For production scripts, validate inputs to avoid injection."})})]})]})]}),e.jsxs("section",{className:"max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-8 animate-fade-slide-up",style:{animationDelay:"0.6s"},children:[e.jsxs("div",{className:"bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-8 border-blue-400",children:[e.jsx("h2",{className:"text-xl font-bold text-blue-700 dark:text-blue-300 mb-3",children:"💭 Think About..."}),e.jsxs("ul",{className:"list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300",children:[e.jsx("li",{children:"What happens if you set `scale=0` and compute 5/2? Why is that useful in some cases?"}),e.jsx("li",{children:"How would you calculate the square root of 2 to 50 decimal places?"}),e.jsx("li",{children:"Why does `bc` treat numbers starting with 0 as octal by default? How to force decimal?"})]})]}),e.jsxs("div",{className:"bg-green-50 dark:bg-green-900/20 rounded-xl p-6 border-l-8 border-green-400",children:[e.jsx("h2",{className:"text-xl font-bold text-green-700 dark:text-green-300 mb-3",children:"📋 Student Mini Checklist"}),e.jsxs("ul",{className:"list-check space-y-2",children:[e.jsx("li",{children:'✅ Can perform basic arithmetic with `echo "2+2" | bc`.'}),e.jsx("li",{children:"✅ Can set decimal precision using `scale`."}),e.jsx("li",{children:"✅ Can use `bc -l` for advanced math (sqrt, sin, cos, log)."}),e.jsx("li",{children:"✅ Can convert between number bases (hex ↔ decimal)."}),e.jsx("li",{children:"✅ Can write simple bc scripts with variables and conditionals."})]})]})]}),e.jsx("section",{className:"max-w-6xl mx-auto px-4 py-8 animate-fade-slide-up",style:{animationDelay:"0.7s"},children:e.jsx(p,{title:"Frequently Asked Questions about bc Command",questions:g})}),e.jsx("section",{className:"max-w-6xl mx-auto px-4 py-8 animate-fade-slide-up",style:{animationDelay:"0.8s"},children:e.jsxs("div",{className:"bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-6 border-l-8 border-indigo-500 teacher-note-hover transition-all",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("div",{className:"w-12 h-12 bg-indigo-100 dark:bg-indigo-800 rounded-full flex items-center justify-center text-xl",children:"👨‍🏫"}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-xl font-bold text-indigo-800 dark:text-indigo-300",children:"Teacher's Note"}),e.jsxs("p",{className:"text-sm text-gray-600 dark:text-gray-400",children:["Sukanta Hui • ",d," years experience (since 1998)"]})]})]}),e.jsxs("div",{className:"space-y-3 text-gray-700 dark:text-gray-300",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"✉️ Email:"})," sukantahui@codernaccotax.co.in | ",e.jsx("strong",{children:"📞 Mobile:"})," 7003756860"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"💻 Expertise:"})," Programming Language, RDBMs, Operating System, Web Development"]}),e.jsx("hr",{className:"my-3 border-gray-300 dark:border-gray-700"}),e.jsxs("p",{children:[e.jsx("strong",{children:"🎓 Classroom Tip:"})," When teaching `bc`, start with a calculator comparison: shell `$((5/2))` gives 2, but `bc` with scale gives 2.5. This immediately highlights why `bc` is needed for real-world math. Then demonstrate calculating compound interest or EMI — students appreciate the financial application."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"⚠️ Remember:"})," `bc` is not just a calculator; it's a programming language. Students can write loops and functions. Introduce them to `for (i=1; i &gt =10; i++)` to generate tables."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"🚀 Pro Challenge:"})," Write a bc script that computes the factorial of a number (n!). Use a loop and recursion. Then compute e^x using Taylor series. This shows bc's power for numerical methods."]})]})]})})]})};export{S as default};
