import{r as c,j as t}from"./index-Da242x_v.js";import{P as v}from"./PrintButton-zunPOdda.js";import{J as u}from"./JavaCodeBlock-Dra3Hw0G.js";import{P as j}from"./prism-zhFG2M2I.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
