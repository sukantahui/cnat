import{j as e,a as s}from"./index-D0w4062P.js";function i(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"String Concatenation & f-Strings in Python"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Python provides multiple ways to build strings. The most common and powerful method is using ",e.jsx("strong",{children:"f-strings"}),", introduced in Python 3.6."]}),e.jsxs("section",{className:"space-y-3",children:[e.jsxs("h2",{className:"text-xl font-semibold text-slate-200",children:["1. String Concatenation using ",e.jsx("code",{children:"+"})]}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["You can add (concatenate) two strings using the ",e.jsx("code",{children:"+"})," operator."]}),e.jsx(s,{initialCode:`first = "Coder"
second = "AccoTax"
result = first + " & " + second
