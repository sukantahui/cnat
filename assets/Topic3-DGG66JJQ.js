...
batch.teacher.call(); // this refers to teacher object`,language:"javascript"}),e.jsxs("p",{className:"text-slate-400 text-sm",children:["Understanding ",e.jsx("code",{children:"this"})," is essential before working with constructors and ES6 classes."]})]})}export{o as default};
