...
}`})]}),e.jsxs("div",{className:`${t} mb-8 ${s} animation-delay-[720ms]`,children:[e.jsxs("h2",{className:"flex items-center gap-2",children:[e.jsx(r,{size:18})," Hint"]}),e.jsx("p",{children:"Observe carefully how conditions must be written in descending order. Try changing the order and see the wrong result."})]}),e.jsxs("div",{className:`${t} mb-8 ${s} animation-delay-[840ms]`,children:[e.jsxs("h2",{className:"flex items-center gap-2",children:[e.jsx(n,{size:18})," Common Pitfalls"]}),e.jsxs("ul",{className:"list-disc pl-5",children:[e.jsx("li",{children:"Placing smaller conditions before larger ones."}),e.jsx("li",{children:"Forgetting final else block."}),e.jsx("li",{children:"Overlapping ranges."})]})]}),e.jsxs("div",{className:`${t} mb-8 ${s} animation-delay-[960ms]`,children:[e.jsxs("h2",{className:"flex items-center gap-2",children:[e.jsx(i,{size:18})," Mini Checklist"]}),e.jsxs("ul",{className:"list-disc pl-5",children:[e.jsx("li",{children:"Conditions ordered properly"}),e.jsx("li",{children:"No overlapping ranges"}),e.jsx("li",{children:"Default else present"})]})]}),e.jsxs("div",{className:`${t} border-l-4 border-sky-400 ${s} animation-delay-[1080ms]`,children:[e.jsx("h2",{className:"font-medium mb-1",children:"Teacher’s Note"}),e.jsx("p",{children:"else-if ladder must be practiced using grading, temperature, attendance — not just numbers — that is how logic matures."})]})]})}}export{f as default};
