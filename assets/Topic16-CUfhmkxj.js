...
public class SecondLargestBasic {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("\\nWith duplicates: " + "[");\r
        for (int i = 0; i < duplicates.length; i++) {\r
            System.out.print(duplicates[i] + (i < duplicates.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class SecondLargestWithDuplicates {\r
    ...
    public static void main(String[] args) {\r
        ...
        for (int i = 0; i < test.length; i++) {\r
            System.out.print(test[i] + (i < test.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
            try {\r
...
public class SecondLargestSinglePass {\r
    ...
    public static int[] findTopK(int[] arr, int k) {\r
        ...
        \r
        int[] top = new int[k];\r
        ManualLoopArrayUtility.fill(top, Integer.MIN_VALUE);\r
        \r
        for (int num : arr) {\r
            for (int i = 0; i < k; i++) {\r
                if (num > top[i]) {\r
    ...
    public static void main(String[] args) {\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Top 5 scores: " + "[");\r
        for (int i = 0; i < top5.length; i++) {\r
            System.out.print(top5[i] + (i < top5.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
    }\r
