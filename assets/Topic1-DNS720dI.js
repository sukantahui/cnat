...
1. MEMORY ALLOCATION RULES:\r
   - 'String s = "hello";'          → 1 object in SCP (or 0 if already present).\r
   - 'String s = new String("hello");' → 2 objects (1 in SCP + 1 in regular Heap).\r
