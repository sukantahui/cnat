...
1. RESTRICTION 7: NO OVERLOAD CLASHES:\r
   ...
   - 'method(List<String>)' and 'method(List<Integer>)' &rarr; both erase to 'method(List)'.\r
   - Triggers compiler 'name clash' error.\r
   - Solution: Use distinct method names.\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,o=[{question:"Why does declaring 'public void print(List<String> l)' and 'public void print(List<Integer> l)' in the same class trigger a compilation error?",shortAnswer:"Because type erasure strips the generic parameters '<String>' and '<Integer>', causing both methods to erase to the exact same bytecode signature: 'public void print(java.util.List)'. In the JVM classfile specification, having two methods with the identical name and parameter descriptors within the same class is illegal.",explanation:"Standard compiler name clash diagnostic under type erasure.",hint:"Both signatures erase to 'print(List)', producing a method name/parameter clash in bytecode.",level:"Intermediate",codeExample:"// void process(List<String> a) and void process(List<Integer> b) -> Compile error: name clash"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 006_005 · Topic 12"}),e.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full",children:"Restriction 7"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Restriction 7: Cannot Overload Methods That Erase to Identical Raw Signatures"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Diagnose compiler name clashes: understanding why methods with parameters erasing to identical raw descriptors cannot be overloaded in the same class."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"Restriction7NoOverloadClashDemo.java",highlightLines:[7,10,14,15,22,23]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{title:"Overload Clashes FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:a,title:"Module 006_005 Topic 12: Restriction 7 - No Overload Clashes",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"006_005_topic12_restriction7_no_overload_clashes_note.txt"})}),e.jsx(s,{note:"If you try to write 'void save(List<Student> s)' and 'void save(List<Course> c)', the compiler will complain about a 'name clash'! That's because both erase to 'void save(List)' in bytecode! Give them different names! — Sukanta Hui"})]})}export{x as default};
