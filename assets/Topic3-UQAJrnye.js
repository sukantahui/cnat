import{b as a,j as e,bm as n}from"./vendor-react-core-BBXbtqt1.js";import{F as f}from"./FAQTemplate-BamsZuNW.js";import{T as v}from"./TeacherSukantaHui-VMH_OtYp.js";import{J as l}from"./JavaFileLoader-CVw5Mqo9.js";import"./vendor-icons-IjXdH6hS.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";const j=`// BasicEntity.java\r
...
public Optional<String> getMiddleName() { return Optional.ofNullable(middleName); }`}],G=()=>{const[t,g]=a.useState({intro:!1,annotations:!1,columnMapping:!1,idGen:!1,embedded:!1,temporal:!1,checklist:!1}),x=(r,i)=>{r.forEach(o=>{o.isIntersecting&&g(d=>({...d,[i]:!0}))})},s=(r,i)=>{if(!r.current)return;const o=new IntersectionObserver(d=>x(d,i),{threshold:.2,rootMargin:"0px 0px -50px 0px"});return o.observe(r.current),o},c=a.useRef(null),m=a.useRef(null),p=a.useRef(null),u=a.useRef(null),h=a.useRef(null),y=a.useRef(null),b=a.useRef(null);return a.useEffect(()=>{const r=[s(c,"intro"),s(m,"annotations"),s(p,"columnMapping"),s(u,"idGen"),s(h,"embedded"),s(y,"temporal"),s(b,"checklist")];return()=>r.forEach(i=>i&&i.disconnect())},[]),e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-100 font-sans leading-relaxed",children:[e.jsx("style",{children:`
