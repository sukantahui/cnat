import{r as a,j as e}from"./index-YkKVfVEM.js";import{J as t}from"./JavaFileLoader-CHMkEsF2.js";import{T as n}from"./TeacherSukantaHui-nIRku_xY.js";import{F as s}from"./FAQTemplate-B_PeLoo7.js";import"./JavaCodeBlock-DN0rWtg8.js";import"./prism-BIjtOw9A.js";import"./browser-zdk-CdZa.js";import"./prism-java-BwO6k4I_.js";import"./github-00a_zZrb.js";import"./createLucideIcon-Cim-rzMd.js";import"./git-branch-BC_-h9tN.js";import"./clsx-B-dksMZM.js";const r=[{question:"What is abstraction in object-oriented programming?",shortAnswer:"Abstraction hides implementation details and shows only essential features.",explanation:"It's a fundamental OOP concept that reduces complexity by focusing on 'what' an object does rather than 'how' it does it. Achieved via abstract classes and interfaces.",hint:"Think of a TV remote - you press buttons without knowing the internal circuits.",level:"basic",codeExample:"abstract class Vehicle { abstract void start(); }"},{question:"How is abstraction different from encapsulation?",shortAnswer:"Abstraction hides complexity (design level), encapsulation hides data (implementation level).",explanation:"Abstraction provides a simplified interface to a complex system. Encapsulation bundles data and methods together and restricts direct access to some components.",hint:"Abstraction = 'what you see', Encapsulation = 'how you protect'.",level:"intermediate",codeExample:`// Abstraction: interface Vehicle { void move(); }
...
}`,k=()=>{const[c,d]=a.useState(!1);return e.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 py-12 px-4 sm:px-6 lg:px-8",children:[e.jsx("style",{children:`
