import{j as e,E as s}from"./index-Dph6J_oz.js";function a(){return e.jsxs("div",{className:"space-y-10",children:[e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-sky-300",children:["The ",e.jsx("span",{className:"text-sky-400",children:"Ternary Operator"})]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["The ",e.jsx("strong",{children:"ternary operator"})," is a short, compact alternative to",e.jsx("code",{className:"text-sky-300",children:" if / else "}),". It evaluates a condition and returns one of two values depending on whether the condition is",e.jsx("span",{className:"text-emerald-400 font-semibold",children:" true"})," or",e.jsx("span",{className:"text-rose-400 font-semibold",children:" false"}),"."]}),e.jsx(s,{language:"javascript",initialCode:`let age = 20;
