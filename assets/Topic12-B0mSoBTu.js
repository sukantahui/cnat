import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as n}from"./JavaFileLoader-CVw5Mqo9.js";import{F as a}from"./FAQTemplate-BamsZuNW.js";import{P as t}from"./PlainTextPrint-CGJ_aUDk.js";import{T as r}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const s=`/**\r
...
================================================================================\r
`,i=[{question:"What are the three standard ANSI SQL read anomalies that can occur in concurrent database transactions?",shortAnswer:"1. Dirty Read, 2. Non-Repeatable Read (Fuzzy Read), and 3. Phantom Read.",explanation:"Standard benchmark classifications for transaction isolation.",hint:"Dirty Read, Non-Repeatable Read, Phantom Read.",level:"Beginner",codeExample:"3 Anomalies: Dirty Read, Non-Repeatable Read, Phantom Read."},{question:"Which isolation level is the minimum required to prevent Dirty Reads?",shortAnswer:"TRANSACTION_READ_COMMITTED (Connection.TRANSACTION_READ_COMMITTED).",explanation:"Ensures transactions only read committed data.",hint:"READ_COMMITTED.",level:"Beginner",codeExample:"conn.setTransactionIsolation(Connection.TRANSACTION_READ_COMMITTED);"}];function A(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 011_004 · Topic 12"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Transactions & ACID"})]}),e.jsxs("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:["Concurrency Phenomena: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"Multi-User Database Anomalies"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"When concurrent transactions collide: analyzing the 3 classic ANSI SQL concurrency read phenomena — Dirty Read, Non-Repeatable Read, and Phantom Read."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:s,title:"ConcurrencyPhenomenaOverviewDemo.java",highlightLines:[18,25,34,43]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Transaction & ACID FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{content:o,title:"Module 011_004 Topic 12: Concurrency Phenomena Overview",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"011_004_topic12_concurrency_phenomena_overview_note.txt"})}),e.jsx(r,{note:"When multiple users hit the database at the exact same millisecond, 3 strange bugs can happen: Dirty Reads, Non-Repeatable Reads, and Phantom Reads! Isolation levels exist specifically to prevent these 3 anomalies! — Sukanta Hui"})]})}export{A as default};
