...
`:"")+`
**About ${e.name}:**
${f}`}if(o){let e=`### 👨‍🏫 Faculty & Mentors at Coder & AccoTax

`;return j.forEach(r=>{const p=r.dco||r.doc,h=p?Math.max(0,new Date().getFullYear()-parseInt(p,10)):null,l=h!==null?` • ${h}+ Yrs Exp`:"";e+=`- **${r.name}** (*${r.title}${l}*)
  - Email: **${r.email}** ${r.github?`| GitHub: [${r.github}](https://github.com/${r.github})`:""}
`}),e+=`
...
${E()}`:P();if(e.includes("course")||e.includes("courses")||e.includes("curriculum")||e.includes("syllabus")||e.includes("programs")||e.includes("what do you teach")||e.includes("what courses")||e.includes("all courses")||e.includes("courses offered")||e.includes("training tracks")||e.includes("degrees")||e.includes("diploma")||e.includes("certification")||e.includes("certifications"))return E();if(e.includes("helpline")||e.includes("whatsapp number")||e.includes("phone number")||e.includes("mobile number")||e.includes("call")||e.includes("contact number"))return F();let h=null,l=0;for(const f of le){let g=0;for(const C of f.keywords)e===C?g+=15:e.includes(C)&&(g+=C.length>4?6:3);g>l&&(l=g,h=f)}if(h&&l>=5)return h.generate(t);if(e.includes("explain")||e.includes("summary")||e.includes("what is this")||e.includes("help")||e.includes("how to")||e.includes("concept")||e.includes("example")||e.includes("tutorial")||e.includes("notes"))return`### 💡 Mentor Guide for: ${r}

Dear student, here is the structured conceptual breakdown for **"${r}"**:
...
*Need practice questions?* Check the interactive Practice Questions and Quiz engine integrated at the bottom of this topic page!`;const d=ie(i,t);return d||`### 🎓 CNAT Mam Academic Assistance

Dear student, you asked: **"${o}"** regarding **${r}**.

Here is my mentorship guidance:

- **Key Focus Area:** When studying **${r}** in our **${p.toUpperCase()}** curriculum, always make sure you understand the underlying computational or arithmetic mechanism before writing code or formulas.
...
*You can also click any of the quick prompt chips below to explore specific formulas, code patterns, teacher details, or course roadmaps!*`}function pe({topicTitle:i="Study Topic",moduleSlug:t="",subjectKey:o="excel"}){const[e,r]=x.useState(!1),[p,h]=x.useState(!1),[l,d]=x.useState(""),[f,g]=x.useState(!1),[C,w]=x.useState(!1),[S,k]=x.useState(null),[I,M]=x.useState(null),R=oe(o),[O,D]=x.useState([{sender:"bot",text:`Hello dear student! I am **CNAT Mam**, your senior AI academic mentor at **Coder & AccoTax**.

I can guide you through **"${i}"**, explain formulas and code, provide our **campus address**, **teachers & mentors details**, or **course syllabi & admissions**. How can I help you today?`,time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}]),L=x.useRef(null),B=()=>{L.current?.scrollIntoView({behavior:"smooth"})};x.useEffect(()=>{e&&B()},[O,e,f]);const q=(s,c)=>{if(typeof window>"u"||!("speechSynthesis"in window))return;if(C&&S===c){window.speechSynthesis.cancel(),w(!1),k(null);return}window.speechSynthesis.cancel();const n=s.replace(/[*#`_~[\]()>-]/g," ").replace(/\|/g," ").replace(/\s+/g," ").trim(),u=new SpeechSynthesisUtterance(n);u.rate=1,u.pitch=1.05;const v=window.speechSynthesis.getVoices(),b=v.find(y=>y.lang.includes("en")&&(y.name.includes("Female")||y.name.includes("Google")||y.name.includes("Samantha")||y.name.includes("Zira")))||v.find(y=>y.lang.includes("en"));b&&(u.voice=b),u.onend=()=>{w(!1),k(null)},u.onerror=()=>{w(!1),k(null)},w(!0),k(c),window.speechSynthesis.speak(u)};x.useEffect(()=>{!e&&typeof window<"u"&&"speechSynthesis"in window&&(window.speechSynthesis.cancel(),w(!1),k(null))},[e]);const T=s=>{const c=s||l;if(!c.trim())return;const n=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),u={sender:"user",text:c,time:n};D(v=>[...v,u]),s||d(""),g(!0),setTimeout(()=>{const v=ce(c,{topicTitle:i,moduleSlug:t,subjectKey:o}),b=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});D(y=>[...y,{sender:"bot",text:v,time:b}]),g(!1)},450)},$=(s,c)=>{navigator.clipboard.writeText(s),M(c),setTimeout(()=>M(null),1500)},W=()=>{typeof window<"u"&&"speechSynthesis"in window&&(window.speechSynthesis.cancel(),w(!1),k(null)),D([{sender:"bot",text:`Chat reset! I am ready for your next question regarding **"${i}"**, institute address, teachers details, or courses.`,time:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}])};return a.jsxs("div",{className:"fixed bottom-5 right-5 z-50 font-sans selection:bg-sky-500/30 selection:text-sky-200",children:[!e&&a.jsxs("button",{onClick:()=>r(!0),className:"group relative flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-indigo-600 via-sky-600 to-teal-600 text-white font-bold text-sm shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 border border-sky-400/30 shadow-sky-950/60 cursor-pointer",children:[a.jsxs("span",{className:"relative flex h-3 w-3",children:[a.jsx("span",{className:"animate-ping absolute inline-flex h-full w-full rounded-full bg-teal-400 opacity-75"}),a.jsx("span",{className:"relative inline-flex rounded-full h-3 w-3 bg-teal-300"})]}),a.jsxs("div",{className:"flex items-center gap-2.5",children:[a.jsx("div",{className:"w-7 h-7 rounded-full overflow-hidden border border-sky-300/40 p-0.5 shadow-sm bg-slate-900",children:a.jsx("img",{src:"/teachers/cnat_mam.jpg",alt:"CNAT Mam",className:"w-full h-full rounded-full object-cover",onError:s=>{s.target.style.display="none"}})}),a.jsx("span",{children:"Ask CNAT Mam"})]}),a.jsx("span",{className:"px-2 py-0.5 rounded-md bg-white/20 text-[10px] uppercase font-extrabold tracking-wider text-teal-100",children:"AI Mentor"})]}),e&&a.jsxs("div",{className:`${p?"w-[94vw] sm:w-[680px] h-[720px]":"w-[92vw] sm:w-[440px] h-[600px]"} max-h-[88vh] rounded-3xl bg-slate-950/95 border border-slate-800 shadow-2xl backdrop-blur-xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-bottom-5 duration-300 border-sky-500/30 transition-all`,children:[a.jsxs("div",{className:"px-4 py-3.5 bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 border-b border-slate-800 flex items-center justify-between",children:[a.jsxs("div",{className:"flex items-center gap-3",children:[a.jsxs("div",{className:"relative",children:[a.jsx("div",{className:"w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 via-sky-400 to-teal-400 p-0.5 shadow-md overflow-hidden",children:a.jsx("img",{src:"/teachers/cnat_mam.jpg",alt:"CNAT Mam Profile",className:"w-full h-full rounded-full object-cover",onError:s=>{s.target.style.display="none"}})}),a.jsx("span",{className:"absolute bottom-0 right-0 w-3 h-3 rounded-full bg-emerald-500 border-2 border-slate-900"})]}),a.jsxs("div",{children:[a.jsxs("div",{className:"flex items-center gap-2",children:[a.jsx("h3",{className:"font-extrabold text-white text-sm tracking-wide",children:"CNAT Mam"}),a.jsxs("span",{className:"px-1.5 py-0.5 rounded bg-sky-950 border border-sky-700 text-sky-300 text-[10px] font-mono font-semibold",children:[o.toUpperCase()," Mentor"]})]}),a.jsx("p",{className:"text-[11px] text-slate-400 truncate max-w-[240px]",children:i})]})]}),a.jsxs("div",{className:"flex items-center gap-1 text-slate-400",children:[a.jsx("button",{onClick:()=>h(s=>!s),title:p?"Compact View":"Expand View",className:"p-1.5 rounded-lg hover:bg-slate-800 hover:text-white transition cursor-pointer",children:p?a.jsx(U,{size:15}):a.jsx(H,{size:15})}),a.jsx("button",{onClick:W,title:"Reset Conversation",className:"p-1.5 rounded-lg hover:bg-slate-800 hover:text-white transition cursor-pointer",children:a.jsx(G,{size:15})}),a.jsx("button",{onClick:()=>r(!1),title:"Close Chat",className:"p-1.5 rounded-lg hover:bg-slate-800 hover:text-white transition cursor-pointer",children:a.jsx(z,{size:18})})]})]}),a.jsxs("div",{className:"px-3 py-1.5 bg-slate-900/95 border-b border-slate-800/80 flex items-center justify-between text-[11px] text-slate-300",children:[a.jsxs("div",{className:"flex items-center gap-2",children:[a.jsxs("button",{onClick:()=>T("What is the official address and campus location of Coder & AccoTax?"),className:"flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-800 hover:bg-sky-950 border border-slate-700 hover:border-sky-600 text-sky-300 hover:text-sky-100 transition cursor-pointer",title:"View Campus Address",children:[a.jsx(V,{size:11,className:"text-sky-400"}),a.jsx("span",{children:"Address"})]}),a.jsxs("button",{onClick:()=>T("Who are the teachers and faculty members at Coder & AccoTax?"),className:"flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-800 hover:bg-indigo-950 border border-slate-700 hover:border-indigo-600 text-indigo-300 hover:text-indigo-100 transition cursor-pointer",title:"View Faculty Profiles",children:[a.jsx(Q,{size:11,className:"text-indigo-400"}),a.jsx("span",{children:"Teachers"})]}),a.jsxs("button",{onClick:()=>T("What are all the courses offered at Coder & AccoTax?"),className:"flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-800 hover:bg-emerald-950 border border-slate-700 hover:border-emerald-600 text-emerald-300 hover:text-emerald-100 transition cursor-pointer",title:"View Courses Catalog",children:[a.jsx(J,{size:11,className:"text-emerald-400"}),a.jsx("span",{children:"Courses"})]})]}),a.jsx("span",{className:"text-[10px] text-slate-400 hidden sm:inline",children:"Coder & AccoTax"})]}),a.jsxs("div",{className:"flex-1 overflow-y-auto p-4 space-y-4 text-xs sm:text-sm custom-scrollbar bg-slate-950/40",children:[O.map((s,c)=>a.jsxs("div",{className:`flex gap-2.5 ${s.sender==="user"?"justify-end":"justify-start"}`,children:[s.sender==="bot"&&a.jsx("img",{src:"/teachers/cnat_mam.jpg",alt:"CNAT Mam",className:"w-7 h-7 rounded-full object-cover border border-sky-600/60 shrink-0 mt-0.5 shadow-sm",onError:n=>{n.target.style.display="none"}}),a.jsxs("div",{className:`relative max-w-[88%] rounded-2xl px-4 py-3 shadow-md text-xs sm:text-sm leading-relaxed ${s.sender==="user"?"bg-gradient-to-r from-sky-600 to-indigo-600 text-white rounded-br-none":"bg-slate-900 border border-slate-800 text-slate-200 rounded-bl-none"}`,children:[a.jsx("div",{className:"whitespace-pre-wrap font-sans space-y-2",children:s.text.split(`
`).map((n,u)=>{if(n.trim()==="---")return a.jsx("hr",{className:"my-2 border-slate-800"},u);if(n.startsWith("### "))return a.jsx("h4",{className:"font-bold text-sky-300 text-sm mt-2 mb-1",children:n.replace("### ","")},u);if(n.startsWith("#### "))return a.jsx("h5",{className:"font-semibold text-teal-300 text-xs mt-1.5 mb-0.5",children:n.replace("#### ","")},u);if(n.startsWith("> "))return a.jsx("div",{className:"my-1.5 p-3 rounded-xl bg-slate-950 border-l-4 border-sky-500 text-slate-200 font-sans text-xs",children:A(n.replace(/^>\s*/,""))},u);if(n.startsWith("`=")||n.startsWith("`")||n.startsWith("```")){const b=n.replace(/```[a-z]*|```/g,"").replace(/`/g,"");return b.trim()?a.jsx("div",{className:"my-1.5 p-2 rounded-xl bg-slate-950 border border-slate-800 font-mono text-sky-300 text-xs overflow-x-auto",children:b},u):null}if(n.trim().startsWith("- ")||n.trim().startsWith("* ")){const b=n.trim().slice(2);return a.jsxs("div",{className:"flex items-start gap-1.5 pl-1",children:[a.jsx("span",{className:"text-sky-400 mt-0.5",children:"•"}),a.jsx("span",{children:A(b)})]},u)}const v=n.trim().match(/^(\d+)\.\s+(.*)$/);if(v)return a.jsxs("div",{className:"flex items-start gap-1.5 pl-1",children:[a.jsxs("span",{className:"font-bold text-amber-400 mt-0.5 text-xs",children:[v[1],"."]}),a.jsx("span",{children:A(v[2])})]},u);if(n.trim().startsWith("|")&&n.trim().endsWith("|")){if(n.includes(":---")||n.includes("---"))return null;const b=n.split("|").filter(y=>y.trim()!=="");return a.jsx("div",{className:"my-1 flex gap-2 overflow-x-auto text-[11px] bg-slate-950/60 p-1.5 rounded-lg border border-slate-800",children:b.map((y,_)=>a.jsx("div",{className:"flex-1 font-mono text-slate-300",children:A(y.trim())},_))},u)}return a.jsx("p",{children:A(n)},u)})}),a.jsxs("div",{className:"mt-2.5 pt-1.5 border-t border-slate-800/60 flex items-center justify-between text-[10px] text-slate-400",children:[a.jsx("span",{children:s.time}),s.sender==="bot"&&a.jsxs("div",{className:"flex items-center gap-2",children:[a.jsxs("button",{onClick:()=>q(s.text,c),className:`hover:text-sky-300 transition flex items-center gap-1 cursor-pointer ${C&&S===c?"text-amber-400 animate-pulse font-bold":""}`,title:"Read Aloud",children:[C&&S===c?a.jsx(K,{size:13}):a.jsx(X,{size:13}),a.jsx("span",{children:C&&S===c?"Stop":"Listen"})]}),a.jsxs("button",{onClick:()=>$(s.text,c),className:"hover:text-sky-300 transition flex items-center gap-1 cursor-pointer",title:"Copy Answer",children:[I===c?a.jsx(Y,{size:12,className:"text-emerald-400"}):a.jsx(Z,{size:12}),a.jsx("span",{children:I===c?"Copied":"Copy"})]})]})]})]}),s.sender==="user"&&a.jsx("div",{className:"w-7 h-7 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-300 shrink-0 mt-0.5",children:a.jsx(ee,{size:14})})]},c)),f&&a.jsxs("div",{className:"flex items-center gap-2 text-slate-400 text-xs italic pl-9",children:[a.jsxs("span",{className:"flex gap-1",children:[a.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-sky-400 animate-ping"}),a.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-sky-400 animate-ping delay-100"}),a.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-sky-400 animate-ping delay-200"})]}),a.jsx("span",{children:"CNAT Mam is preparing your response..."})]}),a.jsx("div",{ref:L})]}),a.jsx("div",{className:"px-3 py-2 bg-slate-900/90 border-t border-slate-800/80 overflow-x-auto flex gap-1.5 no-scrollbar",children:R.map((s,c)=>a.jsx("button",{onClick:()=>T(s.query),className:"px-2.5 py-1 rounded-full bg-slate-800 hover:bg-sky-950 border border-slate-700 hover:border-sky-700 text-slate-300 hover:text-sky-200 text-[11px] font-medium whitespace-nowrap transition-all duration-200 shrink-0 cursor-pointer",children:s.label},c))}),a.jsxs("form",{onSubmit:s=>{s.preventDefault(),T()},className:"p-3 bg-slate-950 border-t border-slate-800 flex items-center gap-2",children:[a.jsx("input",{type:"text",value:l,onChange:s=>d(s.target.value),placeholder:`Ask about ${i}, address, teachers, courses...`,className:"flex-1 px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-100 placeholder:text-slate-500 text-xs sm:text-sm focus:outline-none focus:border-sky-500/60 focus:ring-1 focus:ring-sky-500/60 transition"}),a.jsx("button",{type:"submit",disabled:!l.trim(),className:"p-2.5 rounded-xl bg-gradient-to-r from-sky-600 to-indigo-600 hover:from-sky-500 hover:to-indigo-500 text-white disabled:opacity-40 disabled:cursor-not-allowed transition shadow-md shrink-0 cursor-pointer",title:"Send Question",children:a.jsx(ae,{size:16})})]})]})]})}function A(i){return i?i.split(/(\*\*.*?\*\*|`.*?`|\[.*?\]\(.*?\))/g).map((o,e)=>{if(o.startsWith("**")&&o.endsWith("**"))return a.jsx("strong",{className:"font-bold text-amber-300",children:o.slice(2,-2)},e);if(o.startsWith("`")&&o.endsWith("`"))return a.jsx("code",{className:"px-1.5 py-0.5 rounded bg-slate-950 border border-slate-800 font-mono text-sky-300 text-[11px]",children:o.slice(1,-1)},e);const r=o.match(/^\[(.*?)\]\((.*?)\)$/);return r?a.jsx("a",{href:r[2],target:"_blank",rel:"noopener noreferrer",className:"text-sky-400 font-semibold underline hover:text-sky-300 transition",children:r[1]},e):o}):null}export{pe as default};
