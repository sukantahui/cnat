const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Topic0-wWlNYZ6e.js","assets/index-BnfAr6UH.js","assets/index-Qct8G3J5.css","assets/network-Cm1-SIwb.js","assets/circle-alert-Ckfu1r8B.js","assets/server-CXWLwLDV.js","assets/Topic1-BIRZMOI4.js","assets/Topic2-Cd3WUd7h.js","assets/Topic3-DeJt9sCt.js","assets/Topic4-CGHwAPvi.js","assets/PracticeEngineAdvance-Blydtbs2.js","assets/CodeBlockGeneral-sEycNnBd.js","assets/prism-BWdUCJxD.js","assets/prism-json-D0UlpdKh.js","assets/Topic5-CeaidpKV.js","assets/index-Chjiymov.js","assets/Topic6-B5CKSaht.js","assets/Topic7-DNJml3-B.js","assets/CodeBlock-Q1dXla_L.js","assets/file-code-2-2TDWSW.js","assets/copy-Cqsw3qgy.js","assets/download-DLZRmf4V.js","assets/play-Ckwl6zud.js","assets/Topic0-XrRlHY2I.js","assets/Topic1-BN2ZEUoO.js"])))=>i.map(i=>d[i]);
import{u as Z,j as e,r as d,L as i,R as ee,A as j,e as H,B as te,p as y,q as se,C as q,X as re,_ as x}from"./index-BnfAr6UH.js";import{r as l}from"./general-roadmap-Bm9Nl7tM.js";const G=Object.assign({"./topics/general-practice-test-one/Topic0.jsx":()=>x(()=>import("./Topic0-wWlNYZ6e.js"),__vite__mapDeps([0,1,2,3,4,5])),"./topics/general-practice-test-one/Topic1.jsx":()=>x(()=>import("./Topic1-BIRZMOI4.js"),__vite__mapDeps([6,1,2])),"./topics/general-practice-test-one/Topic2.jsx":()=>x(()=>import("./Topic2-Cd3WUd7h.js"),__vite__mapDeps([7,1,2])),"./topics/general-practice-test-one/Topic3.jsx":()=>x(()=>import("./Topic3-DeJt9sCt.js"),__vite__mapDeps([8,1,2])),"./topics/general-practice-test-one/Topic4.jsx":()=>x(()=>import("./Topic4-CGHwAPvi.js"),__vite__mapDeps([9,1,2,10,11,12,13])),"./topics/general-practice-test-one/Topic5.jsx":()=>x(()=>import("./Topic5-CeaidpKV.js"),__vite__mapDeps([14,1,2,11,12,13,15])),"./topics/general-practice-test-one/Topic6.jsx":()=>x(()=>import("./Topic6-B5CKSaht.js"),__vite__mapDeps([16,1,2,10,11,12,13])),"./topics/general-practice-test-one/Topic7.jsx":()=>x(()=>import("./Topic7-DNJml3-B.js"),__vite__mapDeps([17,1,2,18,12,13,19,20,21,22])),"./topics/general-topics/Topic0.jsx":()=>x(()=>import("./Topic0-XrRlHY2I.js"),__vite__mapDeps([23,1,2])),"./topics/general-topics/Topic1.jsx":()=>x(()=>import("./Topic1-BN2ZEUoO.js"),__vite__mapDeps([24,1,2]))});function ne(){const{moduleSlug:a,topicIndex:m}=Z();return e.jsx(le,{moduleSlug:a,topicIndex:m},`${a}-${m}`)}function le({moduleSlug:a,topicIndex:m}){const n=Number.parseInt(m,10)||0,P=d.useRef(null),[Q,b]=d.useState(!1);let r=null,O=null;for(const s of l.segments){const t=s.modules.find(o=>o.slug===a);if(t){r=t,O=s;break}}if(!r)return e.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 p-10",children:[e.jsx("h1",{className:"text-2xl text-red-400 font-bold",children:"Module Not Found"}),e.jsx(i,{to:`/${l.folder}/roadmap`,className:"text-sky-400 underline mt-4 inline-block",children:"← Back to Roadmap"})]});const N=r.topics[n];if(!N)return e.jsxs("div",{className:"min-h-screen bg-slate-950 text-slate-100 p-10",children:[e.jsx("h1",{className:"text-2xl text-red-400 font-bold",children:"Topic Not Found"}),e.jsx(i,{to:`/${l.folder}/module/${a}`,className:"text-sky-400 underline mt-4 inline-block",children:"← Back to Module"})]});const v=`js-progress-${a}`,[C,S]=d.useState([]);d.useEffect(()=>{const s=localStorage.getItem(v)||"[]";let t=[];try{t=JSON.parse(s)}catch{t=[]}t.includes(n)||t.push(n),t.sort((o,c)=>o-c),localStorage.setItem(v,JSON.stringify(t)),S(t)},[n,v]);const h=r.topics.length,L=C.length,w=Math.round(L/h*100),B=n>0,A=n<h-1,D=()=>{localStorage.removeItem(v),S([])},I=`./topics/${a}/Topic${m}.jsx`,V=G[I]?ee.lazy(G[I]):null;d.useEffect(()=>{P.current&&P.current.scrollIntoView({behavior:"smooth",block:"center"})},[n]),d.useEffect(()=>{b(!1)},[a,m]);const[M,F]=d.useState(""),[p,J]=d.useState(()=>{try{return localStorage.getItem("student_name")||""}catch{return""}}),[k,K]=d.useState(!0),[W,E]=d.useState(!1),[Y,R]=d.useState(""),z=s=>s.map((t,o)=>`${o+1}. ${t}`).join(`
