import{r as s,j as e}from"./index-D8vKF2mq.js";import{c as n}from"./clsx-B-dksMZM.js";import{F as b}from"./FAQTemplate-vk816vUa.js";import{T as j}from"./TeacherSukantaHui-DjhHYUAb.js";import{J as r}from"./JavaFileLoader-WyjnB8lQ.js";import"./github-CLhUlPeX.js";import"./createLucideIcon-DTJ5VPt2.js";import"./git-branch-ivLG4H_K.js";import"./JavaCodeBlock-Cn8snDcq.js";import"./prism-DqVe0I4H.js";import"./browser-iABTCUld.js";import"./prism-java-BwO6k4I_.js";const E=`// LazyVsEagerEntity.java\r
...
private List<Course> courses;`},{question:"How can you initialize a lazy collection programmatically?",shortAnswer:"Call Hibernate.initialize(collection) or collection.size() within an open session.",explanation:"Hibernate.initialize(collection) forces loading. Also works for proxies.",hint:"Useful before closing session if you need the data.",level:"moderate",codeExample:"Hibernate.initialize(student.getCourses());"}],Y=()=>{const[t,g]=s.useState({intro:!1,concepts:!1,lazyDemo:!1,exception:!1,solutions:!1,comparison:!1,checklist:!1}),f=(i,o)=>{i.forEach(l=>{l.isIntersecting&&g(d=>({...d,[o]:!0}))})},a=(i,o)=>{if(!i.current)return;const l=new IntersectionObserver(d=>f(d,o),{threshold:.2,rootMargin:"0px 0px -50px 0px"});return l.observe(i.current),l},h=s.useRef(null),u=s.useRef(null),c=s.useRef(null),y=s.useRef(null),p=s.useRef(null),m=s.useRef(null),x=s.useRef(null);return s.useEffect(()=>{const i=[a(h,"intro"),a(u,"concepts"),a(c,"lazyDemo"),a(y,"exception"),a(p,"solutions"),a(m,"comparison"),a(x,"checklist")];return()=>i.forEach(o=>o&&o.disconnect())},[]),e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-100 font-sans leading-relaxed",children:[e.jsx("style",{children:`
