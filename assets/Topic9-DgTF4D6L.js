...
lead to incorrect results."`,q=()=>{const[c,p]=s.useState("concept"),[x,g]=s.useState({}),[m,f]=s.useState(null),[h,b]=s.useState(null),u=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],y=[{id:1,title:"Example 1: Optimal Solution Found",problem:`Check optimality of the tableau:
┌─────┬─────┬─────┬─────┬─────┬─────┐
│  B  │  x  │  y  │ s₁  │ s₂  │ RHS │
├─────┼─────┼─────┼─────┼─────┼─────┤
│  x  │  1  │  0  │ 0.5 │ -0.5│  4  │
