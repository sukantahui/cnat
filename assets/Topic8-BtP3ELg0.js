...
"   ".isBlank(); // true`}];function y(){return t.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[t.jsx("style",{children:`
        ...
        `}),t.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[t.jsxs("div",{className:"flex items-center gap-3",children:[t.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_001 · Topic 8"}),t.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Core Inspection API"})]}),t.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Core String Inspection Methods: ",t.jsx("code",{className:"text-emerald-400 font-mono",children:"isEmpty()"})," vs ",t.jsx("code",{className:"text-emerald-400 font-mono",children:"isBlank()"})]}),t.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the fundamental string interrogation toolset: character indexing, substring search with ",t.jsx("code",{className:"text-emerald-300 font-mono",children:"indexOf()"}),", and whitespace validation via Java 11 ",t.jsx("code",{className:"text-emerald-300 font-mono",children:"isBlank()"}),"."]})]}),t.jsxs("section",{className:"space-y-4",children:[t.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[t.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),t.jsx(e,{fileModule:a,title:"StringInspectionMethodsDemo.java",highlightLines:[7,14,15,16,23,24,25]})]}),t.jsx("section",{className:"space-y-4",children:t.jsx(n,{title:"String Inspection FAQs",questions:o})}),t.jsx("section",{className:"space-y-4",children:t.jsx(r,{content:i,title:"Module 003_001 Topic 8: String Inspection Methods",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_001_topic8_inspection_methods_note.txt"})}),t.jsx(s,{note:"Never validate user form input with just .isEmpty()! If a student enters three spaces '   ', isEmpty() returns false, but isBlank() correctly catches it. — Sukanta Hui"})]})}export{y as default};
