import{j as e,bg as s}from"./vendor-react-core-Doz9nIC6.js";import{S as i}from"./ShellFileLoader-E94sGNTM.js";import"./vendor-prism-ZrEUZN6d.js";const n=`#!/usr/bin/env xonsh
# ----------------------------------------------------------------------
...
print(f"Current directory: {$(pwd).strip()}")`,l=`#!/usr/bin/env xonsh
# ----------------------------------------------------------------------
...
radius = 5.3
area = pi * radius ** 2
print(f"Circle area: {area:.2f}")`,r=`#!/usr/bin/env xonsh
# ----------------------------------------------------------------------
