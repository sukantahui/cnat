...
students for the algebraic journey ahead."`,C=()=>{const[t,o]=r.useState("concept"),[l,d]=r.useState({}),[n,c]=r.useState(null),[s,h]=r.useState(null),m=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],p=[{id:1,title:"Example 1: When Graphical Method Works",problem:`Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
x, y ≥ 0
