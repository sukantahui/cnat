import{j as a}from"./vendor-react-core-BBXbtqt1.js";import{J as e}from"./JavaFileLoader-CVw5Mqo9.js";import{F as t}from"./FAQTemplate-BamsZuNW.js";import{P as n}from"./PlainTextPrint-CGJ_aUDk.js";import{T as r}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const s=`/**\r
...
1. ILLEGAL MODIFIER COMBINATIONS:\r
   - 'final abstract class' → COMPILE ERROR.\r
   - 'final abstract void method()' → COMPILE ERROR.\r
   - 'private abstract void method()' → COMPILE ERROR.\r
   - 'static abstract void method()' → COMPILE ERROR.\r
\r
================================================================================\r
...
================================================================================`,o=[{question:"Can an abstract class or abstract method be declared 'final' in Java?",shortAnswer:"No! 'abstract' and 'final' are mutually exclusive, opposing concepts. An abstract class requires inheritance to be useful, while a final class prevents inheritance. Combining them produces a compile-time error.",explanation:"'illegal combination of modifiers: abstract and final' is flagged immediately by javac.",hint:"Opposing concepts: abstract requires subclassing, final forbids subclassing.",level:"Beginner",codeExample:"// Compile Error: final abstract class Bad {}"}];function f(){return a.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[a.jsx("style",{children:`
        ...
        `}),a.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[a.jsxs("div",{className:"flex items-center gap-3",children:[a.jsx("span",{className:"px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_007 · Topic 12"}),a.jsx("span",{className:"px-3 py-1 bg-amber-500/10 text-amber-400 border border-amber-500/20 text-xs font-semibold rounded-full",children:"Compiler Prohibitions"})]}),a.jsx("h1",{className:"text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tight",children:"Can an Abstract Class Be Final? (Illegal Modifier Combinations)"}),a.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Learn why ",a.jsx("code",{className:"text-rose-400 font-mono",children:"abstract"})," and ",a.jsx("code",{className:"text-amber-400 font-mono",children:"final"})," represent total logical opposites in compiler type theory."]})]}),a.jsxs("section",{className:"space-y-4",children:[a.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[a.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),a.jsx(e,{fileModule:s,title:"AbstractFinalContradictionDemo.java",highlightLines:[18,22,31]})]}),a.jsx("section",{className:"space-y-4",children:a.jsx(t,{title:"abstract vs final FAQs",questions:o})}),a.jsx("section",{className:"space-y-4",children:a.jsx(n,{content:i,title:"Module 002_007 Topic 12: abstract vs final Contradiction",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_007_topic12_abstract_final_note.txt"})}),a.jsx(r,{note:"'abstract' says 'please extend me!', while 'final' says 'nobody can extend me!' Putting them together is a direct contradiction that javac rejects instantly. — Sukanta Hui"})]})}export{f as default};
