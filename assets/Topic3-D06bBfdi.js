import{j as e,e as s}from"./index-UNuoN892.js";function l(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Real-World Conditional Scenarios in Python"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["Conditional logic powers real applications like login systems, ATM withdrawals, grading, traffic control, and more. Let's explore some realistic scenarios using ",e.jsx("code",{children:"if"}),", ",e.jsx("code",{children:"elif"}),",",e.jsx("code",{children:"else"}),", and logical operators."]}),e.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"1. Login System with Password + OTP"}),e.jsx(s,{initialCode:`username = "admin"
password = "1234"
otp = "9999"
