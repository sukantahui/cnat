...
`})]}),e.jsxs("section",{className:"p-6 bg-slate-900/40 border border-slate-800 rounded-3xl",children:[e.jsx("h2",{className:"text-lg font-semibold mb-3",children:"3. Throwing Custom Errors"}),e.jsxs("p",{className:"text-slate-300 text-sm mb-3",children:["You can throw your own custom errors. This is extremely useful in large projects built by teams like those trained by",e.jsx("strong",{children:" Sukanta Hui & Tanusree Hui "}),"."]}),e.jsx(r,{language:"javascript",code:`function validateAge(age) {
  if (age < 0) {
