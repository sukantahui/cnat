...
fetch("https://jsonplaceholder.typicode.com/posts/1")
  ...
  });`}),e.jsxs("section",{className:"p-4 bg-slate-900/40 border border-slate-800 rounded-2xl",children:[e.jsx("h4",{className:"text-sm font-semibold text-slate-100",children:"Exam + Interview Tip"}),e.jsx("p",{className:"text-slate-300 text-sm mt-2",children:"Always remember the basic meanings: 2xx = success, 4xx = client error, 5xx = server error. And GET vs POST is very commonly asked."})]})]})}}export{a as default};
