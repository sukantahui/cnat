import{j as e}from"./index-D-07m6Qb.js";import{E as s}from"./EditablePythonCodeBlock-DOe1i3T2.js";import"./index-BLtpQgbQ.js";import"./braces-C_CY9Jv1.js";import"./layout-list-xlk1srMZ.js";import"./play-4rBxpZha.js";import"./type-BEuENsNe.js";import"./refresh-cw-DVel-Kgx.js";import"./copy-BeFV_rGJ.js";import"./download-B_C6cj02.js";import"./eye-off-Ddhut9lm.js";import"./eye-DnmUWsTr.js";function p(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Python Indentation, Comments, Variables & User Input"}),e.jsx("p",{className:"text-slate-300 text-sm leading-relaxed",children:"This topic explains the foundation of Python syntax—indentation rules, comments, variables, naming conventions, core data types, type casting, and taking input from the user. These are essential concepts used in every Python program from beginner to advanced level."}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Python Indentation Rules"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Python uses **indentation instead of braces `","`** to define blocks. Incorrect indentation results in an error."]}),e.jsx(s,{initialCode:`# Correct indentation
if 5 > 2:
