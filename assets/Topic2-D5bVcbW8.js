...
================================================================================`,l=[{question:"How do custom cryptographic stream filters (like CipherInputStream / CipherOutputStream) protect file data at rest in Java?",shortAnswer:"They wrap underlying file streams in the Decorator pattern. As bytes flow through the stream, the filter applies cryptographic transformations (AES, RSA, or XOR) in chunks on-the-fly before writing encrypted ciphertext to disk or decrypting ciphertext back to plaintext upon reading, without loading entire files into memory.",explanation:"Standard enterprise approach for zero-trust data-at-rest encryption.",hint:"Applies on-the-fly chunk encryption/decryption as bytes flow through stream decorators.",level:"Advanced",codeExample:"CipherOutputStream cos = new CipherOutputStream(new FileOutputStream(file), aesCipher);"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 005_007 · Topic 2"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Project 2: Encrypted Vault"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Project 2: Encrypted File Vault (Cryptographic Stream Filter)"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Build security stream filters: applying cryptographic transformations to protect sensitive financial records on disk with on-the-fly encryption and decryption."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:i,title:"EncryptedFileVaultProjectDemo.java",highlightLines:[7,10,16,17,21,22,38,39,47,48]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{title:"File Vault FAQs",questions:l})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:o,title:"Module 005_007 Topic 2: Encrypted File Vault",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"005_007_topic2_encrypted_file_vault_note.txt"})}),e.jsx(a,{note:"In banking and taxation software, data stored on disk must always be encrypted at rest! Building a stream filter lets you secure files of any size without needing gigabytes of RAM! — Sukanta Hui"})]})}export{x as default};
