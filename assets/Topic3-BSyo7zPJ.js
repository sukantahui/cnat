...
================================================================================\r
`,i=[{question:"What is the typical recommended batch chunk size for JDBC bulk insertions?",shortAnswer:"500 to 1,000 rows per batch chunk.",explanation:"Provides optimal throughput without overwhelming client JVM RAM or database transaction logs.",hint:"500 to 1,000 rows.",level:"Beginner",codeExample:"int BATCH_SIZE = 1000;"},{question:"Why is a tail flush necessary when batching records in fixed chunk intervals?",shortAnswer:"Because the total number of records processed may not be an exact multiple of the chunk size (e.g. 2,450 records with a batch size of 1,000 leaves 450 unflushed records in the buffer at the end of the loop).",explanation:"Without a tail flush, the remaining records will never be executed.",hint:"Flushes the remaining records that did not make up a full batch interval.",level:"Beginner",codeExample:"if (count % BATCH_SIZE != 0) pstmt.executeBatch();"}];function S(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 011_005 · Topic 3"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Batch Updates & DAO Pattern"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Tuning Batch Sizes: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"Finding the Golden Chunk Size"})]}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Balancing RAM and network packets: why 500 to 1,000 items is the industry sweet spot for high-throughput batching."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:o,title:"TuningBatchSizesDemo.java",highlightLines:[18,25,34,43]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Batch Updates & DAO FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:s,title:"Module 011_005 Topic 3: Tuning Batch Sizes",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"011_005_topic3_tuning_batch_sizes_note.txt"})}),e.jsx(a,{note:"Don't try to batch 1,000,000 records in a single batch! Your JVM heap will run out of memory! Chunk your data into batches of 500 or 1,000 rows, execute each batch, commit, and repeat! — Sukanta Hui"})]})}export{S as default};
