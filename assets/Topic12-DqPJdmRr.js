import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as a}from"./JavaFileLoader-CVw5Mqo9.js";import{F as t}from"./FAQTemplate-BamsZuNW.js";import{P as s}from"./PlainTextPrint-CGJ_aUDk.js";import{T as n}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const i=`/**\r
...
\r
    public static CapstoneCandidateResult evaluateCandidate(\r
        ...
        if (name == null) {\r
            throw new NullPointerException("name must not be null");\r
        }\r
\r
...
\r
        // 3. Capstone Evaluations using primitive array\r
        CapstoneCandidateResult[] candidates = {\r
...
================================================================================\r
\r
1. FORMAL PROBLEM DEFINITION & CAPSTONE ALGORITHMIC SPECIFICATIONS\r
--------------------------------------------------------------------------------\r
PROBLEM 12: Segment 1 Timed Coding Assessment (Comprehensive Capstone)\r
- Objective: Integrate algorithms across all Segment 1 foundational pillars\r
  into a unified evaluation and academic billing engine without external libraries.\r
- Specification 12A (Matrix Diagonals & Binary Search):\r
  * Matrix Diagonal Sum: Given an N x N square matrix, accumulate primary diagonal\r
    matrix[i][i] and secondary diagonal matrix[i][n-1-i] in O(N) time.\r
    If N is odd, deduct the intersecting center matrix[n/2][n/2] once.\r
  * Recursive Binary Search: Perform divide-and-conquer target lookup in a sorted\r
    array with overflow-safe midpoint calculation: mid = low + (high - low) / 2.\r
    Return 0-based target index or -1 if absent. Time complexity: O(log N).\r
- Specification 12B (Sieve Roll Primality & 18% GST Ledger):\r
  * In-Memory Sieve: Precompute boolean[] prime table up to max roll in O(N log log N).\r
  * Academic Tier Dispatch: Switch expression on AcademicTier enum:\r
    - DISTINCTION  (score >= 90) : 25% waiver\r
    - FIRST_CLASS  (score >= 75) : 15% waiver\r
    - SECOND_CLASS (score >= 60) : 5% waiver\r
    - PASS / FAIL  (score < 60)  : 0% waiver\r
  * Statutory GST Invoicing:\r
    - netBeforeTax = baseFeeInr - scholarshipInr\r
    - finalPayableFeeInr = netBeforeTax * 1.18 (18% GST in India)\r
    - Output: CapstoneCandidateResult record.\r
- Constraints: Pure primitive arrays and records. Zero collections.\r
\r
2. SEGMENT 1 CAPSTONE TIMED CHALLENGES\r
--------------------------------------------------------------------------------\r
