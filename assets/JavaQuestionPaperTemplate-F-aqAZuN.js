import{r as c,j as t}from"./index-keUzLGou.js";import{P as v}from"./PrintButton-D0HYeJsS.js";import{J as u}from"./JavaCodeBlock-Cu2i1ylu.js";import{P as j}from"./prism-BLp_EZQ1.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
