...
================================================================================`,i=[{question:"What major problems did the Java 9 Module System (JPMS / Project Jigsaw) solve in enterprise Java?",shortAnswer:"1. Eliminated 'Classpath Hell' by validating dependencies at boot time. 2. Introduced Strong Encapsulation (public classes are private to the module unless exported). 3. Modularized the monolithic JDK (rt.jar) enabling custom minimal runtimes via 'jlink'.",explanation:"JPMS is the most significant architectural evolution of the Java platform since Java 5.",hint:"Solves classpath hell, enforces strong encapsulation, and enables minimal jlink runtimes.",level:"Intermediate",codeExample:"// module com.company.app { requires java.sql; }"}];function g(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_009 · Topic 13"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Modern Java Architecture"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:"Introduction to Java 9 Platform Module System (JPMS / Project Jigsaw)"}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Understand the greatest architectural evolution in modern Java: ending classpath hell, modularizing the JDK, and introducing strong encapsulation across module boundaries."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"Java9ModuleSystemOverviewDemo.java",highlightLines:[7,14,15,16,20,21]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Java 9 JPMS FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:o,title:"Module 002_009 Topic 13: JPMS Overview",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_009_topic13_jpms_note.txt"})}),e.jsx(r,{note:"Before Java 9, rt.jar was a massive 60MB monolith containing everything from CORBA to Swing. Java 9 broke it into clean modules, allowing us to build tiny 20MB microservices for Docker! — Sukanta Hui"})]})}export{g as default};
