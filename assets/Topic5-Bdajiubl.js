...
solution changes."`,R=()=>{const[t,d]=a.useState("concept"),[s,l]=a.useState({}),[r,c]=a.useState(null),[i,h]=a.useState(null),x=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],m=[{id:1,title:"Example 1: Redundant Constraint",problem:`Maximize Z = 3x + 2y
Subject to:
x + y ≤ 10
2x + y ≤ 16
x ≤ 8
