import{b as c,j as e}from"./vendor-react-core-BBXbtqt1.js";import{T as k}from"./TeacherSukantaHui-VMH_OtYp.js";import{P as d}from"./PythonFileLoader-YugaCzY9.js";import{F as g}from"./FAQTemplate-BamsZuNW.js";import{P as f}from"./PlainTextPrint-CGJ_aUDk.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const b=[{question:"What is the key difference between `screen.onkeypress()` and `screen.onkeyrelease()`?",shortAnswer:"`onkeypress()` fires the moment a key is depressed; `onkeyrelease()` fires when the physical key springs back up.",explanation:"Pairing press and release events enables continuous multi-key state tracking.",hint:"Which event fires on key down versus key up?",level:"basic",codeExample:`screen.onkeypress(press_handler, 'Up')
