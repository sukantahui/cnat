...
\`\`\``,hint:"Swap elements from both ends moving towards the center."}]}],s={paperId:n,title:e,duration:t,totalMarks:30,prerequisites:a,instructions:r,sections:i};export{s as q};
