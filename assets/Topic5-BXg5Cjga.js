...
================================================================================`,o=[{question:"Why pass 'this' as an argument into another object's constructor?",shortAnswer:"To establish a bi-directional association or parent-child relationship (e.g. a Ledger holding a reference back to its Student owner).",explanation:"When an object instantiates its own helper component, passing 'this' allows the helper to maintain a back-reference to its creator.",hint:"Establishes bi-directional parent-child association.",level:"Intermediate",codeExample:"this.ledger = new Ledger(this);"}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_003 · Topic 5"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Bi-directional Modeling"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Passing ",e.jsx("code",{className:"text-sky-400 font-mono",children:"this"})," as an Argument in Constructor Calls"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Build tightly-coupled domain relationships by passing ",e.jsx("code",{className:"text-sky-300 font-mono",children:"this"})," to child constructors, establishing parent-child back-pointers cleanly and safely."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:a,title:"PassingThisInConstructorDemo.java",highlightLines:[13,29,39]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{title:"Passing 'this' in Constructor Calls FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:i,title:"Module 002_003 Topic 5: Passing this in Constructor Calls",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_003_topic5_passing_this_constructor_note.txt"})}),e.jsx(s,{note:"When a parent creates a child ledger, passing this lets the child know who its parent is. Just ensure all your parent fields are populated first! — Sukanta Hui"})]})}export{x as default};
