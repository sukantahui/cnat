import{j as e,E as s}from"./index-BnX9VYl0.js";function t(){return e.jsxs("div",{className:"space-y-10",children:[e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-sky-300",children:["The ",e.jsx("span",{className:"text-sky-400",children:"switch"})," Statement"]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["A ",e.jsx("code",{className:"text-sky-300",children:"switch"})," statement lets you compare a value against multiple possible cases. It is cleaner than writing a long chain of",e.jsx("code",{className:"text-sky-300",children:" if / else if "}),", especially when checking the same variable repeatedly."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h3",{className:"text-xl font-semibold text-sky-300",children:"Basic Example"}),e.jsx(s,{language:"javascript",initialCode:`let day = 3;
let result = "";
