import{b as a,j as e,bh as o}from"./vendor-react-core-CaA1o1Cx.js";import{T as m}from"./TeacherSukantaHui-CQZ6Ktkk.js";import{F as f}from"./FAQTemplate-D_90hN4m.js";import{P as y}from"./PlainTextPrint-yt10TRX1.js";import{P as b}from"./PythonFileLoader-CiS1GfkF.js";import"./vendor-icons-DAu8Qe7E.js";import"./PythonCodeBlock-B71mjQen.js";import"./vendor-prism-ntVuzLqd.js";const x=[{id:1,question:"What is a W3C Decentralized Identifier (DID) and what is its standard URI structure?",shortAnswer:"A DID is a globally unique, persistent, cryptographically verifiable URI conforming to the W3C standard with the syntax `did:method:method-specific-id` (e.g., `did:ion:EiD382...` or `did:indy:sovrin:99124`). It resolves to a DID Document without relying on a centralized registry or identity provider.",explanation:"DIDs enable self-sovereign identity where individuals control their own public/private key pairs.",hint:"W3C standard URI: did:method:method-specific-id that resolves to a DID Document.",level:"Basic",codeExample:`// DID URI Syntax:
// scheme : did
