import{j as e,b as c,bg as d}from"./vendor-react-core-Doz9nIC6.js";const x=`#!/bin/bash
...
# Cleanup
rm ascii.txt utf8.txt`,g=`#!/bin/bash
...
# Cleanup
rm text.txt fixed.txt`,p=`#!/bin/bash
