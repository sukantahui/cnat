import{b as o,j as e}from"./vendor-react-core-Doz9nIC6.js";import{E as t}from"./EditableCodeBlock-qnnEAQ-n.js";import"./vendor-monaco-Bv7hoEkV.js";import"./vendor-icons-CIaKtAt4.js";class r extends o.Component{render(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-semibold",children:"Topic 10 – Nested objects and arrays of objects"}),e.jsx(t,{language:"javascript",initialCode:`// Example 1: Nested objects
const institute = {
  name: "Coder & AccoTax",
  location: {
    city: "Barrackpore",
...
console.log(course.mentors[0].name);     // "Sukanta Hui"`})]})}}export{r as default};
