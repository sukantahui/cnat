import{b as a,j as e,bm as o}from"./vendor-react-core-BBXbtqt1.js";import{T as m}from"./TeacherSukantaHui-VMH_OtYp.js";import{F as f}from"./FAQTemplate-BamsZuNW.js";import{P as y}from"./PlainTextPrint-CGJ_aUDk.js";import{P as b}from"./PythonFileLoader-YugaCzY9.js";import"./vendor-icons-IjXdH6hS.js";import"./PythonCodeBlock-BDgVOCqn.js";import"./vendor-prism-B7oW9GGR.js";const x=[{id:1,question:"What is a W3C Decentralized Identifier (DID) and what is its standard URI structure?",shortAnswer:"A DID is a globally unique, persistent, cryptographically verifiable URI conforming to the W3C standard with the syntax `did:method:method-specific-id` (e.g., `did:ion:EiD382...` or `did:indy:sovrin:99124`). It resolves to a DID Document without relying on a centralized registry or identity provider.",explanation:"DIDs enable self-sovereign identity where individuals control their own public/private key pairs.",hint:"W3C standard URI: did:method:method-specific-id that resolves to a DID Document.",level:"Basic",codeExample:`// DID URI Syntax:
// scheme : did
