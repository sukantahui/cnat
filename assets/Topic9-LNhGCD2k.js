import{j as e}from"./vendor-react-core-BBXbtqt1.js";import{J as t}from"./JavaFileLoader-CVw5Mqo9.js";import{F as n}from"./FAQTemplate-BamsZuNW.js";import{P as s}from"./PlainTextPrint-CGJ_aUDk.js";import{T as a}from"./TeacherSukantaHui-VMH_OtYp.js";import"./JavaCodeBlock-C-PCLa__.js";import"./vendor-prism-B7oW9GGR.js";import"./vendor-icons-IjXdH6hS.js";const r=`/**\r
 ...
 *              10. Enhanced For-Each Array Element Mutation Trap\r
...
\r
    // =========================================================================\r
    // BUG 10: The Enhanced For-Each Array Element Mutation Trap\r
    // =========================================================================\r
    public static void fixBug10_ForEachArrayMutation(int[] arr) {\r
        // BUG: for (int val : arr) { val = val * 2; }\r
        // (Modifies only the local loop copy variable; original array remains unchanged!)\r
        // FIX: Use index-based for loop to mutate underlying array elements:\r
        for (int i = 0; i < arr.length; i++) {\r
            arr[i] = arr[i] * 2;\r
        }\r
    }\r
...
\r
        // 10. For-Each Array Mutation Trap\r
        int[] scores = {10, 20, 30};\r
        fixBug10_ForEachArrayMutation(scores);\r
        System.out.printf("Bug 10 Fix (Index-Based Loop) : Doubled Scores = [%d, %d, %d]%n%n",\r
                scores[0], scores[1], scores[2]);\r
\r
        System.out.println("================================================================================");\r
        ...
        System.out.println("4. Never use enhanced for-each to modify array elements; use index-based loops instead.");\r
        System.out.println("================================================================================");\r
    }\r
}\r
`,i=`================================================================================\r
...
================================================================================\r
\r
1. FORMAL PROBLEM DEFINITION & DIAGNOSTIC SPECIFICATIONS\r
--------------------------------------------------------------------------------\r
PROBLEM 9: Diagnostic Debugging Challenge (10 Common Java Bugs)\r
- Objective: Diagnose root cause and apply canonical defensive fixes for 10\r
  classic Java Foundations anti-patterns across memory, control, and arrays.\r
- Bug Categories:\r
  * Category A (References & Types): String ==, NPE, Array Bounds, Overflow, Float.\r
  * Category B (Syntax & Mutation) : Semicolon, Switch, Truncation, String, For-Each.\r
- Output: Defensively guarded, clean-compiling, bug-free implementations.\r
\r
2. THE 10 CLASSIC JAVA BUGS & FIXES\r
--------------------------------------------------------------------------------\r
1. String Equality (== vs .equals())\r
   * Bug: a == b compares memory addresses!\r
   * Fix: a.equals(b) or (a != null && a.equals(b)).\r
\r
...
\r
10. Enhanced For-Each Array Mutation Trap\r
   * Bug: for (int x : arr) x = 0 modifies only the local loop copy variable.\r
   * Fix: use index-based loop for (int i = 0; i < arr.length; i++) arr[i] = 0.\r
\r
