import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{E as s}from"./EditablePythonCodeBlock-BrIv9qrF.js";import"./vendor-monaco-Bv7hoEkV.js";import"./vendor-icons-CbUXUJ65.js";function l(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Assignment & Compound Assignment Operators"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Assignment operators store values inside variables. Python also provides several compound assignment operators that combine arithmetic with assignment, making code shorter, cleaner & efficient."}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. Basic Assignment Operator (=)"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"It assigns the value on the right side to the variable on the left side."}),e.jsx(s,{initialCode:`x = 10
y = 5
name = "Python"
