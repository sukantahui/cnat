import{j as e}from"./index-DI04DAgq.js";import{E as s}from"./EditablePythonCodeBlock-PLwuoa8r.js";import"./index-dzV7gd_1.js";import"./braces-CK1RveI2.js";import"./layout-list-CjY_Mh8i.js";import"./play-DnWShgnU.js";import"./type-DY6QvqBr.js";import"./refresh-cw-Evg5lk_v.js";import"./copy-DQfKP-RU.js";import"./download-DwVcN2kg.js";import"./eye-off-DDPcd9Hm.js";import"./eye-CmydJEzS.js";function h(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"String Concatenation & f-Strings in Python"}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["Python provides multiple ways to build strings. The most common and powerful method is using ",e.jsx("strong",{children:"f-strings"}),", introduced in Python 3.6."]}),e.jsxs("section",{className:"space-y-3",children:[e.jsxs("h2",{className:"text-xl font-semibold text-slate-200",children:["1. String Concatenation using ",e.jsx("code",{children:"+"})]}),e.jsxs("p",{className:"text-slate-300 text-sm",children:["You can add (concatenate) two strings using the ",e.jsx("code",{children:"+"})," operator."]}),e.jsx(s,{initialCode:`first = "Coder"
second = "AccoTax"
result = first + " & " + second
