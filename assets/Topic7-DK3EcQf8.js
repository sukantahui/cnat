...
1. QUANTIFIER MODES:\r
   - Greedy     : '*', '+', '?', '{n,m}' &rarr; Matches maximum length.\r
   - Reluctant  : '*?', '+?', '??' &rarr; Matches minimum length (lazy).\r
   - Possessive : '*+', '++', '?+' &rarr; Never backtracks (fastest & ReDoS safe).\r
\r
================================================================================\r
Classroom Practice: Barrackpore Academy | Mentor: Sukanta Hui\r
================================================================================`,o=[{question:"What is the difference between Greedy ('*') and Reluctant/Lazy ('*?') quantifiers in regex?",shortAnswer:"A Greedy quantifier ('*') reads the entire text first and backtracks backwards to find the longest possible match (swallowing intermediate tags). A Reluctant quantifier ('*?') matches as few characters as possible, stopping at the earliest occurrence.",explanation:"Always use reluctant quantifiers ('.*?') when parsing delimited HTML tags or quotes.",hint:"Greedy finds the longest possible match; Reluctant finds the shortest match.",level:"Intermediate",codeExample:'Pattern lazy = Pattern.compile("<b>.*?</b>"); // Matches individual tags'}];function g(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_006 · Topic 7"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Quantifier Mechanics"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Quantifiers: Greedy (",e.jsx("code",{className:"text-rose-400 font-mono",children:".*"}),"), Reluctant (",e.jsx("code",{className:"text-emerald-400 font-mono",children:".*?"}),") & Possessive (",e.jsx("code",{className:"text-sky-400 font-mono",children:".*+"}),")"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Master the three engine matching strategies: avoiding greedy HTML tag over-consumption with lazy ",e.jsx("code",{className:"text-emerald-300 font-mono",children:".*?"})," and preventing backtracking CPU thrashing with possessive quantifiers."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(t,{fileModule:s,title:"RegexQuantifiersComparisonDemo.java",highlightLines:[7,16,17,24,25,31,32]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(a,{title:"Quantifiers FAQs",questions:o})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:i,title:"Module 003_006 Topic 7: Regex Quantifiers",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_006_topic7_quantifiers_note.txt"})}),e.jsx(n,{note:"If you are parsing HTML tags, NEVER use '<b>.*</b>'! It will swallow all your tags from the first <b> on line 1 to the last </b> on line 50! Always use lazy '<b>.*?</b>'! — Sukanta Hui"})]})}export{g as default};
