...
================================================================================`,s=[{question:"What does the 'String.intern()' native method do in Java?",shortAnswer:"The 'intern()' method returns the canonical representation of the string from the String Constant Pool (SCP). If the string exists in SCP, its pool reference is returned; otherwise, the string is added to SCP and returned.",explanation:"Allows converting dynamically computed heap strings into shared pooled instances for memory optimization.",hint:"Returns the canonical pooled reference from SCP.",level:"Intermediate",codeExample:"String s2 = s1.intern(); // s2 points directly to SCP"}];function g(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_001 · Topic 5"}),e.jsx("span",{className:"px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 text-xs font-semibold rounded-full",children:"Pool Interning"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["The ",e.jsx("code",{className:"text-purple-400 font-mono",children:"intern()"})," Method: Caching Dynamic Strings into SCP"]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Learn how ",e.jsx("code",{className:"text-purple-300 font-mono",children:"String.intern()"})," queries and registers strings into the String Constant Pool: deduplicating dynamic runtime data and enabling lightning-fast reference comparisons."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:i,title:"StringInterningMasteryDemo.java",highlightLines:[7,15,18,21,24,27]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"intern() FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:o,title:"Module 003_001 Topic 5: String.intern() Method",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_001_topic5_intern_note.txt"})}),e.jsx(a,{note:"If you are parsing a huge CSV file with 1 million records where the city is repeated over and over, calling city.intern() deduplicates the strings in RAM and saves hundreds of megabytes! — Sukanta Hui"})]})}export{g as default};
