import{j as t}from"./index-CK4WUhpx.js";import{C as e}from"./CodeBlock-BQBAcWlN.js";import"./prism-Bgw5yzRN.js";import"./prism-json-D0UlpdKh.js";import"./file-code-CDbVQmeK.js";import"./createLucideIcon--yS5sPo-.js";import"./copy-dX76-Zhw.js";import"./download-CvyilHOI.js";import"./play-CGI8rN0h.js";function p(){return t.jsxs("div",{className:"space-y-6",children:[t.jsx("h2",{className:"text-xl font-semibold text-sky-300",children:"break & continue"}),t.jsxs("p",{className:"text-slate-300 text-sm",children:[t.jsx("strong",{children:"break"})," stops the loop completely.",t.jsx("br",{}),t.jsx("strong",{children:"continue"})," skips the current iteration."]}),t.jsx("h3",{className:"text-lg text-slate-200 font-semibold",children:"break Example"}),t.jsx(e,{code:`for (let i = 1; i <= 10; i++) {
  if (i === 5) break;
  console.log(i);
}
