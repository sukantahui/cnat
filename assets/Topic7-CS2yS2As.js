...
1. BRIDGE ARCHITECTURE:\r
   - 'InputStreamReader' : InputStream (Bytes) → Reader (Chars).\r
   - 'OutputStreamWriter': Writer (Chars) → OutputStream (Bytes).\r
