import{b as i,j as e,bg as h}from"./vendor-react-core-Doz9nIC6.js";import{S as l}from"./ShellFileLoader-E94sGNTM.js";import"./vendor-prism-ZrEUZN6d.js";const m=`# topic10_files/quoting_basic.sh\r
#!/bin/bash\r
...
echo "Quoted empty: '$EMPTY'"  # Shows empty quotes`,g=`# topic10_files/quoting_special_chars.sh\r
#!/bin/bash\r
...
\r
# Cleanup\r
rm -f file1.txt file2.txt file3.txt "file with spaces.txt"`,p=`# topic10_files/quoting_command_sub.sh\r
#!/bin/bash\r
