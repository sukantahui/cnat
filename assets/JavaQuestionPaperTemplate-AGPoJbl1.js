import{r as c,j as t}from"./index-CRQVh4re.js";import{P as v}from"./PrintButton-dEXcUQfV.js";import{J as u}from"./JavaCodeBlock-BwGLOxAw.js";import{P as j}from"./prism-CY4NEqq1.js";import"./prism-java-BwO6k4I_.js";function y({code:i="",highlightLines:p=[],title:h="Java Code (BlueJ)"}){const[d,m]=c.useState([]),x=c.useRef(null);return c.useEffect(()=>{const l=j.highlight(i,j.languages.java,"java");m(l.split(`
