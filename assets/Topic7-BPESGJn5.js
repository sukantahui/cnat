...
================================================================================`,i=[{question:"What does the 'compareTo(String anotherString)' method return in Java?",shortAnswer:"It returns an integer: negative (< 0) if this string lexicographically precedes the argument, zero (0) if they are equal, and positive (> 0) if this string follows the argument. 'compareToIgnoreCase()' performs the same check ignoring case.",explanation:"Powers sorting algorithms in Collections.sort() and Arrays.sort().",hint:"Returns < 0 for before, 0 for equal, > 0 for after.",level:"Beginner",codeExample:'int diff = "Apple".compareTo("Banana"); // Returns negative number'}];function x(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
        ...
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 003_001 · Topic 7"}),e.jsx("span",{className:"px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-semibold rounded-full",children:"Lexicographical Sorting"})]}),e.jsxs("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:["Case-Insensitive Comparisons: ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"equalsIgnoreCase()"})," & ",e.jsx("code",{className:"text-emerald-400 font-mono",children:"compareTo()"})]}),e.jsxs("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:["Learn how to perform case-agnostic equality tests and alphabetical sorting comparisons using ",e.jsx("code",{className:"text-emerald-300 font-mono",children:"compareTo()"})," and Unicode code-point differences."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(r,{fileModule:o,title:"StringComparisonMethodsDemo.java",highlightLines:[7,14,15,16,20,24,25]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Lexicographical Comparison FAQs",questions:i})}),e.jsx("section",{className:"space-y-4",children:e.jsx(n,{content:s,title:"Module 003_001 Topic 7: String Comparisons",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"003_001_topic7_comparison_methods_note.txt"})}),e.jsx(a,{note:"When sorting student names alphabetically in our Barrackpore portal, Collections.sort() uses compareTo() under the hood. Negative means 'comes before', zero means 'equal', and positive means 'comes after'! — Sukanta Hui"})]})}export{x as default};
