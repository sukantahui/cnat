...
becomes second nature."`,U=()=>{const[s,u]=r.useState("concept"),[h,p]=r.useState({}),[n,y]=r.useState(null),[l,v]=r.useState(null),j=[{id:"concept",label:"Concept"},{id:"examples",label:"Examples"},{id:"practice",label:"Practice"}],f=[{id:1,title:"Example 1: Basic Simplex Tableau",problem:`Construct the initial simplex tableau for:
Maximize Z = 3x + 2y
Subject to:
2x + y ≤ 10
x + 2y ≤ 8
