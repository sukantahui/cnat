import{b as o,j as e,bg as d}from"./vendor-react-core-Doz9nIC6.js";import{T as a}from"./TeacherSukantaHui-DerPxfxp.js";import{J as i}from"./JavaFileLoader-BfBG3xz_.js";import"./vendor-icons-CH1iX9C8.js";import"./JavaCodeBlock-BwsLxS3r.js";import"./vendor-prism-ZrEUZN6d.js";const c=`\r
public class BubbleSortBasic {\r
    ...
    public static void main(String[] args) {\r
        ...
        for (int i = 0; i < marks.length; i++) {\r
            System.out.print(marks[i] + (i < marks.length - 1 ? ", " : ""));\r
        }\r
        ...
        bubbleSort(scores);\r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Sorted scores: " + "[");\r
        for (int i = 0; i < scores.length; i++) {\r
            System.out.print(scores[i] + (i < scores.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class BubbleSortOptimized {\r
    ...
    public static void main(String[] args) {\r
        ...
        for (int i = 0; i < sorted.length; i++) {\r
            System.out.print(sorted[i] + (i < sorted.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        bubbleSort(sorted);\r
        // ICSE Syllabus: Manual array element display using loop\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Original: " + "[");\r
        for (int i = 0; i < nearlySorted.length; i++) {\r
            System.out.print(nearlySorted[i] + (i < nearlySorted.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        ...
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Original: " + "[");\r
        for (int i = 0; i < random.length; i++) {\r
            System.out.print(random[i] + (i < random.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        bubbleSort(random);\r
        // ICSE Syllabus: Manual array element display using loop\r
...
public class BubbleSortStepByStep {\r
    ...
    public static void bubbleSortWithTrace(int[] arr) {\r
        ...
        System.out.println("]");\r
            ...
            \r
            // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("End of pass " + (i + 1) + ": " + "[");\r
        for (int i = 0; i < arr.length; i++) {\r
            System.out.print(arr[i] + (i < arr.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
...
public class BubbleSortWithStrings {\r
    ...
    public static void main(String[] args) {\r
        ...
        \r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Original names: " + "[");\r
        for (int i = 0; i < students.length; i++) {\r
            System.out.print(students[i] + (i < students.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        bubbleSort(students);\r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Sorted names: " + "[");\r
        for (int i = 0; i < students.length; i++) {\r
            System.out.print(students[i] + (i < students.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
        ...
        bubbleSort(cities);\r
        // ICSE Syllabus: Manual array element display using loop\r
        System.out.print("Sorted cities: " + "[");\r
        for (int i = 0; i < cities.length; i++) {\r
            System.out.print(cities[i] + (i < cities.length - 1 ? ", " : ""));\r
        }\r
        System.out.println("]");\r
