...
choice = int(input("Enter choice: "))
print("You chose", choice)`}),e.jsxs("div",{className:"bg-red-900/30 border-l-4 border-red-400 p-3 text-sm text-red-200",children:[e.jsx("strong",{children:"⚠ Teacher Warning:"}),"Forgetting ",e.jsx("code",{children:"break"})," and improper input handling are the most common errors in menu-driven programs."]})]})]})}}export{j as default};
