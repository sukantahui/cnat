import{b as n,j as e,bm as r}from"./vendor-react-core-D9iF7FwR.js";import{T as y}from"./TeacherSukantaHui-Bldu0y17.js";import{F as A}from"./FAQTemplate-DmdkpHR-.js";import{P as v}from"./PlainTextPrint-CS96sBe2.js";import{P as k}from"./PythonFileLoader-D5JKxZvU.js";import"./vendor-icons-Beb6eGc1.js";import"./PythonCodeBlock-Dy3OqNFl.js";import"./vendor-prism-SANIKoEh.js";const I=[{id:1,question:"What is the primary architectural difference between SAML 2.0, OAuth 2.0, and OpenID Connect (OIDC)?",shortAnswer:"SAML 2.0: Enterprise XML-based protocol for user authentication and Web Browser SSO. OAuth 2.0: Delegated authorization framework for API resource access. OpenID Connect (OIDC): Identity/Authentication layer built directly on top of OAuth 2.0 using JSON and JWTs.",explanation:"OAuth 2.0 grants API access (authorization); OIDC asserts user identity (authentication); SAML federates enterprise web logins.",hint:"SAML = Enterprise XML SSO; OAuth = API Authorization; OIDC = Identity layer over OAuth using JWTs.",level:"Basic",codeExample:`// Protocol Essence:
