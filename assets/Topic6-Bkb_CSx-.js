import{j as e}from"./index-CK4WUhpx.js";import{E as s}from"./EditablePythonCodeBlock-6OdLdI1a.js";import"./index-s7j91j2a.js";import"./createLucideIcon--yS5sPo-.js";import"./braces-6524uQsV.js";import"./layout-list-Cl8lmIC1.js";import"./play-CGI8rN0h.js";import"./type-DD2SMkRe.js";import"./refresh-cw-BeQoxRgF.js";import"./copy-dX76-Zhw.js";import"./download-CvyilHOI.js";import"./eye-off-wSbFtSgN.js";import"./eye-BOx9f4_I.js";function j(){return e.jsxs("div",{className:"space-y-10",children:[e.jsx("h1",{className:"text-2xl font-bold text-sky-300",children:"Core Data Types in Python — int, float, str, bool"}),e.jsxs("p",{className:"text-slate-300 text-sm leading-relaxed",children:["Python has four essential built-in data types used in the foundation of every program:",e.jsx("code",{children:"int"}),", ",e.jsx("code",{children:"float"}),", ",e.jsx("code",{children:"str"}),", and ",e.jsx("code",{children:"bool"}),". These types are dynamically assigned, meaning Python automatically decides the type based on the value."]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-xl font-semibold text-slate-200",children:"1. int (Integer)"}),e.jsx("p",{className:"text-slate-300 text-sm",children:"Used for whole numbers — no decimals allowed. Python can store very large integers without overflow."}),e.jsx(s,{initialCode:`a = 10
b = -50
