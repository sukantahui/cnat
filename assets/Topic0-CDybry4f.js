import{j as e}from"./vendor-react-core-Doz9nIC6.js";import{E as s}from"./EditableCodeBlock-qnnEAQ-n.js";import"./vendor-monaco-Bv7hoEkV.js";import"./vendor-icons-CIaKtAt4.js";function o(){return e.jsxs("div",{className:"space-y-10",children:[e.jsxs("section",{className:"space-y-6",children:[e.jsxs("h2",{className:"text-2xl font-bold text-sky-300",children:["Understanding ",e.jsx("span",{className:"text-sky-400",children:"if / else"})," Statements"]}),e.jsxs("p",{className:"text-slate-300 leading-relaxed text-sm md:text-base",children:["An ",e.jsx("code",{className:"text-sky-300",children:"if"})," statement allows your program to perform different actions based on a condition. A condition must always evaluate to a boolean (",e.jsx("span",{className:"text-emerald-400 font-semibold",children:"true"})," or",e.jsx("span",{className:"text-rose-400 font-semibold",children:" false"}),")."]}),e.jsx(s,{language:"javascript",initialCode:`let age = 18;
