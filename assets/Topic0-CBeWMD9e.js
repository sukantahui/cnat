...
================================================================================`,s=[{question:"What does Polymorphism literally mean in Java?",shortAnswer:"Derived from Greek ('poly' = many, 'morph' = forms), polymorphism is the ability of a single interface, method, or reference variable to take on multiple concrete operational forms at runtime.",explanation:"It allows client code to interact with abstract base contracts while the JVM automatically executes specialized subclass logic.",hint:"'Many forms' - one unified interface with multiple concrete behaviors.",level:"Beginner",codeExample:"Shape s = new Circle(); s.draw();"}];function y(){return e.jsxs("div",{className:"space-y-12 px-4 md:px-8 py-8 text-slate-200 bg-slate-900 min-h-screen",children:[e.jsx("style",{children:`
          @keyframes fadeIn {
            from { opacity: 0; transform: translateY(8px); }
            to { opacity: 1; transform: translateY(0); }
          }
          .animate-fade-in { animation: fadeIn 0.5s ease-out forwards; }
        `}),e.jsxs("header",{className:"space-y-4 border-b border-slate-800 pb-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("span",{className:"px-3 py-1 bg-sky-500/10 text-sky-400 border border-sky-500/20 text-xs font-semibold rounded-full uppercase tracking-wider",children:"Module 002_006 · Topic 0"}),e.jsx("span",{className:"px-3 py-1 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-xs font-semibold rounded-full",children:"Core OOP Pillar"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-extrabold text-white tracking-tight",children:'What is Polymorphism: "One Interface, Multiple Implementations"'}),e.jsx("p",{className:"text-base md:text-lg text-slate-400 leading-relaxed max-w-4xl",children:"Discover the crowning jewel of Object-Oriented Programming: decoupling abstract intent from concrete execution through Compile-Time Overloading and Runtime Overriding."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsxs("h2",{className:"text-2xl font-bold text-emerald-400 flex items-center gap-2",children:[e.jsx("span",{children:"💻"})," Hands-On Java Demo Code"]}),e.jsx(n,{fileModule:a,title:"PolymorphismFoundationsDemo.java",highlightLines:[12,17,24,31,42,51]})]}),e.jsx("section",{className:"space-y-4",children:e.jsx(t,{title:"Polymorphism Foundations FAQs",questions:s})}),e.jsx("section",{className:"space-y-4",children:e.jsx(r,{content:o,title:"Module 002_006 Topic 0: What is Polymorphism",stampEnabled:!0,showDownload:!0,downloadButtonText:"Download Printable Note",downloadFileName:"002_006_topic0_polymorphism_note.txt"})}),e.jsx(i,{note:"Polymorphism lets your code say: 'Send alert!' and the system automatically decides whether to use SMS, Email, or WhatsApp depending on the object behind the scenes! — Sukanta Hui"})]})}export{y as default};
