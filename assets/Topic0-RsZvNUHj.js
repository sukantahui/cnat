import{j as e}from"./index-DlQhRwac.js";import{E as s}from"./EditablePythonCodeBlock-CFQYO0-a.js";import"./index-Cwnu-Juo.js";import"./braces-Cs97IlMa.js";import"./layout-list-BonHw52I.js";import"./play-CpwSfdJ1.js";import"./type-ClWXtHxZ.js";import"./refresh-cw-BFZI2NBH.js";import"./copy-Dx2Xdz_j.js";import"./download-9mt5C_Kp.js";import"./eye-off-jIIH8s4K.js";import"./eye-Cs4vM6yN.js";function p(){return e.jsxs("div",{className:"space-y-8",children:[e.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-sky-300",children:"Conditional Statements in Python — if, elif, else"}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base leading-relaxed",children:["Conditional statements allow a program to make decisions. Python evaluates a condition as ",e.jsx("strong",{children:"True"})," or ",e.jsx("strong",{children:"False"}),"and executes the matching code block. This is one of the most powerful tools for creating logic, validations, menus, and real-world applications."]}),e.jsxs("h2",{className:"text-xl font-semibold text-sky-300",children:["1. The ",e.jsx("code",{children:"if"})," Statement"]}),e.jsxs("p",{className:"text-slate-300 text-sm md:text-base",children:["An ",e.jsx("code",{children:"if"})," block runs only when its condition is ",e.jsx("strong",{children:"True"}),". Python uses indentation (usually 4 spaces) to define the block."]}),e.jsx(s,{initialCode:`age = 20
