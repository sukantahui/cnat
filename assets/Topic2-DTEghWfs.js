import{b as c,j as e}from"./vendor-react-core-CaA1o1Cx.js";import{T as k}from"./TeacherSukantaHui-Ds9F9lLV.js";import{P as d}from"./PythonFileLoader-DUNJ9gwR.js";import{F as g}from"./FAQTemplate-D_90hN4m.js";import{P as f}from"./PlainTextPrint-yt10TRX1.js";import"./vendor-icons-ri6cs58t.js";import"./PythonCodeBlock-PUup0iW5.js";import"./vendor-prism-CCfIgi4B.js";const b=[{question:"What is the key difference between `screen.onkeypress()` and `screen.onkeyrelease()`?",shortAnswer:"`onkeypress()` fires the moment a key is depressed; `onkeyrelease()` fires when the physical key springs back up.",explanation:"Pairing press and release events enables continuous multi-key state tracking.",hint:"Which event fires on key down versus key up?",level:"basic",codeExample:`screen.onkeypress(press_handler, 'Up')
