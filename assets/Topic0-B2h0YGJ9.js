...
if __name__ == "__main__":
    ...
    print(f"20 - 10 = {res}")
\`\`\``}]}],q={paperId:k,title:v,duration:j,totalMarks:N,prerequisites:P,instructions:_,sections:A},C=()=>{const[i]=d.useState(q),p={name:"Coder & AccoTax",address:"Barrackpore, Kolkata",logo:"/logo.png"};return n.jsx("div",{className:"container mx-auto py-8",children:n.jsx(w,{data:i,isLoggedIn:!0,organizationDetails:p})})};export{C as default};
